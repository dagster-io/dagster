...
import {BackfillLaunchpadSession} from './BackfillLaunchpadSession';
...
export const BackfillLaunchpadTransientSessionContainer = (props: Props) => {
  const {
    launchpadType,
    pipeline,
    partitionSets,

...
export const InstanceConcurrencyKeyInfo = ({concurrencyKey}: {concurrencyKey: string}) => {
  useTrackPageView();
  useDocumentTitle(`Concurrency group: ${concurrencyKey}`);
  ...
  const onDelete = () => {
    // navigate to main page, show toast
    console.log('deletedddd!!!');
    showSharedToaster({
      icon: 'trash',
      intent: 'success',
      message: 'Deleted concurrency group',
    });
  };
        ...
        {concurrencyLimit ? (
          <Box>
            ...
            >
              <Heading>
                <Box flex={{direction: 'row', gap: 8, alignItems: 'center'}}>
                  <div>
                    <Link to="/deployment/concurrency">Concurrency groups</Link>
                  </div>
                  <div>/</div>
            ...
            <Box padding={{vertical: 16, horizontal: 24}}>
              <Subheading>Group info</Subheading>
            </Box>
                  ...
                  <tr>
                    ...
                    <td>
                      <Box flex={{justifyContent: 'space-between', alignItems: 'center'}}>
                        <div>{concurrencyLimit.slotCount}</div>

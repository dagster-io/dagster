...
export type AppContextValue = {
  // `basePath` is the root used for routing and GraphQL requests. In open source Dagster UI,
  // this will also be the same as the root for static assets, `staticPathRoot`.
  basePath: string;
  rootServerURI: string;
  // `staticPathRoot` is the root where static assets are served from. In open source Dagster UI,

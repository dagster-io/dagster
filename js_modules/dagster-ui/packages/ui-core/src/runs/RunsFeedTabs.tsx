...
export const useRunsFeedTabs = (filter: RunsFilter = {}, view: RunsFeedView) => {
  ...
  const urlForStatus = (statuses: RunStatus[], nextView?: RunsFeedView) => {
    nextView ||= view === RunsFeedView.RUNS ? RunsFeedView.RUNS : RunsFeedView.ALL;
  ...
  const tabs = (
    <Tabs selectedTabId={selectedTab}>
      <TabLink id="all" title="All" to={urlForStatus([], RunsFeedView.ALL)} />
      <TabLink id="runs" title="Runs" to={urlForStatus([], RunsFeedView.RUNS)} />

...
import {AssetCheckKeyInput} from '../graphql/types';

export function getAssetCheckKeyInputs(
...
export function asAssetCheckKeyInput(check: {name: string; assetKey: {path: string[]}}) {

...
export interface RunDagsterRunEventFragment_ResourceInitFailureEvent_error_errorChain_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunDagsterRunEventFragment_ResourceInitFailureEvent_error_errorChain {
  __typename: "ErrorChainLink";
  isExplicitLink: boolean;
  error: RunDagsterRunEventFragment_ResourceInitFailureEvent_error_errorChain_error;
}
...
export interface RunDagsterRunEventFragment_ResourceInitFailureEvent_error {
  ...
  message: string;
  stack: string[];
  errorChain: RunDagsterRunEventFragment_ResourceInitFailureEvent_error_errorChain[];
}
...
export interface RunDagsterRunEventFragment_ExecutionStepFailureEvent_error_errorChain_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunDagsterRunEventFragment_ExecutionStepFailureEvent_error_errorChain {
  __typename: "ErrorChainLink";
  isExplicitLink: boolean;
  error: RunDagsterRunEventFragment_ExecutionStepFailureEvent_error_errorChain_error;
}
...
export interface RunDagsterRunEventFragment_ExecutionStepFailureEvent_error {
  ...
  message: string;
  stack: string[];
  errorChain: RunDagsterRunEventFragment_ExecutionStepFailureEvent_error_errorChain[];
}
...
export interface RunDagsterRunEventFragment_ExecutionStepUpForRetryEvent_error_errorChain_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunDagsterRunEventFragment_ExecutionStepUpForRetryEvent_error_errorChain {
  __typename: "ErrorChainLink";
  isExplicitLink: boolean;
  error: RunDagsterRunEventFragment_ExecutionStepUpForRetryEvent_error_errorChain_error;
}
...
export interface RunDagsterRunEventFragment_ExecutionStepUpForRetryEvent_error {
  ...
  message: string;
  stack: string[];
  errorChain: RunDagsterRunEventFragment_ExecutionStepUpForRetryEvent_error_errorChain[];
}

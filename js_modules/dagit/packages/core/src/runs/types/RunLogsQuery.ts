...
export interface RunLogsQuery_logsForRun_EventConnection_events_ResourceInitFailureEvent_error_errorChain_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunLogsQuery_logsForRun_EventConnection_events_ResourceInitFailureEvent_error_errorChain {
  __typename: "ErrorChainLink";
  isExplicitLink: boolean;
  error: RunLogsQuery_logsForRun_EventConnection_events_ResourceInitFailureEvent_error_errorChain_error;
}
...
export interface RunLogsQuery_logsForRun_EventConnection_events_ResourceInitFailureEvent_error {
  ...
  message: string;
  stack: string[];
  errorChain: RunLogsQuery_logsForRun_EventConnection_events_ResourceInitFailureEvent_error_errorChain[];
}
...
export interface RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepFailureEvent_error_errorChain_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepFailureEvent_error_errorChain {
  __typename: "ErrorChainLink";
  isExplicitLink: boolean;
  error: RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepFailureEvent_error_errorChain_error;
}
...
export interface RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepFailureEvent_error {
  ...
  message: string;
  stack: string[];
  errorChain: RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepFailureEvent_error_errorChain[];
}
...
export interface RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepUpForRetryEvent_error_errorChain_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepUpForRetryEvent_error_errorChain {
  __typename: "ErrorChainLink";
  isExplicitLink: boolean;
  error: RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepUpForRetryEvent_error_errorChain_error;
}
...
export interface RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepUpForRetryEvent_error {
  ...
  message: string;
  stack: string[];
  errorChain: RunLogsQuery_logsForRun_EventConnection_events_ExecutionStepUpForRetryEvent_error_errorChain[];
}

...
export interface RunLogsQuery_pipelineRunOrError_PipelineRun_events_PipelineInitFailureEvent_error_cause {
  __typename: "PythonError";
  message: string;
  stack: string[];
}

export interface RunLogsQuery_pipelineRunOrError_PipelineRun_events_PipelineInitFailureEvent_error {
  __typename: "PythonError";
  message: string;
  stack: string[];
  cause: RunLogsQuery_pipelineRunOrError_PipelineRun_events_PipelineInitFailureEvent_error_cause | null;
}

export interface RunLogsQuery_pipelineRunOrError_PipelineRun_events_PipelineInitFailureEvent {
  ...
  stepKey: string | null;
  eventType: DagsterEventType | null;
  error: RunLogsQuery_pipelineRunOrError_PipelineRun_events_PipelineInitFailureEvent_error;
}

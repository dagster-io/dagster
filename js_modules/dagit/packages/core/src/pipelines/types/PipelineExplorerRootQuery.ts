...
export interface PipelineExplorerRootQuery_pipelineSnapshotOrError_PipelineSnapshot_tags {
...
export interface PipelineExplorerRootQuery_pipelineSnapshotOrError_PipelineSnapshot {
  ...
  id: string;
  name: string;
  tags: PipelineExplorerRootQuery_pipelineSnapshotOrError_PipelineSnapshot_tags[];
  description: string | null;

...
export interface AssetViewDefinitionQuery_assetOrError_Asset_definition_metadataEntries_LogicalVersionMetadataEntry {
...
export interface AssetViewDefinitionQuery_assetOrError_Asset_definition_type_metadataEntries_LogicalVersionMetadataEntry {
  __typename: "LogicalVersionMetadataEntry";
  label: string;
  description: string | null;
  value: string;
...
export interface AssetViewDefinitionQuery_assetOrError_Asset_definition_type_innerTypes_metadataEntries_LogicalVersionMetadataEntry {
  __typename: "LogicalVersionMetadataEntry";
  label: string;
  description: string | null;
  value: string;

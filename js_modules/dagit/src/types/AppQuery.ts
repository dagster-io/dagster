...
export interface AppQuery_pipelinesOrError_PipelineConnection_nodes_runs_logs_nodes_PipelineProcessStartedEvent {
  message: string;
  timestamp: string;
  level: LogLevel;

...
export interface RootRepositoriesQuery_repositoryLocationsOrError_RepositoryLocationConnection_nodes_RepositoryLocation_repositories_origin_PythonRepositoryOrigin_repositoryMetadata {
...
export interface RootRepositoriesQuery_repositoryLocationsOrError_RepositoryLocationConnection_nodes_RepositoryLocation_repositories_origin_PythonRepositoryOrigin {
  ...
  repositoryMetadata: RootRepositoriesQuery_repositoryLocationsOrError_RepositoryLocationConnection_nodes_RepositoryLocation_repositories_origin_PythonRepositoryOrigin_repositoryMetadata[];
}

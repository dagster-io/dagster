...
export const LogsRowStructuredContent: React.FunctionComponent<IStructuredContentProps> = ({
  ...
  switch (node.__typename) {
    ...
    case 'PipelineCancellingEvent':
      return <DefaultContent message={node.message} eventType="Cancelling Pipeline" />;
    case 'PipelineCancelledEvent':
      return <FailureContent message={node.message} eventType="Pipeline Cancelled" />;
    case 'EngineEvent':
      if (node.engineError) {
        return (
          <FailureContent

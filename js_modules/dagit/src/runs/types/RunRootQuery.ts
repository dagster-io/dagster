...
export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_step {
  __typename: "ExecutionStep";
  key: string;
}

export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventPathMetadataEntry {
  __typename: "EventPathMetadataEntry";
  label: string;
  description: string | null;
  path: string;
...
export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventJsonMetadataEntry {
  __typename: "EventJsonMetadataEntry";
  label: string;
  description: string | null;
  jsonString: string;
...
export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventUrlMetadataEntry {
  __typename: "EventUrlMetadataEntry";
  label: string;
  description: string | null;
  url: string;
...
export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventTextMetadataEntry {
  __typename: "EventTextMetadataEntry";
  label: string;
  description: string | null;
  text: string;
...
export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventMarkdownMetadataEntry {
  __typename: "EventMarkdownMetadataEntry";
  label: string;
  description: string | null;
  mdString: string;
...
export type RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries = RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventPathMetadataEntry | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventJsonMetadataEntry | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventUrlMetadataEntry | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventTextMetadataEntry | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries_EventMarkdownMetadataEntry;

export interface RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent {
  __typename: "EngineEvent";
  message: string;
  timestamp: string;
  level: LogLevel;
  step: RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_step | null;
  metadataEntries: RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent_metadataEntries[];
}

export type RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes = RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_ExecutionStepSkippedEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_PipelineProcessStartedEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_PipelineProcessStartEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_StepMaterializationEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_PipelineInitFailureEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_ExecutionStepFailureEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_ExecutionStepInputEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_ExecutionStepOutputEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_StepExpectationResultEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_ObjectStoreOperationEvent | RunRootQuery_pipelineRunOrError_PipelineRun_logs_nodes_EngineEvent;

...
const StepItem = ({
  ...
  return (
    <div
      key={name}
      className={clsx(styles.stepItemContainer, selected && styles.stepItemContainerSelected)}
...
export const StepStatusDot = (props: React.ComponentPropsWithoutRef<'div'>) => {
  const {className, ...rest} = props;
  return <div className={clsx(styles.stepStatusDot, className)} {...rest} />;
};

...
def parse_spark_config(spark_conf):
    ...
    return list(
        itertools.chain.from_iterable(
            [('--conf', '{}={}'.format(*c)) for c in spark_conf_list]
        )
    )
                    ...
                    PermissiveDict(
                        fields={
                            ...
                            'executorEnv': Field(
                                PermissiveDict(
                                    fields={
                                            '[EnvironmentVariableName]': Field(
                                            String,
                                            description='''Runtime Environment: Add the environment variable specified by EnvironmentVariableName to the Executor process. The user can specify multiple of these to set multiple environment variables.''',
                                            is_optional=True,
                                        ),
                                    }
                                )

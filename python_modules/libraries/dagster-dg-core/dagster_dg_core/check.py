...
from dagster_dg_core.component import DgRegistry, get_specified_env_var_deps, get_used_env_vars
...
class ErrorInput(NamedTuple):
    object_key: Optional[DgRegistryKey]
...
def check_yaml(
    ...
    component_contents_by_key: dict[DgRegistryKey, Any] = {}
    ...
    for component_dir in dg_context.defs_path.rglob("*"):
        ...
        if yaml_path:
            ...
            key = DgRegistryKey.from_typename(qualified_key)
    ...
    component_registry = DgRegistry.from_dg_context(

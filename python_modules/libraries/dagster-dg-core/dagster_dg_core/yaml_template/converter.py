...
class JsonSchemaConverter:
    ...
    def _generate_property_template_lines(self, prop_name: str, prop_schema: Dict[str, Any], indent_level: int) -> List[str]:
        ...
        if prop_type == "object":
            ...
            for nested_name, nested_schema in nested_properties.items():
                ...
                nested_lines = self._generate_property_template_lines(nested_name, nested_schema, indent_level + 1)
    ...
    def _generate_example_value(self, prop_schema: Dict[str, Any], property_name: str = None, is_array_item: bool = False) -> Any:
        ...
        if prop_type == "object":
            ...
            for nested_name, nested_schema in nested_properties.items():
                ...
                example_obj[nested_name] = self._generate_example_value(nested_schema, nested_name, is_array_item)
            ...
            if items_type == "object":
                ...
                example_item = self._generate_example_value(items_schema, None, True)
                ...
                if property_name == "roles":
                    ...
                    example_item = get_example_value_for_type(items_type, format_hint, items_schema, property_name, True)
                    return [example_item, example_item]
        
        else:
            # Primitive type
            format_hint = prop_schema.get("format")
            return get_example_value_for_type(prop_type, format_hint, prop_schema, property_name, is_array_item)

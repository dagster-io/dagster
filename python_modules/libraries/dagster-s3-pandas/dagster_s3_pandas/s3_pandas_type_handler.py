...
from dagster_aws.s3.parquet_io_manager import FsTypeHandler, build_s3_parquet_io_manager
from upath import UPath


class S3PandasTypeHandler(FsTypeHandler[pd.DataFrame]):
    """
    # TODO - doc string
    ...
    def handle_output(self, context: OutputContext, obj: pd.DataFrame, path: UPath):
    ...
    def load_input(self, context: InputContext, path: UPath) -> pd.DataFrame:
...
s3_parquet_pandas_io_manager = build_s3_parquet_io_manager([S3PandasTypeHandler()])
s3_parquet_pandas_io_manager.__doc__ = """
# TODO - doc string

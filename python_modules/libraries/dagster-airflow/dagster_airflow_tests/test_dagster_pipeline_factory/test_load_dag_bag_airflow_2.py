...
test_airflow_example_dags_params = [
    pytest.param(
        "airflow_dataset_consumes_1", False, id="airflow_dataset_consumes_1"
    ),
    pytest.param(
        "airflow_dataset_consumes_1_and_2", False, id="airflow_dataset_consumes_1_and_2"
    ),
    pytest.param(
        "airflow_dataset_consumes_1_never_scheduled", False, id="airflow_dataset_consumes_1_never_scheduled"
    ),
    pytest.param(
        "airflow_dataset_consumes_unknown_never_scheduled", False, id="airflow_dataset_consumes_unknown_never_scheduled"
    ),
    pytest.param(
        "airflow_dataset_produces_1", False, id="airflow_dataset_produces_1"
    ),
    pytest.param(
        "airflow_dataset_produces_2", False, id="airflow_dataset_produces_2"
    ),
    pytest.param(
        "airflow_example_branch_datetime_operator", False, id="airflow_example_branch_datetime_operator"
    ),
    pytest.param(
        "airflow_example_branch_datetime_operator_2", False, id="airflow_example_branch_datetime_operator_2"
    ),
    pytest.param(
        "airflow_example_branch_datetime_operator_3", False, id="airflow_example_branch_datetime_operator_3"
    ),
    pytest.param(
        "airflow_example_branch_dop_operator_v3", False, id="airflow_example_branch_dop_operator_v3"
    ),
    pytest.param(
        "airflow_example_branch_labels", False, id="airflow_example_branch_labels"
    ),
    pytest.param(
        "airflow_example_branch_operator", False, id="airflow_example_branch_operator"
    ),
    pytest.param(
        "airflow_example_branch_python_operator_decorator", False, id="airflow_example_branch_python_operator_decorator"
    ),
    pytest.param(
        "airflow_example_complex", False, id="airflow_example_complex"
    ),
    # requires email server to work
    pytest.param(
        "airflow_example_dag_decorator", True, id="airflow_example_dag_decorator"
    ),
    pytest.param(
        "airflow_example_external_task_marker_child", False, id="airflow_example_external_task_marker_child"
    ),
    pytest.param(
        "airflow_example_external_task_marker_parent", False, id="airflow_example_external_task_marker_parent"
    ),
    ...
    pytest.param(
        "airflow_example_local_kubernetes_executor", False, id="airflow_example_local_kubernetes_executor"
    ),
    pytest.param(
    ...
    pytest.param(
        "airflow_example_passing_params_via_test_command", True, id="airflow_example_passing_params_via_test_command"
    ),
    # requires template files to exist
    pytest.param(
        "airflow_example_python_operator", True, id="airflow_example_python_operator"
    ),
    pytest.param(
        "airflow_example_short_circuit_decorator", False, id="airflow_example_short_circuit_decorator"
    ),
    pytest.param(
        "airflow_example_short_circuit_operator", False, id="airflow_example_short_circuit_operator"
    ),
    pytest.param(
        "airflow_example_skip_dag", False, id="airflow_example_skip_dag"
    ),
    pytest.param(
        "airflow_example_sla_dag", False, id="airflow_example_sla_dag"
    ),
    # runs slow
    pytest.param(
        "airflow_example_subdag_operator", True, id="airflow_example_subdag_operator"
    ),
    pytest.param(
        "airflow_example_subdag_operator_section_1", False, id="airflow_example_subdag_operator_section_1"
    ),
    pytest.param(
        "airflow_example_subdag_operator_section_2", False, id="airflow_example_subdag_operator_section_2"
    ),
    pytest.param(
        "airflow_example_task_group", False, id="airflow_example_task_group"
    ),
    pytest.param(
        "airflow_example_task_group_decorator", False, id="airflow_example_task_group_decorator"
    ),
    pytest.param(
        "airflow_example_time_delta_sensor_async", False, id="airflow_example_time_delta_sensor_async"
    ),
    ...
    pytest.param(
        "airflow_example_weekday_branch_operator", False, id="airflow_example_weekday_branch_operator"
    ),
    pytest.param(
        "airflow_example_xcom", False, id="airflow_example_xcom"
    ),
    pytest.param(
        "airflow_example_xcom_args", False, id="airflow_example_xcom_args"
    ),
    pytest.param(
        "airflow_example_xcom_args_with_operators", False, id="airflow_example_xcom_args_with_operators"
    ),
    pytest.param(
        "airflow_latest_only", False, id="airflow_latest_only"
    ),
    pytest.param(
        "airflow_latest_only_with_trigger", False, id="airflow_latest_only_with_trigger"
    ),
    pytest.param(
        "airflow_tutorial", False, id="airflow_tutorial"
    ),
    pytest.param(
        "airflow_tutorial_taskflow_api", False, id="airflow_tutorial_taskflow_api"
    ),
    pytest.param(
        "airflow_tutorial_taskflow_api_virtualenv", False, id="airflow_tutorial_taskflow_api_virtualenv"
    ),
]
@pytest.mark.skipif(airflow_version < "2.0.0", reason="requires airflow 2")
@pytest.mark.parametrize(

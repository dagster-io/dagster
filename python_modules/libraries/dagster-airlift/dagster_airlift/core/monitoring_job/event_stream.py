...
class DagRunStarted:
    ...
    def persist_state(
        ...
        for asset_key in airflow_data.all_asset_keys_by_dag_handle[self.dag_run.dag_handle]:
            context.instance.report_dagster_event(
                run_id=dagster_run_id,
...
def _process_completed_runs(
    ...
    offset = 0
    dag_ids_to_query = airflow_data.dag_ids_with_mapped_asset_keys.union(

...
class ADLS2FileManager(FileManager):
    ...
    def copy_handle_to_local_temp(self, file_handle: ADLS2FileHandle):  # ty: ignore[invalid-method-override]
    ...
    def read_data(self, file_handle: ADLS2FileHandle) -> Any:  # ty: ignore[invalid-method-override]
    ...
    def write(  # ty: ignore[invalid-method-override]

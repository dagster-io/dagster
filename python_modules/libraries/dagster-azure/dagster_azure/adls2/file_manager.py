...
class ADLS2FileManager(FileManager):
    ...
    def _download_if_not_cached(self, file_handle: ADLS2FileHandle) -> ADLS2FileHandle:
    ...
    def write(self, file_obj, mode: str = "wb", ext: Optional[str] = None) -> ADLS2FileHandle:
        ...
        adls2_file.upload_data(file_obj, overwrite=True)  # type: ignore

...
"""
    ...
    assert instance.compute_log_manager._storage_account == storage_account  # noqa: SLF001  # ty: ignore[unresolved-attribute]
    assert instance.compute_log_manager._container == container  # noqa: SLF001  # ty: ignore[unresolved-attribute]
    assert instance.compute_log_manager._blob_prefix == prefix  # noqa: SLF001  # ty: ignore[unresolved-attribute]
...
"""
    ...
    assert instance.compute_log_manager._container == container  # noqa: SLF001  # ty: ignore[unresolved-attribute]
    assert instance.compute_log_manager._blob_prefix == prefix  # noqa: SLF001  # ty: ignore[unresolved-attribute]
    assert instance.compute_log_manager._default_azure_credential == {  # noqa: SLF001  # ty: ignore[unresolved-attribute]
        "exclude_environment_credentials": True
    }

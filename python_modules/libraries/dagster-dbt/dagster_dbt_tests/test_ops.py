...
def test_seed_op(conn_string, test_project_dir, dbt_config_dir):
...
def test_build_op(dbt_seed, conn_string, test_project_dir, dbt_config_dir, yield_asset_events):
    dbt_resource = dbt_cli_resource.configured(
        {"project_dir": test_project_dir, "profiles_dir": dbt_config_dir}
    )
...
def test_run_op(dbt_seed, conn_string, test_project_dir, dbt_config_dir):
    dbt_resource = dbt_cli_resource.configured(
        {"project_dir": test_project_dir, "profiles_dir": dbt_config_dir}
    )
...
def test_run_op_with_select(dbt_build, conn_string, test_project_dir, dbt_config_dir):
    dbt_resource = dbt_cli_resource.configured(
...
def test_run_test_job(dbt_seed, conn_string, test_project_dir, dbt_config_dir):
    dbt_resource = dbt_cli_resource.configured(
        {"project_dir": test_project_dir, "profiles_dir": dbt_config_dir}
    )

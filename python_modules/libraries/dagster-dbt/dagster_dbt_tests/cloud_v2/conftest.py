...
SAMPLE_TRIGGERED_BY_DAGSTER_RUNS_RESPONSE = get_sample_list_runs_sample(
    data=[
        get_sample_run_data(
            run_status=int(DbtCloudJobRunStatusType.SUCCESS),
...
@pytest.fixture(
    name="sensor_runs_triggered_by_dagster_api_mocks",
)
def sensor_runs_triggered_by_dagster_api_mocks_fixture(
    all_api_mocks: responses.RequestsMock,
) -> Iterator[responses.RequestsMock]:
    all_api_mocks.replace(
        method_or_response=responses.GET,

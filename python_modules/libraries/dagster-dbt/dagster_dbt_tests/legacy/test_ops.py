...
def test_build_op(dbt_seed, test_project_dir, dbt_config_dir, yield_asset_events):
    dbt_resource = dbt_cli_resource.configured(
        {"project_dir": test_project_dir, "profiles_dir": dbt_config_dir}
    )
...
def test_run_op(dbt_seed, test_project_dir, dbt_config_dir):
    dbt_resource = dbt_cli_resource.configured(
        {"project_dir": test_project_dir, "profiles_dir": dbt_config_dir}
    )
...
def test_run_test_job(dbt_seed, test_project_dir, dbt_config_dir):
    dbt_resource = dbt_cli_resource.configured(
        {"project_dir": test_project_dir, "profiles_dir": dbt_config_dir}
    )

...
class DbtManifest:
    ...
    ## DEFAULT METHODS THAT CAN BE OVERRIDEN

    def unique_id_to_asset_key(self, unique_id: str) -> AssetKey:
        node_info = self.node_info_by_dbt_unique_id[unique_id]
    ...
    def output_asset_key_replacements(self) -> Mapping[AssetKey, AssetKey]:
        ...
        """
        return {
            default_asset_key_fn(node_info): self.unique_id_to_asset_key(unique_id)
            for unique_id, node_info in self.node_info_by_dbt_unique_id.items()
        }

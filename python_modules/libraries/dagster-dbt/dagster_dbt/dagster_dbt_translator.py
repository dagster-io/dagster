...
class DagsterDbtTranslatorSettings:
    ...
    Args:
        ...
        enable_source_tests_as_checks (bool): Whether to load dbt source tests as Dagster asset checks. Defaults
            to False. If False, observation events will be emitted for dbt source tests instead.
    """

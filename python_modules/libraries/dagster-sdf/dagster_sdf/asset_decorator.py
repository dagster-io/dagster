...
def sdf_assets(
    *,
    ...
    information_schema = SdfInformationSchema(workspace_dir=workspace_dir, target_dir=target_dir, environment=environment)
    outs, internal_asset_deps = information_schema.get_outs_and_internal_deps(io_manager_key=io_manager_key)

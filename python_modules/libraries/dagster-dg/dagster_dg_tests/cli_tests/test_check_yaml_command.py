...
@pytest.mark.parametrize(
    "test_case",
    [NON_SPECIFIED_ENV_VAR_TEST_CASE, SPECIFIED_ENV_VAR_TEST_CASE],
    ids=[
        str(case.component_path)
        for case in [NON_SPECIFIED_ENV_VAR_TEST_CASE, SPECIFIED_ENV_VAR_TEST_CASE]
    ],
)

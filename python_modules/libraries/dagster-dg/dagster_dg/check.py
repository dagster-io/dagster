...
class ErrorInput(NamedTuple):
    entry_key: Optional[LibraryEntryKey]
...
def check_yaml(
    ...
    component_contents_by_key: dict[LibraryEntryKey, Any] = {}
    ...
    for component_dir in dg_context.defs_path.iterdir():
        ...
        if component_path.exists():
            ...
            key = LibraryEntryKey.from_typename(qualified_key)
    ...
    component_registry = RemoteLibraryEntryRegistry.from_dg_context(

...
from dagster_dg.component import RemoteLibraryEntryRegistry, all_components_schema_from_dg_context
...
def inspect_component_type_command(
    ...
    **global_options: object,
    ...
    component_key = LibraryEntryKey.from_typename(component_type)

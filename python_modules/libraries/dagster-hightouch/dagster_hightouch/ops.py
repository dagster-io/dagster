...
from dagster_hightouch.resources import DEFAULT_POLL_INTERVAL
...
def hightouch_sync_op(context):
    """Executes a Hightouch sync for a given ``sync_id``, and polls until that sync completes.

    It raises an error if it is unsuccessful. It outputs a HightouchOutput

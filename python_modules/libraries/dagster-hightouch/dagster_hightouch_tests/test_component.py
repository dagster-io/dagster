...
from dagster_hightouch import ConfigurableHightouchResource, HightouchSyncComponent
from dagster_hightouch.types import HightouchOutput


def test_hightouch_component_load():
    asset_key_str = "test_hightouch_asset"
    component = HightouchSyncComponent(sync_id="123", asset=dg.AssetSpec(key=asset_key_str))
...
def test_component_execution():
    ...
    component = HightouchSyncComponent(sync_id="123", asset=dg.AssetSpec(key="test_asset"))

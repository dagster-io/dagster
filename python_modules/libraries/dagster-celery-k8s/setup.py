...
def get_version(name):
    ...
    if name == 'dagster-celery-k8s':
        return version['__version__']
    elif name == 'dagster-celery-k8s-nightly':
...
def _do_setup(name='dagster-celery-k8s'):
    setup(
        name=name,
...
if __name__ == '__main__':
    ...
    if parsed.nightly:
        _do_setup('dagster-celery-k8s-nightly')
    else:
        _do_setup('dagster-celery-k8s')

...
def run_launch_agent(context: OpExecutionContext):
    ...
    **Example:**
    ...
    launch.create_and_run_agent(api=context.resources.wandb_resource["api"], config=config)  # ty: ignore[unresolved-attribute]
...
def run_launch_job(context: OpExecutionContext):
    ...
    **Example:**
    ...
    if queue is None:
        ...
        launch.run(api=context.resources.wandb_resource["api"], config=config)  # ty: ignore[unresolved-attribute]
    else:

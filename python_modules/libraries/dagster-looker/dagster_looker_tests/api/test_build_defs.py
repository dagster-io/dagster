...
from dagster_looker import LookerFilter, build_dashboard_notification_assets_definition
...
def test_load_asset_specs_filter(
    ...
    assert AssetKey(["my_model__my_other_explore"]) not in asset_specs_by_key
...
def test_load_asset_specs(
    ...
    assert lookml_explore_asset.tags == {
        ...
        "dagster-looker/asset_type": "explore",
    }
    ...
    assert looker_dashboard_asset.tags == {
        "dagster/kind/looker": "",
        "dagster/kind/dashboard": "",
        "dagster-looker/asset_type": "dashboard",
    }
...
def test_build_defs_with_scheduled_plans(
    ...
    resource_key = "looker"
    specs = load_looker_asset_specs(looker_resource)

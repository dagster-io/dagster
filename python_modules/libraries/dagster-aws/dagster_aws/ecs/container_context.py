...
class EcsContainerContext(
    NamedTuple(
        ...
        [
            ...
            ("server_ecs_tags", Sequence[Mapping[str, str | None]]),
            ("run_ecs_tags", Sequence[Mapping[str, str | None]]),
    ...
    def __new__(
        ...
        secrets_tags: Sequence[str] | None = None,
        env_vars: Sequence[str] | None = None,
        task_definition_arn: str | None = None,
        container_name: str | None = None,
        server_resources: Mapping[str, str] | None = None,
        run_resources: Mapping[str, str] | None = None,

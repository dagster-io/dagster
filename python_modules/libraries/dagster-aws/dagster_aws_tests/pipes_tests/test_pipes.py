...
# @pytest.fixture
# def sfn_client(moto_server) -> "SFNClient":
#     client = boto3.client("stepfunctions", region_name="us-east-1", endpoint_url=_MOTO_SERVER_URL)
...
#             }
#         ),
#         roleArn="arn:aws:iam::012345678901:role/service-role/StatesExecutionRole-us-east-1",
#     )
#     return client
...
#     ) -> None:
#     @asset
#     def my_asset(context: AssetExecutionContext, pipes_sfn_client: PipesSFNClient):
#         return pipes_sfn_client.run(
#             context=context,
#             start_execution_input={"stateMachineArn": "arn:aws:states:us-east-1:123456789012:stateMachine:TestSFN"},
#         ).get_results()
#     context_injector = PipesS3ContextInjector(bucket=_S3_TEST_BUCKET, client=s3_client)
#     message_reader = (
#         PipesS3MessageReader(bucket=_S3_TEST_BUCKET, client=s3_client, interval=0.001)

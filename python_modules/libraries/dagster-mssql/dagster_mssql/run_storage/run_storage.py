...
class MSSQLRunStorage(SqlRunStorage, ConfigurableClass):
    ...
    def get_server_version(self) -> str | None:
        # @@VERSION returns a multi-line banner; ProductVersion is the bare "16.0.4265.3"
        with (
    ...
    @staticmethod
    def create_clean_storage(mssql_url: str) -> "MSSQLRunStorage":

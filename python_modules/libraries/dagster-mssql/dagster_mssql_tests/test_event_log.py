...
TestEventLogStorage.__test__ = False
...
class TestMSSQLEventLogStorage(TestEventLogStorage):
    __test__ = True
    ...
    def event_log_storage(self, instance):
        ...
        assert isinstance(event_log_storage, MSSQLEventLogStorage)
    ...
    def test_load_from_config(self, conn_string):
        ...
        with instance_for_test(overrides=safe_load_yaml(url_cfg)) as from_url_instance:
            ...
            with instance_for_test(overrides=safe_load_yaml(explicit_cfg)) as explicit_instance:
                ...
                assert from_url.mssql_url == from_explicit.mssql_url  # ty: ignore[unresolved-attribute]

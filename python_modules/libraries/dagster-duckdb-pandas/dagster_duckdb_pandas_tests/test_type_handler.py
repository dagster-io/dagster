...
from dagster_duckdb_pandas import duckdb_pandas_io_manager, DuckDBPandasTypeHandler
...
def test_duckdb_io_manager_with_assets(tmp_path):
    io_manager = build_configurable_duckdb_io_manager(type_handlers=[DuckDBPandasTypeHandler()], default_load_type=pd.DataFrame)

...
def get_version() -> str:
    ...
    with open(Path(__file__).parent / "dagster_test_package/version.py", encoding="utf8") as fp:
...
setup(
    ...
    packages=find_packages(exclude=["dagster_test_package_tests*"]),
    install_requires=[
        f"dagster{pin}",

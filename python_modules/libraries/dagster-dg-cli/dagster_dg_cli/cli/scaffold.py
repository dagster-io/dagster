...
class ScaffoldDefsGroup(DgClickGroup):
    ...
    def _define_commands(self, cli_context: click.Context) -> None:
        ...
        # as a command alias.
        keys_by_name: dict[str, set[DgRegistryKey]] = {}
    ...
    def _create_subcommand(
        self, key: DgRegistryKey, obj: DgRegistryObjectSnap, use_typename_alias: bool
    ) -> None:
...
def scaffold_component_command(
    ...
    component_key = DgRegistryKey(name=class_name, namespace=module_name)

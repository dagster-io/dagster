...
def scaffold_component_command(
    context: click.Context, name: str, model: bool, context_path: Path, **global_options: object
) -> None:
    ...
    """
    cli_config = normalize_cli_config(global_options, context)
    dg_context = DgContext.for_component_library_environment(context_path, cli_config)
    registry = RemotePluginRegistry.from_dg_context(dg_context)

...
def list_project_command(context_path: Path, **global_options: object) -> None:
    """List projects in the current workspace."""
    cli_config = normalize_cli_config(global_options, click.get_current_context())
    dg_context = DgContext.for_workspace_environment(context_path, cli_config)
...
def list_components_command(
    context_path: Path, package: Optional[str], output_json: bool, **global_options: object
) -> None:
...
@dg_global_options
@cli_telemetry_wrapper
def list_env_command(context_path: Path, **global_options: object) -> None:

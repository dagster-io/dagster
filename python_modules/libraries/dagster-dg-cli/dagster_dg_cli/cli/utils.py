...
import click
from dagster_dg_core.component import DgRegistry, all_components_schema_from_dg_context
...
def inspect_component_type_command(
    ...
    **global_options: object,
    ...
    registry = DgRegistry.from_dg_context(dg_context)
    component_key = DgRegistryKey.from_typename(component_type)

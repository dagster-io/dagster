"""Intermediate display models for consistent formatting across output formats.

These models represent the normalized view of data that should be displayed,

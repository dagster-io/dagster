...
class DgApiErrorMapping(NamedTuple):
    ...
    code: Literal[
        ...
        # Client Errors
        "INVALID_SUBSET_ERROR",
        "INVALID_PARTITION_SUBSET_ERROR",
        # Server Errors
        "PYTHON_ERROR",
...
def get_graphql_error_mappings() -> dict[str, DgApiErrorMapping]:
    ...
    return {
        ...
        "PartitionSubsetDeserializationError": DgApiErrorMapping(
            code="INVALID_PARTITION_SUBSET_ERROR",
            status_code=400,
        ),
...
def get_or_create_dg_api_error(graphql_error) -> DgApiError:
    ...
    # Special case: PYTHON_ERROR with InvalidSubsetError class should map to INVALID_SUBSET_ERROR

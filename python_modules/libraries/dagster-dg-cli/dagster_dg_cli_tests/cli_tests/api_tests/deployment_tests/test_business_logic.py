...
class TestFormatDeployments:
    ...
    def _create_sample_deployment_list(self):
        """Create sample DgApiDeploymentList from fixture data."""
        ...
        deployments = [
            DgApiDeployment(
                ...
                type=DgApiDagsterCloudDeploymentType(dep["deploymentType"]),
            )
...
class TestFormatDeploymentSettings:
    ...
    def test_format_settings_text_output(self, snapshot):
        ...
        settings = DgApiDeploymentSettings(settings=response["deploymentSettings"]["settings"])

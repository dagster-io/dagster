...
def get_environment_op(context):
...
def define_docker_celery_pipeline():
    ...
    def use_resource_with_output_op():
        pass
...
def emit_airflow_execution_date_op(context):
    airflow_execution_date = context.run.tags["airflow_execution_date"]

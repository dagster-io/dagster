...
@dg.asset(freshness_policy=FreshnessPolicy.time_window(fail_window=timedelta(minutes=60)))
def asset_with_time_window_freshness_60m():
    return 1


@dg.asset(freshness_policy=FreshnessPolicy.time_window(fail_window=timedelta(minutes=30)))

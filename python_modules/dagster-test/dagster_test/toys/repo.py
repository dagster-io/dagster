...
from dagster_test.toys.asset_collection import collection, full_collection_sensor, subset_schedule
...
def toys_repository():
    return (
        ...
        + [
            collection,
            collection.build_job("test", "asset_foo"),
            full_collection_sensor,
            subset_schedule,
        ]
        + get_toys_schedules()
        + get_toys_sensors()

...
snapshots['test_scaffold_airflow_dag 2'] = [
    ...
    '',
    '# Set the host directory to mount into /tmp/results on the containers. May be a template including',
    '# the `safe_run_id` to support multiple simultaneous runs (recommended). Note that you must change',
    '# this for Windows!',
    "HOST_TMP_DIR = '/tmp/results{safe_run_id}'",
    '',

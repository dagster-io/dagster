...
def test_assets_excluded_from_subset_not_in_job():
    ...
    assert (
        ExternalAssetNode(
            ...
            op_name="abc_subset_8e776",
            node_definition_name="abc_subset_8e776",
            graph_name=None,
            op_names=["abc_subset_8e776"],
    ...
    assert (
        ExternalAssetNode(
            ...
            op_name="abc_subset_e90bb",
            node_definition_name="abc_subset_e90bb",
            graph_name=None,
            op_names=["abc_subset_e90bb"],

...
def test_source_asset_with_op():
    ...
    assert asset_node_snaps == [
        AssetNodeSnap(
            ...
            op_names=["bar"],
            op_description=None,
            parent_edges=[AssetParentEdgeSnap(AssetKey("foo"))],
            child_edges=[],
            job_names=["__ASSET_JOB", "assets_job"],
            output_name="result",
            group_name=DEFAULT_GROUP_NAME,
        ...
        AssetNodeSnap(
            ...
            op_description=None,
            parent_edges=[],
            child_edges=[AssetChildEdgeSnap(AssetKey("bar"))],
            job_names=[],
            group_name=DEFAULT_GROUP_NAME,
            metadata={
                SYSTEM_METADATA_KEY_ASSET_EXECUTION_TYPE: AssetExecutionType.UNEXECUTABLE.value
...
def test_graph_output_metadata_and_description():
    ...
    assert asset_node_snaps == [
        AssetNodeSnap(
            ...
            parent_edges=[AssetParentEdgeSnap(AssetKey(["zero"]))],
            child_edges=[],
            execution_type=AssetExecutionType.MATERIALIZATION,
            op_name="three",
        ...
        AssetNodeSnap(
            ...
            parent_edges=[],
            child_edges=[AssetChildEdgeSnap(AssetKey(["three"]))],
            execution_type=AssetExecutionType.MATERIALIZATION,
            op_name="zero",
...
def test_nasty_nested_graph_asset():
    ...
    assert asset_node_snaps[-3:] == [
        AssetNodeSnap(
            ...
            parent_edges=[
                AssetParentEdgeSnap(AssetKey(["eight"])),
                AssetParentEdgeSnap(AssetKey(["five"])),
                AssetParentEdgeSnap(AssetKey(["zero"])),
            ],
            child_edges=[AssetChildEdgeSnap(AssetKey(["twenty"]))],
            execution_type=AssetExecutionType.MATERIALIZATION,
        ...
        AssetNodeSnap(
            ...
            parent_edges=[
                AssetParentEdgeSnap(AssetKey(["six"])),
                AssetParentEdgeSnap(AssetKey(["thirteen"])),
            ],
            child_edges=[],
            execution_type=AssetExecutionType.MATERIALIZATION,
        ...
        AssetNodeSnap(
            ...
            parent_edges=[],
            child_edges=[
                AssetChildEdgeSnap(AssetKey(["eight"])),
                AssetChildEdgeSnap(AssetKey(["five"])),
                AssetChildEdgeSnap(AssetKey(["six"])),
                AssetChildEdgeSnap(AssetKey(["thirteen"])),
            ],
            execution_type=AssetExecutionType.MATERIALIZATION,
            op_name="zero",
            node_definition_name="zero",
...
def test_graph_asset_description():
    ...
    assert asset_node_snaps[0].op_description == "bar"
...
def test_graph_multi_asset_description():
    ...
    assert asset_node_snaps[AssetKey("asset1")].op_description == "bar"
    assert asset_node_snaps[AssetKey("asset2")].op_description == "baz"

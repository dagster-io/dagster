  ...
  "external_pipeline_datas": [
    {
      ...
      "name": "a_pipeline",
      "parent_pipeline_snapshot_with_id": null,
      "pipeline_snapshot_with_id": {
        "__class__": "PipelineSnapshotWithID",
        "pipeline_snapshot": {
        ...
        "pipeline_snapshot_id": "408b00cba2a34559e8448a4e7ba0ac1815a5b4ad"
      }
    }
  ],

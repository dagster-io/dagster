  ...
  "pipeline_snapshot": {
    ...
    "config_schema_snapshot": {
      ...
      "all_config_snaps_by_key": {
        ...
        "Shape.27b45d5168a36b5e624371567143d7a812390583": {
          "__class__": "ConfigTypeSnap",
          "description": null,
          "enum_values": null,
          "field_aliases": {
          ...
          "given_name": null,
          "key": "Shape.27b45d5168a36b5e624371567143d7a812390583",
          "kind": {
            "__enum__": "ConfigTypeKind.STRICT_SHAPE"
          },
          "scalar_kind": null,
        ...
        "Shape.daa862de8119a9655a7922eb2b3209ba54e2a454": {
          "__class__": "ConfigTypeSnap",
          "description": null,
          "enum_values": null,
          "field_aliases": {
          ...
          "fields": [
            ...
            },
            {
              "__class__": "ConfigFieldSnap",
              "default_provided": true,
              "default_value_as_json_str": "{\\"a_op\\": {}}",
              "description": "Configure runtime parameters for ops or assets.",
              "is_required": false,
              "name": "ops",
              "type_key": "Shape.27b45d5168a36b5e624371567143d7a812390583"
            },
            {
              "__class__": "ConfigFieldSnap",
              "default_provided": true,
          ...
          "given_name": null,
          "key": "Shape.daa862de8119a9655a7922eb2b3209ba54e2a454",
          "kind": {
            "__enum__": "ConfigTypeKind.STRICT_SHAPE"
          },
          "scalar_kind": null,
    ...
    "description": null,
    "graph_def_name": "a_job_no_partitions",
    ...
    "mode_def_snaps": [
      {
        ...
        "root_config_key": "Shape.daa862de8119a9655a7922eb2b3209ba54e2a454"
      }
    ],
    "name": "a_job_no_partitions",
...
snapshots['test_external_repository_data 1'] = '''{
  ...
  "external_partition_set_datas": [
    ...
    },
    {
      ...
      "pipeline_name": "a_job_no_partitions",
      "solid_selection": null
    }
  ],

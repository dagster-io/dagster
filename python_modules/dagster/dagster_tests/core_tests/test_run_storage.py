...
def test_fetch_by_pipeline(storage):
    assert storage
    one = str(uuid.uuid4())
    two = str(uuid.uuid4())
...
def test_fetch_by_filter(storage):
    assert storage
    one = str(uuid.uuid4())
    two = str(uuid.uuid4())
...
def test_fetch_count_by_tag(storage):
    assert storage
    one = str(uuid.uuid4())
    two = str(uuid.uuid4())
    three = str(uuid.uuid4())
...
def test_fetch_by_tags(storage):
    assert storage
    one = str(uuid.uuid4())
    two = str(uuid.uuid4())
    three = str(uuid.uuid4())
...
def test_paginated_fetch(storage):
    assert storage
...
def test_fetch_by_status(storage):
    assert storage
    one = str(uuid.uuid4())
    two = str(uuid.uuid4())
    three = str(uuid.uuid4())
...
def test_fetch_by_status_cursored(storage):
    assert storage
    one = str(uuid.uuid4())
    two = str(uuid.uuid4())
    three = str(uuid.uuid4())

...
def test_basic_ops_config(snapshot):
    ...
    assert env_config_type.fields["ops"].is_required  # ty: ignore[unresolved-attribute]
    ops_config_type = env_config_type.fields["ops"].config_type  # ty: ignore[unresolved-attribute]
    ...
    assert set(env_config_type.fields["loggers"].config_type.fields.keys()) == set(["console"])  # ty: ignore[unresolved-attribute]

    console_logger_config_type = env_config_type.fields["loggers"].config_type.fields["console"]  # ty: ignore[unresolved-attribute]

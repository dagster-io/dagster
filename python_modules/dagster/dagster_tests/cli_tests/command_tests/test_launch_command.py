...
@pytest.mark.parametrize(
    "gen_job_args", [python_bar_cli_args("qux", True), grpc_server_bar_cli_args("qux", True)],
)
...
@pytest.mark.parametrize(
    "gen_pipeline_args", [python_bar_cli_args("qux", True), grpc_server_bar_cli_args("qux", True)],
)

...
def test_io_manager_add_input_metadata():
    ...
    loaded_input_event_metadata = loaded_input_event.event_specific_data.metadata  # ty: ignore[unresolved-attribute]
...
def test_input_manager_add_input_metadata():
    ...
    metadata = loaded_input_event.event_specific_data.metadata  # ty: ignore[unresolved-attribute]

...
def get_code_location_origin(
    ...
    return InProcessCodeLocationOrigin(
        loadable_target_origin=LoadableTargetOrigin(
            ...
            module_name=(
                "dagster_tests.definitions_tests.auto_materialize_tests.utils.asset_daemon_scenario"
            ),
...
class AssetDaemonScenarioState(AssetScenarioState):
    ...
    @staticmethod
    def create_from_state(state: AssetScenarioState) -> "AssetDaemonScenarioState":
        """Creates an AssetDaemonScenarioState from an AssetScenarioState."""
        return AssetDaemonScenarioState(
...
class AssetDaemonScenario(NamedTuple):
    ...
    id: str
    initial_state: AssetScenarioState
    ...
    def evaluate_fast(self) -> None:
        ...
        self.execution_fn(
            dataclasses.replace(
                AssetDaemonScenarioState.create_from_state(self.initial_state),

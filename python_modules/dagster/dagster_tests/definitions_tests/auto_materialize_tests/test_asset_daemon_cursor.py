...
def test_forwards_compat() -> None:
    forwardscompat_serialized = """{"__class__": "AssetDaemonCursor", "evaluation_id": 42, "last_observe_request_timestamp_by_asset_key": {"__mapping_items__": []}, "previous_evaluation_state": []}"""

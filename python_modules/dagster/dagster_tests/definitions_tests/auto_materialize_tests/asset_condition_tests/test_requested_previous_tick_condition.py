from dagster._core.definitions.declarative_scheduling import RequestedPreviousTickCondition
...
def test_requested_previous_tick() -> None:
    ...
    state = SchedulingConditionScenarioState(
        ...
        # the inner condition
        scheduling_condition=(RequestedPreviousTickCondition() & false_condition)
        | hardcoded_condition,

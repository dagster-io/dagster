...
def test_label_scheduling_condition() -> None:
    not_missing = (~SchedulingCondition.missing()).with_label("Not missing")
    not_in_progress = (~SchedulingCondition.in_progress()).with_label("Not in progress")

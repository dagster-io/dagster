...
def test_partition_with_end_date(
    ...
    first_partition_window_ = TimeWindow(
        start=datetime.strptime(first_partition_window[0], fmt).astimezone(timezone.utc),
        end=datetime.strptime(first_partition_window[1], fmt).astimezone(timezone.utc),
    )

    last_partition_window_ = TimeWindow(
        start=datetime.strptime(last_partition_window[0], fmt).astimezone(timezone.utc),
        end=datetime.strptime(last_partition_window[1], fmt).astimezone(timezone.utc),
    )

...
STUB_LOCATION_PATH = Path(__file__).parent / "stubs" / "sling_replication_location"
COMPONENT_RELPATH = "components/file_ingest"
...
def test_python_params(sling_path: Path) -> None:
    component = SlingReplicationComponent.from_decl_node(
        ...
        decl_node=YamlComponentDecl(
            path=sling_path / "components" / "file_ingest",

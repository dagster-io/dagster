...
def test_multi_asset_io_manager_execution_specs() -> None:
    ...
    assert my_asset.op.output_defs[0].dagster_type == dg.Int
    assert my_asset.op.output_defs[1].dagster_type == dg.Nothing
    assert my_asset.op.output_defs[2].dagster_type == dg.Any

...
def test_input_has_asset_key():
    ...
    @asset(upstream_assets={AssetKey(["b", "asset1"])})
    def asset2():
        ...
...
def test_upstream_same_name_as_asset():
    @asset(upstream_assets={AssetKey("asset1")}, key_prefix="b")
    def asset1():
        ...
    ...
    @multi_asset(
        outs={"asset1": AssetOut(key_prefix="b")}, upstream_assets={AssetKey(["a", "asset1"])}
    )
    def multi_asset1():
        ...

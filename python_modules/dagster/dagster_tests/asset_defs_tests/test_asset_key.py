...
# These tests pin the current behavior around getting forward slashes into asset keys
# We may want to forbid this in the future
...
def test_to_asset_key_path():
    ...
    assert AssetKey.from_escaped_user_string("foo/bar/baz").path == ["foo", "bar", "baz"]

...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('tag:"<null>"', AssetSelection.tag("<null>", "", include_sources=True, is_null=False)),
        ('tag:""', AssetSelection.tag("", "", include_sources=True, is_null=False)),
        ("tag:<null>", AssetSelection.tag("", "", include_sources=True, is_null=True)),
        ("owner:<null>", AssetSelection.owner("", is_null=True)),
        ("group:<null>", AssetSelection.groups("", include_sources=True, is_null=True)),
        (
            "kind:<null>",
            AssetSelection.kind("", include_sources=True, is_null=True),
        ),
        (
            "code_location:<null>",
            CodeLocationAssetSelection(selected_code_location="", is_null=True),
        ),
        ("column:<null>", ColumnAssetSelection(selected_column="", is_null=True)),
        ("table_name:<null>", TableNameAssetSelection(selected_table_name="", is_null=True)),
        ("column_tag:<null>", ColumnTagAssetSelection(key="", value="", is_null=True)),
        (
            "changed_in_branch:<null>",
            ChangedInBranchAssetSelection(selected_changed_in_branch="", is_null=True),
        ),
    ],
)

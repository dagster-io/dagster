...
def diff_dicts(config_dict: Dict[str, Any], dst_dict: Dict[str, Any]) -> ManagedStackDiff:
    """
    ...
    for key in set(config_dict.keys()).union(set(dst_dict.keys())):
        ...
        # Airbyte returns secrets as asterisks via the API, so we can't compare them

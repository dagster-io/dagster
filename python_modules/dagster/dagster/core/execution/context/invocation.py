...
class UnboundSolidExecutionContext(OpExecutionContext):
    ...
    def __init__(
        ...
        upstream_mapping_key: Optional[str],
    ):  # pylint: disable=super-init-not-called
        ...
        self._upstream_mapping_key = upstream_mapping_key
    ...
    def bind(
        ...
        return BoundSolidExecutionContext(
            ...
            upstream_mapping_key=self._upstream_mapping_key,
        )
    ...
    def get_mapping_key(self) -> Optional[str]:
        return self._upstream_mapping_key
...
def build_op_context(
    ...
    upstream_mapping_key: Optional[str] = None,
) -> OpExecutionContext:
    ...
    Args:
        ...
        upstream_mapping_key (Optional[str]): A key representing the mapping key from an upstream dynamic output. Can be accessed using ``context.get_mapping_key()``.
    ...
    return build_solid_context(
        ...
        upstream_mapping_key=upstream_mapping_key,
    )
...
def build_solid_context(
    ...
    return UnboundSolidExecutionContext(
        ...
        upstream_mapping_key=check.opt_str_param(upstream_mapping_key, "upstream_mapping_key"),
    )

...
@whitelist_for_serdes
class JobState(namedtuple("_JobState", "origin job_type status last_completed_timestamp")):
    def __new__(cls, origin, job_type, status, last_completed_timestamp=None):

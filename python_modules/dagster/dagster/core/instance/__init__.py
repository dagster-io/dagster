    ...
    def get_tick_retention_settings(
        ...
        DEFAULT_RETENTION_SETTINGS = {
            InstigatorType.SCHEDULE: {
                TickStatus.STARTED: 90,
                TickStatus.SKIPPED: 90,
                TickStatus.SUCCESS: 90,
                TickStatus.FAILURE: 90,
            },
            InstigatorType.SENSOR: {
                TickStatus.STARTED: 30,
                TickStatus.SKIPPED: 7,
                TickStatus.SUCCESS: 30,
                TickStatus.FAILURE: 30,
            },
        }
        ...
        if isinstance(purge_value, int):
            ...
            return {
                ...
                status: purge_value.get(status, default_value)

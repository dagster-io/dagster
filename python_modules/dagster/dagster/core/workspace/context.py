...
class BaseWorkspaceRequestContext(IWorkspace):
    ...
    def has_external_pipeline(self, selector: JobSelector) -> bool:
    ...
    def get_full_external_pipeline(self, selector: JobSelector) -> ExternalPipeline:
        return (
            self.get_repository_location(selector.location_name)
            .get_repository(selector.repository_name)
            .get_full_external_pipeline(selector.job_name)
        )

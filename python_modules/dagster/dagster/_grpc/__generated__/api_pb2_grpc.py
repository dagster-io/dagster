...
class DagsterApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExternalConditionEvaluation = channel.unary_unary(
            "/api.DagsterApi/ExternalConditionEvaluation",
            request_serializer=api__pb2.ExternalConditionEvaluationRequest.SerializeToString,
            response_deserializer=api__pb2.ExternalConditionEvaluationReply.FromString,
        )
...
def add_DagsterApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "ExternalConditionEvaluation": grpc.unary_unary_rpc_method_handler(
            servicer.ExternalConditionEvaluation,
            request_deserializer=api__pb2.ExternalConditionEvaluationRequest.FromString,
            response_serializer=api__pb2.ExternalConditionEvaluationReply.SerializeToString,
        ),
...
class DagsterApi(object):
    ...
    def ExternalConditionEvaluation(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/api.DagsterApi/ExternalConditionEvaluation",
            api__pb2.ExternalConditionEvaluationRequest.SerializeToString,
            api__pb2.ExternalConditionEvaluationReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

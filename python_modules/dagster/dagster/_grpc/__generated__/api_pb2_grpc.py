...
class DagsterApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ModifyBlueprint = channel.unary_unary(
            "/api.DagsterApi/ModifyBlueprint",
            request_serializer=api__pb2.ModifyBlueprintRequest.SerializeToString,
            response_deserializer=api__pb2.ModifyBlueprintReply.FromString,
        )
...
class DagsterApiServicer(object):
    ...
    def ModifyBlueprint(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_DagsterApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "ModifyBlueprint": grpc.unary_unary_rpc_method_handler(
            servicer.ModifyBlueprint,
            request_deserializer=api__pb2.ModifyBlueprintRequest.FromString,
            response_serializer=api__pb2.ModifyBlueprintReply.SerializeToString,
        ),
    }
...
class DagsterApi(object):
    ...
    def ModifyBlueprint(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/api.DagsterApi/ModifyBlueprint",
            api__pb2.ModifyBlueprintRequest.SerializeToString,
            api__pb2.ModifyBlueprintReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

...
_CHECKSTACKSYNCREQUEST = _descriptor.Descriptor(
    name="CheckStackSyncRequest",
    full_name="api.CheckStackSyncRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="serialized_check_stack_sync_request",
            full_name="api.CheckStackSyncRequest.serialized_check_stack_sync_request",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CHECKSTACKSYNCRESULT = _descriptor.Descriptor(
    name="CheckStackSyncResult",
    full_name="api.CheckStackSyncResult",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="serialized_check_stack_sync_result",
            full_name="api.CheckStackSyncResult.serialized_check_stack_sync_result",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_APPLYSTACKCHANGESREQUEST = _descriptor.Descriptor(
    name="ApplyStackChangesRequest",
    full_name="api.ApplyStackChangesRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="serialized_apply_stack_changes_request",
            full_name="api.ApplyStackChangesRequest.serialized_apply_stack_changes_request",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_APPLYSTACKCHANGESRESULT = _descriptor.Descriptor(
    name="ApplyStackChangesResult",
    full_name="api.ApplyStackChangesResult",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="serialized_apply_stack_changes_result",
            full_name="api.ApplyStackChangesResult.serialized_apply_stack_changes_result",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name["CheckStackSyncRequest"] = _CHECKSTACKSYNCREQUEST
DESCRIPTOR.message_types_by_name["CheckStackSyncResult"] = _CHECKSTACKSYNCRESULT
DESCRIPTOR.message_types_by_name["ApplyStackChangesRequest"] = _APPLYSTACKCHANGESREQUEST
DESCRIPTOR.message_types_by_name["ApplyStackChangesResult"] = _APPLYSTACKCHANGESRESULT
...
CheckStackSyncRequest = _reflection.GeneratedProtocolMessageType(
    "CheckStackSyncRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _CHECKSTACKSYNCREQUEST,
        "__module__": "api_pb2"
        # @@protoc_insertion_point(class_scope:api.CheckStackSyncRequest)
    },
)
_sym_db.RegisterMessage(CheckStackSyncRequest)

CheckStackSyncResult = _reflection.GeneratedProtocolMessageType(
    "CheckStackSyncResult",
    (_message.Message,),
    {
        "DESCRIPTOR": _CHECKSTACKSYNCRESULT,
        "__module__": "api_pb2"
        # @@protoc_insertion_point(class_scope:api.CheckStackSyncResult)
    },
)
_sym_db.RegisterMessage(CheckStackSyncResult)

ApplyStackChangesRequest = _reflection.GeneratedProtocolMessageType(
    "ApplyStackChangesRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _APPLYSTACKCHANGESREQUEST,
        "__module__": "api_pb2"
        # @@protoc_insertion_point(class_scope:api.ApplyStackChangesRequest)
    },
)
_sym_db.RegisterMessage(ApplyStackChangesRequest)

ApplyStackChangesResult = _reflection.GeneratedProtocolMessageType(
    "ApplyStackChangesResult",
    (_message.Message,),
    {
        "DESCRIPTOR": _APPLYSTACKCHANGESRESULT,
        "__module__": "api_pb2"
        # @@protoc_insertion_point(class_scope:api.ApplyStackChangesResult)
    },
)
_sym_db.RegisterMessage(ApplyStackChangesResult)
...
_DAGSTERAPI = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="CheckStackSync",
            full_name="api.DagsterApi.CheckStackSync",
            index=19,
            containing_service=None,
            input_type=_CHECKSTACKSYNCREQUEST,
            output_type=_CHECKSTACKSYNCRESULT,
            serialized_options=None,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="ApplyStackChanges",
            full_name="api.DagsterApi.ApplyStackChanges",
            index=20,
            containing_service=None,
            input_type=_APPLYSTACKCHANGESREQUEST,
            output_type=_APPLYSTACKCHANGESRESULT,
            serialized_options=None,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(

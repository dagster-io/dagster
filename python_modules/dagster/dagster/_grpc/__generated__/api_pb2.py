...
_EXTERNALJOBREPLY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="serialized_external_job_data",
            full_name="api.ExternalJobReply.serialized_external_job_data",
            index=0,
            number=1,
            type=9,
            cpp_type=9,

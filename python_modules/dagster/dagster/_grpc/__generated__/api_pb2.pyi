...
@typing_extensions.final
class ModifyBlueprintRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    SERIALIZED_MODIFY_BLUEPRINT_REQUEST_FIELD_NUMBER: builtins.int
    serialized_modify_blueprint_request: builtins.str
    def __init__(
        self,
        *,
        serialized_modify_blueprint_request: builtins.str = ...,
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "serialized_modify_blueprint_request", b"serialized_modify_blueprint_request"
        ],
    ) -> None: ...

global___ModifyBlueprintRequest = ModifyBlueprintRequest

@typing_extensions.final
class ModifyBlueprintReply(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    SERIALIZED_MODIFY_BLUEPRINT_REPLY_FIELD_NUMBER: builtins.int
    serialized_modify_blueprint_reply: builtins.str
    def __init__(
        self,
        *,
        serialized_modify_blueprint_reply: builtins.str = ...,
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "serialized_modify_blueprint_reply", b"serialized_modify_blueprint_reply"
        ],
    ) -> None: ...

global___ModifyBlueprintReply = ModifyBlueprintReply

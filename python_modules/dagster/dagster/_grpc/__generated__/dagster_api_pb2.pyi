...
@typing.final
class ComponentInstanceContentsRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    SERIALIZED_REQUEST_FIELD_NUMBER: builtins.int
    serialized_request: builtins.str
    def __init__(
        self,
        *,
        serialized_request: builtins.str = ...,
    ...
    def ClearField(
        self, field_name: typing.Literal["serialized_request", b"serialized_request"]
    ) -> None: ...

global___ComponentInstanceContentsRequest = ComponentInstanceContentsRequest

@typing.final
class ComponentInstanceContentsReply(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    SERIALIZED_RESPONSE_FIELD_NUMBER: builtins.int
    SERIALIZED_ERROR_FIELD_NUMBER: builtins.int
    serialized_response: builtins.str
    serialized_error: builtins.str
    def __init__(
        self,
        *,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "serialized_error", b"serialized_error", "serialized_response", b"serialized_response"
        ],
    ) -> None: ...

global___ComponentInstanceContentsReply = ComponentInstanceContentsReply

@typing.final
class ComponentInstancePreviewRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ComponentInstancePreviewRequest = ComponentInstancePreviewRequest

@typing.final
class ComponentInstancePreviewReply(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ComponentInstancePreviewReply = ComponentInstancePreviewReply

@typing.final
class ScaffoldedComponentInstancePreviewRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ScaffoldedComponentInstancePreviewRequest = ScaffoldedComponentInstancePreviewRequest

@typing.final
class ScaffoldedComponentInstancePreviewReply(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ScaffoldedComponentInstancePreviewReply = ScaffoldedComponentInstancePreviewReply

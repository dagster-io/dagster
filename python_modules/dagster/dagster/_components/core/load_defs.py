...
from dagster._components.core.context import ComponentLoadContext, use_component_load_context
...
def load_defs(defs_root: ModuleType) -> Definitions:
    ...
    """
    from dagster._components.core.defs_module import DefsModuleComponent

...
def get_pipeline_snapshot_from_cli_args(cli_args):
    ...
    if cli_args.get('image'):
        ...
        external_repo_data = get_external_repository_data_from_image(cli_args.get('image'))
        return external_repo_data.get_pipeline_snapshot(cli_args.get('pipeline_name')[0])
    else:

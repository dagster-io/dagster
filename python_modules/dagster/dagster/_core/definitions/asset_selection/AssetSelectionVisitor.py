...
class AssetSelectionVisitor(ParseTreeVisitor):
    ...
    def visitBothTraversalExpression(self, ctx:AssetSelectionParser.BothTraversalExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitRightTraversalExpression(self, ctx:AssetSelectionParser.RightTraversalExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitLeftTraversalExpression(self, ctx:AssetSelectionParser.LeftTraversalExpressionContext):
        return self.visitChildren(ctx)

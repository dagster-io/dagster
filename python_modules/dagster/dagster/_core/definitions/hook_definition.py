from typing import Any, Callable, Iterator, Optional, NamedTuple, AbstractSet, cast
...
from .resource_requirement import RequiresResources, ResourceRequirement, HookResourceRequirement

...
if TYPE_CHECKING:
    from dagster._core.definitions.auto_materialize_policy_evaluator import (
        AutoMaterializePolicyEvaluator,
    )
...
class AutoMaterializePolicy(
    ...
    **Warning:**
    ...
    def to_auto_materialize_policy_evaluator(self) -> "AutoMaterializePolicyEvaluator":
        """Converts a set of materialize / skip rules into a single binary expression."""
        from .auto_materialize_policy_evaluator import AutoMaterializePolicyEvaluator, RuleCondition
        ...
        return AutoMaterializePolicyEvaluator(
            condition=condition,

...
if TYPE_CHECKING:
    from .operands import (
        ...
        MaterializedSchedulingCondition,
    )
...
class SchedulingCondition(ABC, DagsterModel):
    ...
    @staticmethod
    def materialized() -> "MaterializedSchedulingCondition":
        """Returns a SchedulingCondition that is true for an asset partition if it has been materialized."""
        from .operands import MaterializedSchedulingCondition

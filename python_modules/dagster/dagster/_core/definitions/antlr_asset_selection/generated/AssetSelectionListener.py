...
class AssetSelectionListener(ParseTreeListener):
    ...
    def enterParenthesizedExpression(self, ctx:AssetSelectionParser.ParenthesizedExpressionContext):
        pass
    ...
    def enterDownTraversalExpression(self, ctx:AssetSelectionParser.DownTraversalExpressionContext):
        pass
    ...
    def enterUpAndDownTraversalExpression(self, ctx:AssetSelectionParser.UpAndDownTraversalExpressionContext):
        pass

    # Exit a parse tree produced by AssetSelectionParser#UpAndDownTraversalExpression.
    def exitUpAndDownTraversalExpression(self, ctx:AssetSelectionParser.UpAndDownTraversalExpressionContext):
        pass
    ...
    # Enter a parse tree produced by AssetSelectionParser#KeySubsetExpr.
    def enterKeySubsetExpr(self, ctx:AssetSelectionParser.KeySubsetExprContext):
        pass

    # Exit a parse tree produced by AssetSelectionParser#KeySubsetExpr.
    def exitKeySubsetExpr(self, ctx:AssetSelectionParser.KeySubsetExprContext):
        pass
    ...
    def enterCodeLocationAttributeExpr(self, ctx:AssetSelectionParser.CodeLocationAttributeExprContext):
        pass

    # Exit a parse tree produced by AssetSelectionParser#CodeLocationAttributeExpr.
    def exitCodeLocationAttributeExpr(self, ctx:AssetSelectionParser.CodeLocationAttributeExprContext):
        pass

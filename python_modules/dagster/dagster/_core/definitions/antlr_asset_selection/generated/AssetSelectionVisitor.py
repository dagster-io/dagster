...
class AssetSelectionVisitor(ParseTreeVisitor):
    ...
    def visitParenthesizedExpression(self, ctx:AssetSelectionParser.ParenthesizedExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitDownTraversalExpression(self, ctx:AssetSelectionParser.DownTraversalExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitUpAndDownTraversalExpression(self, ctx:AssetSelectionParser.UpAndDownTraversalExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitCodeLocationAttributeExpr(self, ctx:AssetSelectionParser.CodeLocationAttributeExprContext):
        return self.visitChildren(ctx)

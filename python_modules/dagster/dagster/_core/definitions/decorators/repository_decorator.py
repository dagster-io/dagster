...
class _Repository:
    def __init__(
        ...
        self.component_origin = component_origin
...
def repository(
    *,
    ...
    _component_origin: Optional["ComponentOrigin"],
) -> _Repository: ...
...
def repository(
    ...
    *,
    ...
    _component_origin: Optional["ComponentOrigin"] = None,
    ...
    return _Repository(
        ...
        component_origin=_component_origin,
    )

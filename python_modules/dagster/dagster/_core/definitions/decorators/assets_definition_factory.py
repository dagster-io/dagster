...
from dagster._core.definitions.assets import ASSET_SUBSET_INPUT_PREFIX, AssetsDefinition
...
class AssetsDefinitionBuilder:
    ...
    def from_args(*, fn: Callable[..., Any], args: AssetsDefinitionBuilderArgs):
        ...
        return AssetsDefinitionBuilder.from_non_spec_args(fn=fn, op_name=op_name, args=args)

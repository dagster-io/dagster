...
from dagster._core.execution.retries import (
    RetryMode,
    get_allow_execution_after_failed_steps_config,
    get_retries_config,
)
...
def _core_in_process_executor_creation(config: ExecutorConfig) -> "InProcessExecutor":
    ...
    return InProcessExecutor(
        ...
        allow_execution_after_failed_steps=config.get("allow_execution_after_failed_steps"),  # type: ignore  # (should be bool)
    )
...
IN_PROC_CONFIG = Field(
    {
        ...
        "allow_execution_after_failed_steps": get_allow_execution_after_failed_steps_config(),
    },

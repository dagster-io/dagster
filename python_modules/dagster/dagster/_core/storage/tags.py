...
RETRY_ON_RUN_EXCEPTION_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_run_exception"
RETRY_ON_ASSET_OR_OP_FAILURE_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_asset_or_op_failure"
RETRY_ON_JOB_INITIALIZATION_FAILURE_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_job_initialization_failure"
RETRY_ON_START_TIMEOUT_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_start_timeout"
RETRY_ON_UNKNOWN_FAILURE_TAG = f"{SYSTEM_TAG_PREFIX}retry_on_unknown_failure"

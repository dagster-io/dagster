...
class RunRecord(
    NamedTuple(
        ...
        [
            ...
            ("public_update_timestamp", Optional[float]),
        ],
    ),
    LoadableBy[str],
):
    ...
    def __new__(
        ...
        public_update_timestamp: Optional[float] = None,
    ):
        return super().__new__(
            cls,
            ...
            public_update_timestamp=check.opt_float_param(
                public_update_timestamp, "public_update_timestamp"
            ),
        )

...
class DagsterInstance(DynamicPartitionsStore):
    ...
    def get_materialization_records(
        ...
        Returns:
            List[EventLogRecord]: List of event log records stored in the event log storage.
        """
        return self._event_storage.get_materialization_records(records_filter, limit, ascending)
    ...
    def get_observation_records(
        ...
        Returns:
            List[EventLogRecord]: List of event log records stored in the event log storage.
        """
        return self._event_storage.get_observation_records(records_filter, limit, ascending)

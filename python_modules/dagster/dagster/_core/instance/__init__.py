...
class DagsterInstance:
    ...
    def create_run(
        ...
        *,
        ...
        # if step_keys_to_execute is None, then everything is executed
        # In some cases callers are still exploding and sending the full list of step keys,
        # even though that is unnecessary
        ...
        # pipeline_snapshot should always be set in production scenarios. In some tests we omit it
        # parent_pipeline_snapshot is set in cases where the pipeline has been subsetted

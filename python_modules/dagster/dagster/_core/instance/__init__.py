...
class DagsterInstance(DynamicPartitionsStore):
    ...
    def delete_runs(self, run_ids: Sequence[str]) -> None:
        """Delete runs and all events generated by those runs from storage.

        Args:
            run_ids (Sequence[str]): The ids of the runs to delete.
        """
        self._run_storage.delete_runs(run_ids)
        self._event_storage.delete_events_for_runs(run_ids)

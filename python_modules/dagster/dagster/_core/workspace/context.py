...
class BaseWorkspaceRequestContext(IWorkspace):
    ...
    @property
    @abstractmethod
    def asset_summary_record_loader(self) -> AssetSummaryRecordLoader:
        pass
...
class WorkspaceRequestContext(BaseWorkspaceRequestContext):
    def __init__(
        ...
        self._asset_summary_record_loader = AssetSummaryRecordLoader(self._instance, {})

    @property
    def asset_summary_record_loader(self) -> AssetSummaryRecordLoader:
        return self._asset_summary_record_loader

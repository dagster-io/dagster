...
from dagster_pipes import (
    ...
    DefaultPipesProcessContextLoader,
...
class ExtFileContextInjector(ExtContextInjector):
    ...
    def inject_context(self, context_data: "PipesProcessContextData") -> Iterator[PipesParams]:
        ...
        try:
            yield {DefaultPipesProcessContextLoader.FILE_PATH_KEY: self._path}
        finally:
...
class ExtEnvContextInjector(ExtContextInjector):
    ...
    def inject_context(
        ...
        yield {DefaultPipesProcessContextLoader.DIRECT_KEY: context_data}

...
class PipesSession:
    ...
    def default_remote_invocation_tags(self) -> Dict[str, str]:
        """Remote execution environments commonly have their own concepts of tags or labels.
        It's useful to include dagster-specific metadata in these environments to help with debugging,
        monitoring, and linking remote resources back to Dagster.
        For example, the Kubernetes Pipes client is using these tags as Kubernetes labels.

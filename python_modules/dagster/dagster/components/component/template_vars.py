...
def get_static_template_vars(cls: type) -> dict[str, TemplateVarFn]:
    """Find all staticmethods in a class that can be used as template variables (no context).
        ...
        if is_staticmethod(cls, method):
            ...
            if is_template_var(func):
                ...
                if len(sig.parameters) == 0:
                    ...
                    # Skip context-requiring functions - they're handled by get_context_aware_static_template_vars
                    continue
                else:
                    raise ValueError(

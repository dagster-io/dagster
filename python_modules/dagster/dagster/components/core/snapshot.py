...
def get_package_entry_snap(key: DgRegistryKey, obj: object) -> DgRegistryObjectSnap:
    type_data = []
    owners = []
    tags = []
    aliases = []
    if isinstance(obj, type) and issubclass(obj, Component):
        ...
        if obj.__module__ != key.namespace:
            ...
            aliases.append(DgRegistryKey(namespace=obj.__module__, name=obj.__name__))

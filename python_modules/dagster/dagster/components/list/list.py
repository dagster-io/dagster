...
from dagster_shared.serdes.objects.package_entry import DgRegistryManifest
...
) -> Union[DgRegistryManifest, SerializableErrorInfo]:
...
def _load_component_types(
    entry_points: bool, extra_modules: Sequence[str]
) -> dict[DgRegistryKey, type[Component]]:
    return {
        key: obj

...
class TestEnhancedSectionHeaderDetection:
    ...
    def test_missing_colon_detection(self):
        ...
        fixtures_module = importlib.import_module(
            "automation_tests.dagster_docs_tests.enhanced_section_headers.missing_colon_cases"
        )

        result = validate_docstring_text(
            fixtures_module.MissingColonCases.basic_missing_colons.__doc__ or "",
            "MissingColonCases.basic_missing_colons",
        )
    ...
    def test_incorrect_capitalization_detection(self):
        ...
        fixtures_module = importlib.import_module(
            "automation_tests.dagster_docs_tests.enhanced_section_headers.capitalization_cases"
        )

        result = validate_docstring_text(
            fixtures_module.CapitalizationCases.incorrect_capitalization.__doc__ or "",
            "CapitalizationCases.incorrect_capitalization",
        )
    ...
    def test_incorrect_spacing_detection(self):
        ...
        fixtures_module = importlib.import_module(
            "automation_tests.dagster_docs_tests.enhanced_section_headers.spacing_cases"
        )

        result = validate_docstring_text(
            fixtures_module.SpacingCases.incorrect_spacing.__doc__ or "",
            "SpacingCases.incorrect_spacing",
        )
    ...
    def test_corrupted_section_header_detection(self):
        ...
        fixtures_module = importlib.import_module(
            "automation_tests.dagster_docs_tests.enhanced_section_headers.corrupted_headers"
        )

        result = validate_docstring_text(
            fixtures_module.CorruptedHeaderCases.basic_corrupted_header.__doc__ or "",
            "CorruptedHeaderCases.basic_corrupted_header",
        )
    ...
    def test_multiple_header_errors(self):
        ...
        result = validate_docstring_text(
            fixtures_module.MissingColonCases.multiple_header_errors.__doc__ or "",
            "MissingColonCases.multiple_header_errors",
        )
    ...
    def test_valid_section_headers_pass(self):
        ...
        result = validate_docstring_text(
            fixtures_module.CapitalizationCases.valid_section_headers.__doc__ or "",
            "CapitalizationCases.valid_section_headers",
        )
...
class TestEnhancedRSTErrorMessages:
    ...
    def test_unexpected_indentation_message_enhancement(self):
        ...
        result = validate_docstring_text(
            fixtures_module.MissingColonCases.unexpected_indentation_case.__doc__ or "",
            "MissingColonCases.unexpected_indentation_case",
        )
    ...
    def test_block_quote_error_message_enhancement(self):
        ...
        result = validate_docstring_text(
            fixtures_module.SpacingCases.block_quote_formatting_issues.__doc__ or "",
            "SpacingCases.block_quote_formatting_issues",
        )
    ...
    def test_code_block_error_enhancement_still_works(self):
        ...
        fixtures_module = importlib.import_module(
            "automation_tests.dagster_docs_tests.enhanced_section_headers.edge_cases"
        )

        result = validate_docstring_text(
            fixtures_module.EdgeCasesFixtures.code_block_enhancement_test.__doc__ or "",
            "EdgeCasesFixtures.code_block_enhancement_test",
        )
...
class TestSectionHeaderEdgeCases:
    ...
    def test_short_corrupted_headers_ignored(self):
        ...
        result = validate_docstring_text(
            fixtures_module.CorruptedHeaderCases.short_headers_not_flagged.__doc__ or "",
            "CorruptedHeaderCases.short_headers_not_flagged",
        )
    ...
    def test_headers_within_code_blocks_ignored(self):
        ...
        result = validate_docstring_text(
            fixtures_module.EdgeCasesFixtures.headers_within_code_blocks.__doc__ or "",
            "EdgeCasesFixtures.headers_within_code_blocks",
        )
    ...
    def test_multiple_colons_in_line(self):
        ...
        result = validate_docstring_text(
            fixtures_module.CorruptedHeaderCases.multiple_colons_in_content.__doc__ or "",
            "CorruptedHeaderCases.multiple_colons_in_content",
        )
    ...
    def test_case_sensitivity_boundaries(self):
        ...
        result = validate_docstring_text(
            fixtures_module.CapitalizationCases.all_caps_case.__doc__ or "",
            "CapitalizationCases.all_caps_case",
        )
    ...
    def test_whitespace_variants(self):
        ...
        result = validate_docstring_text(
            fixtures_module.SpacingCases.whitespace_variants.__doc__ or "",
            "SpacingCases.whitespace_variants",
        )
    ...
    def test_attributes_in_code_block_should_not_be_flagged(self):
        ...
        result = validate_docstring_text(
            fixtures_module.EdgeCasesFixtures.template_var_attributes_example.__doc__ or "",
            "EdgeCasesFixtures.template_var_attributes_example",
        )
    ...
    def test_see_also_with_cross_references_should_not_warn(self):
        ...
        result = validate_docstring_text(
            fixtures_module.EdgeCasesFixtures.see_also_cross_references.__doc__ or "",
            "EdgeCasesFixtures.see_also_cross_references",
        )

...
from automation.docs_cli.commands.ls import _list_package_symbols
from automation.docs_cli.commands.watch import _resolve_symbol_file_path
...
class TestCheckHelperFunctions:
    ...
    def test_validate_single_symbol_success(self):
        ...
        result = _validate_single_symbol(validator, "automation.docstring_lint.DocstringValidator")
    ...
    def test_validate_package_symbols_success(self):
        ...
        result = _validate_package_symbols(validator, "automation.docstring_lint")
    ...
    @patch("automation.docs_cli.commands.check.Path.cwd")
    ...
    @patch("automation.docs_cli.commands.check._find_git_root")
    ...
    @patch("automation.docs_cli.commands.check.git_changed_files")
    @patch("automation.docs_cli.commands.check._find_git_root")
...
class TestLsHelperFunctions:
    ...
    def test_list_package_symbols_success(self):
        ...
        _list_package_symbols("automation.docstring_lint")
...
class TestWatchHelperFunctions:
    ...
    def test_resolve_symbol_file_path_success(self):
        ...
        result = _resolve_symbol_file_path("automation.docstring_lint.DocstringValidator", False)
    ...
    def test_resolve_symbol_file_path_verbose_mode(self):
        ...
        result = _resolve_symbol_file_path("automation.docstring_lint.DocstringValidator", True)

...
class TestPublicMethodFiltering:
    ...
    def test_identifies_only_public_methods_on_public_classes(self, importer):
        ...
        methods = importer.get_all_public_annotated_methods(module_path)
    ...
    def test_nonexistent_module_raises_import_error(self, importer):
        ...
        with pytest.raises(ModuleNotFoundError, match="No module named"):
            importer.get_all_public_annotated_methods("nonexistent.module.that.does.not.exist")
    ...
    def test_empty_module_returns_empty_list(self, importer):
        ...
        try:
            methods = importer.get_all_public_annotated_methods("json")

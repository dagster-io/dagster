...
class Manager:
    ...
    def define_out_of_pipeline_info(self):
        ...
        with yield_context(pipeline_def, {}, ReentrantInfo("")) as context:
...
def get_info():
    if not MANAGER_FOR_NOTEBOOK_INSTANCE.info:
        MANAGER_FOR_NOTEBOOK_INSTANCE.define_out_of_pipeline_info()

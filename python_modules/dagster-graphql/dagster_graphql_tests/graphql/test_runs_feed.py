...
GET_RUNS_FEED_QUERY = """
query RunsFeedEntryQuery($cursor: String, $limit: Int!, $filter: RunsFilter,  $excludeSubruns: Boolean!) {
    runsFeedOrError(cursor: $cursor, limit: $limit, filter: $filter, excludeSubruns: $excludeSubruns) {

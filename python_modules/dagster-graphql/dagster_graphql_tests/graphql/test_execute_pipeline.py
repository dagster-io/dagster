...
1     3     4    7      49'''
    ...
    assert has_filesystem_intermediate(run_id, 'sum_solid.num.read', 'input_thunk_output')
    ...
    assert not has_filesystem_intermediate(new_run_id, 'sum_solid.num.read', 'input_thunk_output')

...
snapshots['test_success_whole_execution_plan_with_in_memory_config 1'] = {
    'executePlan': {
        ...
        'stepEvents': [
            ...
            {
                '__typename': 'ObjectStoreOperationEvent',
                'message': 'Retrieved intermediate object for input sum_df in memory object store using pickle.',
                'stepKey': 'sum_sq_solid.compute'
            },
            {
                '__typename': 'ExecutionStepInputEvent',
...
snapshots['TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_postgres_instance_managed_grpc_env] 1'] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [
            {

...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_in_memory_instance_in_process_env] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
        'pipelineName': 'csv_hello_world',
    }
}

snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_in_memory_instance_out_of_process_env] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_in_memory_instance_multi_location] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_sqlite_instance_in_process_env] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_sqlite_instance_out_of_process_env] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_sqlite_instance_multi_location] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots['test_pipeline_not_found_error_execute_plan 1'] = {
    'executePlan': {'__typename': 'PipelineNotFoundError', 'pipelineName': 'nope'}
}
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_in_memory_instance_grpc] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_sqlite_instance_external_grpc_server] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_sqlite_instance_grpc] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],
...
snapshots[
    'TestExecutionPlan.test_invalid_config_fetch_execute_plan[readonly_postgres_instance_grpc] 1'
] = {
    'executionPlanOrError': {
        '__typename': 'PipelineConfigValidationInvalid',
        'errors': [{'message': 'Invalid scalar at path root:solids:sum_solid:inputs:num'}],

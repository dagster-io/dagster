...
snapshots['test_query_multiple_schedule_ticks 1'] = [
    ...
    {
        'scheduleDefinition': {'name': 'solid_subset_daily_decorator'},
        'stats': {'ticksFailed': 0, 'ticksSkipped': 0, 'ticksStarted': 0, 'ticksSucceeded': 0},
        'ticks': [],
        'ticksCount': 0,
    },
    {
        'scheduleDefinition': {'name': 'solid_subset_hourly_decorator'},
        'stats': {'ticksFailed': 0, 'ticksSkipped': 0, 'ticksStarted': 0, 'ticksSucceeded': 0},
        'ticks': [],
        'ticksCount': 0,
    },
    {
        'scheduleDefinition': {'name': 'solid_subset_monthly_decorator'},
        'stats': {'ticksFailed': 0, 'ticksSkipped': 0, 'ticksStarted': 0, 'ticksSucceeded': 0},
        'ticks': [],
        'ticksCount': 0,
    },
    {
        'scheduleDefinition': {'name': 'solid_subset_weekly_decorator'},
        'stats': {'ticksFailed': 0, 'ticksSkipped': 0, 'ticksStarted': 0, 'ticksSucceeded': 0},
        'ticks': [],
        'ticksCount': 0,
    },

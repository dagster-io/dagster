...
snapshots[
    ...
    "assetNodes": [
        ...
        {
            "freshnessInfo": {"currentMinutesLate": 0.0, "latestMaterializationMinutesLate": None},
...
snapshots[
    "TestAssetAwareEventLog.test_get_run_materialization[postgres_with_default_run_launcher_deployed_grpc_env] 1"

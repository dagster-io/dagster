...
snapshots['TestAssetAwareEventLog.test_all_asset_keys[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'assetsOrError': {
        '__typename': 'AssetConnection',
        'nodes': [
            {
...
snapshots['TestAssetAwareEventLog.test_asset_op[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'assetOrError': {
        'definition': {
            'op': {
                'description': None,
...
snapshots['TestAssetAwareEventLog.test_freshness_info[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'assetNodes': [
        {
            'freshnessInfo': None,
            'freshnessPolicy': None,
...
snapshots['TestAssetAwareEventLog.test_get_asset_key_materialization[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'assetOrError': {
        'assetMaterializations': [
            {
                'assetLineage': [
...
snapshots['TestAssetAwareEventLog.test_get_asset_key_not_found[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'assetOrError': {
        '__typename': 'AssetNotFoundError'
    }
}
...
snapshots['TestAssetAwareEventLog.test_get_partitioned_asset_key_materialization[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'assetOrError': {
        'assetMaterializations': [
            {
                'label': 'a',
...
snapshots['TestAssetAwareEventLog.test_get_run_materialization[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'runsOrError': {
        'results': [
            {
                'assetMaterializations': [
...
snapshots['TestAssetAwareEventLog.test_op_assets[sqlite_with_default_run_launcher_code_server_cli_env] 1'] = {
    'repositoryOrError': {
        'usedSolid': {
            'definition': {
                'assetNodes': [

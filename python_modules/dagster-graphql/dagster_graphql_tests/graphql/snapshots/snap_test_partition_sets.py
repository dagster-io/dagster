...
snapshots['TestPartitionSets.test_get_partition_set[readonly_postgres_instance_lazy_repository] 1'] = {
    'partitionSetOrError': {
        '__typename': 'PartitionSet',
        'mode': 'default',
        'name': 'integer_partition',
...
snapshots['TestPartitionSets.test_get_partition_set[readonly_postgres_instance_lazy_repository] 2'] = {
    'partitionSetOrError': {
        '__typename': 'PartitionSetNotFoundError'
    }
}

snapshots['TestPartitionSets.test_get_partition_set[readonly_postgres_instance_managed_grpc_env] 1'] = {
    'partitionSetOrError': {
        '__typename': 'PartitionSet',
        'mode': 'default',
        'name': 'integer_partition',
...
snapshots['TestPartitionSets.test_get_partition_set[readonly_postgres_instance_managed_grpc_env] 2'] = {
    'partitionSetOrError': {
        '__typename': 'PartitionSetNotFoundError'
    }
}
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_postgres_instance_lazy_repository] 1'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
            {
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_postgres_instance_lazy_repository] 2'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
        ]
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_postgres_instance_managed_grpc_env] 1'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
            {
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_postgres_instance_managed_grpc_env] 2'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
        ]

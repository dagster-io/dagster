...
snapshots['TestExpectations.test_basic_expectations_within_compute_step_events[postgres_with_default_run_launcher_deployed_grpc_env] 2'] = [
    {
        '__typename': 'StepExpectationResultEvent',
        'eventType': 'STEP_EXPECTATION_RESULT',
        'expectationResult': {
...
snapshots['TestExpectations.test_basic_expectations_within_compute_step_events[postgres_with_default_run_launcher_deployed_grpc_env] 3'] = [
    {
        '__typename': 'StepExpectationResultEvent',
        'eventType': 'STEP_EXPECTATION_RESULT',
        'expectationResult': {
...
snapshots['TestExpectations.test_basic_expectations_within_compute_step_events[postgres_with_default_run_launcher_managed_grpc_env] 1'] = [
    {
        '__typename': 'StepExpectationResultEvent',
        'eventType': 'STEP_EXPECTATION_RESULT',
        'expectationResult': {
...
snapshots['TestExpectations.test_basic_expectations_within_compute_step_events[postgres_with_default_run_launcher_managed_grpc_env] 2'] = [
    {
        '__typename': 'StepExpectationResultEvent',
        'eventType': 'STEP_EXPECTATION_RESULT',
        'expectationResult': {
...
snapshots['TestExpectations.test_basic_expectations_within_compute_step_events[postgres_with_default_run_launcher_managed_grpc_env] 3'] = [
    {
        '__typename': 'StepExpectationResultEvent',
        'eventType': 'STEP_EXPECTATION_RESULT',
        'expectationResult': {

...
snapshots['TestEnvironmentSchema.test_basic_invalid_config_on_run_config_schema[readonly_postgres_instance_managed_grpc_env] 1'] = {
    'runConfigSchemaOrError': {
        'isRunConfigValid': {
            '__typename': 'PipelineConfigValidationInvalid',
            'errors': [
...
snapshots['TestEnvironmentSchema.test_basic_valid_config_on_run_config_schema[readonly_postgres_instance_managed_grpc_env] 1'] = {
    'runConfigSchemaOrError': {
        'isRunConfigValid': {
            '__typename': 'PipelineConfigValidationValid',
            'pipelineName': 'csv_hello_world'

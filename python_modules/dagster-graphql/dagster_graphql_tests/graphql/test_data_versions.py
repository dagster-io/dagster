...
# @pytest.mark.xfail(
#     reason="Bug: Downstream assets incorrectly show as stale when upstream transitions from "
#     "materializable to observable with different data versions. See "
#     "https://dagsterlabs.slack.com/archives/C06GXHNH3T8/p1759938082471509",
#     strict=True,
# )
def test_stale_status_observable_transition():
    ...
    with instance_for_test(synchronous_run_coordinator=True) as instance:
        ...
        with define_out_of_process_context(
            __file__, "get_repo_observable_transition", instance
        ) as context:
        ...
        # a new data version.
        with define_out_of_process_context(
            __file__, "get_repo_observable_transition_v2", instance
        ) as context:

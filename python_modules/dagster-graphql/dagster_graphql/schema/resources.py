...
GrapheneResourceReadinessCheckStatus = graphene.Enum.from_enum(ReadinessCheckStatus)


class GrapheneResourceReadinessCheckResult(graphene.ObjectType):
    status = graphene.NonNull(GrapheneResourceReadinessCheckStatus)
    message = graphene.NonNull(graphene.String)

    class Meta:
        name = "ResourceReadinessCheckResult"

    def __init__(self, result: ReadinessCheckResult):
        super().__init__(
...
class GrapheneResourceDetails(graphene.ObjectType):
    ...
    readinessCheckResult = graphene.Field(GrapheneResourceReadinessCheckResult)
    ...
    def resolve_readinessCheckResult(self, graphene_info) -> GrapheneResourceReadinessCheckResult:
        ...
        return GrapheneResourceReadinessCheckResult(
            instance.get_readiness_check_status(self._external_resource.name, repo_origin)
        )

...
def get_runs_feed_entries(
    ...
    exclude_subruns = view == GrapheneRunsFeedView.ALL
    ...
    should_fetch_backfills = (view == GrapheneRunsFeedView.ALL or view == GrapheneRunsFeedView.BACKFILLS) and (
...
def get_runs_feed_count(
    ...
    # to get the value to pass to the backend
    exclude_subruns = view == GrapheneRunsFeedView.RUNS
    should_fetch_runs = view == GrapheneRunsFeedView.RUNS or view == GrapheneRunsFeedView.ALL
    should_fetch_backfills = (view == GrapheneRunsFeedView.BACKFILLS or view == GrapheneRunsFeedView.ALL) and (
        _filters_apply_to_backfills(filters) if filters else True
    )
    with disable_dagster_warnings():
        run_filters = (

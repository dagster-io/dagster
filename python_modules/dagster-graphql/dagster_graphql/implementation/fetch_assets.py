...
def get_2d_run_length_encoded_partitions(
    ...
    def build_secondary_dim(secondary_subsets: Mapping[PartitionRangeStatus, PartitionsSubset]):
        ...
        return build_partition_statuses(
            dynamic_partitions_store,
            secondary_subsets.get(PartitionRangeStatus.MATERIALIZED),
            secondary_subsets.get(PartitionRangeStatus.FAILED),
            secondary_subsets.get(PartitionRangeStatus.MATERIALIZING),

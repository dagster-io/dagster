...
@capture_error
def launch_pipeline_reexecution(graphene_info: HasContext, execution_params: ExecutionParams) -> GrapheneLaunchRunSuccess:
    return _launch_pipeline_execution(graphene_info, execution_params, is_reexecuted=True)


@capture_error
def launch_pipeline_execution(graphene_info: HasContext, execution_params: ExecutionParams) -> GrapheneLaunchRunSuccess:
    return _launch_pipeline_execution(graphene_info, execution_params)


def do_launch(graphene_info: HasContext, execution_params: ExecutionParams, is_reexecuted: bool = False) -> PipelineRun:
...
@capture_error
def launch_reexecution_from_parent_run(graphene_info: HasContext, parent_run_id: str, strategy: str) -> GrapheneLaunchRunSuccess:
    """

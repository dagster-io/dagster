...
from dagster.core.storage.dagster_run import DagsterRunStatus, PipelineTarget
...
def create_valid_dagster_run(graphene_info, external_pipeline, execution_params):
    ...
    target = PipelineTarget(nameexecution_params.selector.pipeline_name, mode=execution_params.mode)

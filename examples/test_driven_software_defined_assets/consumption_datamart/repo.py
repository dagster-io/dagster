...
from consumption_datamart.assets.consumption_datamart.curated_views.active_customers_by_product_daily import active_customers_by_product_daily
...
from consumption_datamart.monitoring_graph import monitoring_daily
...
def dev_repository():
    jobs = [
        ...
        build_assets_job(
            ...
            assets=[
                fact_usage_daily,
                active_customers_by_product_daily,
            ],
            source_assets=[
                invoice_order_lines,

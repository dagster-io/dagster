...
# this is a list containing a single multi_asset representing all of the assets in the dbt project
dbt_assets = load_assets_from_dbt_manifest(
    json.load(open(os.path.join(DBT_PROJECT_DIR, "target", "manifest.json"))),
    runtime_metadata_fn=asset_metadata,
    io_manager_key="warehouse_io_manager",
)
activity_stats = build_assets_job("activity_stats", dbt_assets, [], resource_defs=DEV_RESOURCES)

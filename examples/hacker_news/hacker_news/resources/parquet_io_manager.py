...
import pandas
import pyspark
from dagster import AssetKey, Field, IOManager, MetadataValue, OutputContext, check, io_manager
...
class PartitionedParquetIOManager(IOManager):
    ...
    def handle_output(
        ...
        context.add_output_metadata({"row_count": row_count, "path": MetadataValue.path(path)})

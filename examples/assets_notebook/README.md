...
You can start writing assets in `assets_notebook/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `assets_notebook_tests` directory and you can run tests using `pytest`:

```bash
pytest assets_notebook_tests
```

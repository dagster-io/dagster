...
invalid_notebook_paths = [
    ...
    (
        '../../../legacy_examples/dagster_examples/airline_demo/notebooks/Delays_by_Geography.ipynb',
        ['cells', 6, 'outputs', 0],
    ...
    (
        '../../../legacy_examples/dagster_examples/airline_demo/notebooks/SFO_Delays_by_Destination.ipynb',
        ['cells', 6, 'outputs', 0],
        psycopg2.OperationalError.__name__,
        "could not connect to server:",
        "error",
    ...
    (
        '../../../legacy_examples/dagster_examples/airline_demo/notebooks/Fares_vs_Delays.ipynb',
        ['cells', 6, 'outputs', 0],
        psycopg2.OperationalError.__name__,
        "could not connect to server:",
        "error",

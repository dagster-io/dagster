...
def devices_at_risk(
    ...
    devices_at_risk = (
        cleaned_readings.select("UDI")
        .with_columns(pl.Series("at_risk", y_pred))
    ...
    context.add_asset_metadata({"devices_at_risk": devices_at_risk_list})

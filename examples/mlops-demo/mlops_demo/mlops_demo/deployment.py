...
def production_model_candidates(
    context: dg.AssetExecutionContext, trained_model: RandomForestClassifier
) -> list[str]:
    ...
    with open("trained-models/list-of-models.txt") as f:
        models = f.read().splitlines()

    context.add_asset_metadata({"list-of-models": models})
...
@dg.asset(description="The currently deployed model", group_name="deployment")
def deployed_model(
    production_model_candidates: list[str], config: DeployedModelConfiguration

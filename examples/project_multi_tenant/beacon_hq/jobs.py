...
beacon_reporting_inputs_job = dg.define_asset_job(
    ...
    selection=dg.AssetSelection.assets(
        ["beacon_hq", "consolidated_revenue"],
        ["beacon_hq", "risk_overview"],
        ["beacon_hq", "briefing_highlights"],
    ),
...
beacon_executive_briefing_job = dg.define_asset_job(
    ...
    selection=dg.AssetSelection.assets(
        ["beacon_hq", "briefing_highlights"],
        ["beacon_hq", "executive_context_packet"],
        ["beacon_hq", "executive_summary"],
        ["beacon_hq", "executive_llm_audit_log"],
    ),

...
import requests
import numpy as np
from dagster import MetadataValue, Output, asset, Definitions, DynamicPartitionsDefinition, Output, FreshnessPolicy
import datetime
...
@asset
def previous_item():
    previous_item=requests.get(f"https://hacker-news.firebaseio.com/v0/maxitem.json").json()

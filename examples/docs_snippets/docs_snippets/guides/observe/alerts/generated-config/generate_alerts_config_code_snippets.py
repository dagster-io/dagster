# This script is used to generate docs snippets referenced in `guides/observe/alerts/example-config.md`.
# It creates and formats the cross-product of all alert types and notification services.
# After adding a new alert type or service, just run

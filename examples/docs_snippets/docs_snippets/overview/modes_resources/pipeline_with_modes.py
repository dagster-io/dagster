...
from .database_resources import postgres_database, postgres_dialect, sqlite_database
...
@pipeline(
    mode_defs=[
        ...
        ModeDefinition(
            "prod", resource_defs={"database": postgres_database, "dialect": postgres_dialect}
        ),
    ],
)

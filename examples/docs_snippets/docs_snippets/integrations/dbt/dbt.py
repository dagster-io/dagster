...
def scope_enable_table_schema_metadata_dagster_dbt_translator():
    # start_enable_table_schema_metadata_dagster_dbt_translator
    from pathlib import Path
    from dagster import AssetExecutionContext
    from dagster_dbt import (
        DagsterDbtTranslator,
    ...
    # end_enable_table_schema_metadata_dagster_dbt_translator

...
def do_something_with_exc(exc: Exception):  # pylint: disable=W0613
    pass


def submit_pipeline_execution_default():
...
def submit_pipeline_execution_preset():
...
def submit_execution_pipeline_name_only():

...
from docs_snippets.guides.build.ops_jobs_graphs.op_hooks import (
    a,
    notif_all,
    notif_all_dev,
    notif_all_prod,
...
from docs_snippets.guides.build.ops_jobs_graphs.op_hooks_context import my_failure_hook

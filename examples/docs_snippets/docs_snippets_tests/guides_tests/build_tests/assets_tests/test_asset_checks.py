...
from docs_snippets.guides.build.assets.asset_checks.asset_with_check import (
    defs as asset_with_check_defs,
)
from docs_snippets.guides.build.assets.asset_checks.blocking import (
    defs as blocking_defs,
)
from docs_snippets.guides.build.assets.asset_checks.factory import (
    check_blobs,
    defs as factory_defs,
    make_check,
)
from docs_snippets.guides.build.assets.asset_checks.materializable_freshness_complete import (
    defs as materializable_freshness_complete_defs,
)
from docs_snippets.guides.build.assets.asset_checks.materializable_freshness_in_pieces import (
    defs as materializable_freshness_in_pieces_defs,
)
from docs_snippets.guides.build.assets.asset_checks.metadata import (
    defs as metadata_defs,
)
from docs_snippets.guides.build.assets.asset_checks.orders_check import (
    defs as orders_defs,
)
from docs_snippets.guides.build.assets.asset_checks.severity import (
    defs as severity_defs,
)
from docs_snippets.guides.build.assets.asset_checks.source_data_freshness_complete import (
    defs as source_data_freshness_complete_defs,
)
from docs_snippets.guides.build.assets.asset_checks.source_data_freshness_in_pieces import (
...
def mock_fetch_last_updated_timestamps():
    with mock.patch(
        "docs_snippets.guides.build.assets.asset_checks.source_data_freshness_in_pieces.fetch_last_updated_timestamps"
    ) as m:
        with mock.patch(
            "docs_snippets.guides.build.assets.asset_checks.source_data_freshness_complete.fetch_last_updated_timestamps"
        ) as m_complete:

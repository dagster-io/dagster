import docs_snippets.guides.build.assets.external_assets.external_asset_deps
import docs_snippets.guides.build.assets.external_assets.normal_asset_depending_on_external
import docs_snippets.guides.build.assets.external_assets.single_declaration
from dagster import AssetKey, Definitions


def test_docs_snippets_concepts_external_asset_single_decl() -> None:
    single_decl_defs: Definitions = (
        docs_snippets.guides.build.assets.external_assets.single_declaration.defs
    )
...
def test_docs_snippets_concepts_external_asset_external_asset_deps() -> None:
    defs_with_deps: Definitions = (
        docs_snippets.guides.build.assets.external_assets.external_asset_deps.defs
    )
...
def test_docs_snippets_normal_assets_dep_on_external() -> None:
    defs: Definitions = docs_snippets.guides.build.assets.external_assets.normal_asset_depending_on_external.defs

    from docs_snippets.guides.build.assets.external_assets.normal_asset_depending_on_external import (
        aggregated_logs,
    )

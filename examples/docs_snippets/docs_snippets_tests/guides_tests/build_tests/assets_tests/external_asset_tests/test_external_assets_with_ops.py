import docs_snippets.guides.build.assets.external_assets.update_external_asset_via_op
from dagster import AssetKey, DagsterInstance, Definitions


def test_external_assets_update_external_asset_via_op_0() -> None:
    defs: Definitions = docs_snippets.guides.build.assets.external_assets.update_external_asset_via_op.defs

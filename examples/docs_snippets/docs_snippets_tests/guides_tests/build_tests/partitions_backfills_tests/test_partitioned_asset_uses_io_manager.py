...
from docs_snippets.guides.build.partitions_backfills.partitioned_asset_uses_io_manager import (
    my_daily_partitioned_asset,
)


@patch(
    "docs_snippets.guides.build.partitions_backfills.partitioned_asset_uses_io_manager.pd.read_csv"
)

...
from docs_snippets.guides.automate.sensors.sensor_alert import (
    email_on_run_failure,
    my_slack_on_run_failure,
    my_slack_on_run_success,
    slack_on_run_failure,
)
from docs_snippets.guides.automate.sensors.sensors import (
    log_file_job,
    my_directory_sensor,
    my_s3_sensor,
    sensor_A,
...
def test_s3_sensor():
    with mock.patch(
        "docs_snippets.guides.automate.sensors.sensors.get_s3_keys"
    ) as mock_s3_keys:

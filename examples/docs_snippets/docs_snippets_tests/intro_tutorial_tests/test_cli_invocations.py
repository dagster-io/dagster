...
cli_args = [
    ...
    ("basics/connecting_solids/", "serial_pipeline.py", "serial", None, None, None, 0, None,),
    ("basics/connecting_solids/", "complex_pipeline.py", "diamond", None, None, None, 0, None,),
    ("basics/e04_quality/", "inputs_typed.py", "inputs_job", None, None, None, 0, None,),
    ("basics/e04_quality/", "custom_types.py", "custom_type_job", None, None, None, 0, None,),
    ("basics/e04_quality/", "custom_types_2.py", "custom_type_job", None, None, None, 1, None,),
    (

...
from docs_snippets.deployment.oss.deployment_options.kubernetes.k8s_config_tag_job import (
    my_job,
)
from docs_snippets.deployment.oss.deployment_options.kubernetes.k8s_config_tag_op import (
    my_op,
)

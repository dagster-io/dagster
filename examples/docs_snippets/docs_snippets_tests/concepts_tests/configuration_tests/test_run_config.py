...
def test_make_values_resource_any():
    from docs_snippets.concepts.configuration.make_values_resource_any import my_pipeline
...
def test_make_values_resource_config_schema():
    from docs_snippets.concepts.configuration.make_values_resource_config_schema import my_pipeline

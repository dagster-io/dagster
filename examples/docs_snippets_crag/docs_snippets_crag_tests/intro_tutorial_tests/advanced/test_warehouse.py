...
from docs_snippets_crag.intro_tutorial.advanced.pipelines.modes import (
    SqlAlchemyPostgresWarehouse as sapw1,
)
from docs_snippets_crag.intro_tutorial.advanced.pipelines.modes import modes_pipeline
from docs_snippets_crag.intro_tutorial.advanced.pipelines.presets import (
    SqlAlchemyPostgresWarehouse as sapw2,
)
from docs_snippets_crag.intro_tutorial.advanced.pipelines.presets import presets_pipeline
...
def test_warehouse(postgres):
    with open(
        script_relative_path("../../../docs_snippets_crag/intro_tutorial/cereal.csv"), "r"
    ) as fd:

...
from docs_snippets_crag.intro_tutorial.basics.e04_quality.custom_types_2 import sort_by_calories
from docs_snippets_crag.intro_tutorial.basics.e04_quality.custom_types_4 import (
...
def test_sort():
    with open(
        script_relative_path("../../../docs_snippets_crag/intro_tutorial/cereal.csv"),
        "r",
    ) as fd:

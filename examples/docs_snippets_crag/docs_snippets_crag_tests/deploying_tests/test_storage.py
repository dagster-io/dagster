...
def test_dagster_postgres_yaml():
    dagster_yaml_folder = file_relative_path(__file__, "../../docs_snippets_crag/deploying/")
...
def test_dagster_pg_yaml():
    ...
    res, _custom_instance_class = dagster_instance_config(dagster_yaml_folder, "dagster-pg.yaml")

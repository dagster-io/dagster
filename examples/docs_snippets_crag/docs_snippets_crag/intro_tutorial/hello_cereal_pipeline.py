"""
The airflow DAG scaffold for docs_snippets_crag.intro_tutorial.airflow.hello_cereal_pipeline
...
dag, tasks = make_airflow_dag(
    # NOTE: you must ensure that docs_snippets_crag.intro_tutorial.airflow is

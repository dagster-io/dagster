...
https://github.com/dagster-io/dagster/blob/master/examples/experimental/dagster-airlift/examples/tutorial-example/peer.py#L1-L14
...
https://github.com/dagster-io/dagster/blob/master/examples/experimental/dagster-airlift/examples/tutorial-example/observe.py#L1-L56
...
To begin migration on a DAG, first you will need a file to track migration progress. In your Airflow DAG directory, create a `migration_state` folder, and in it create a yaml file with the same name as your DAG. The included example at [`examples/tutorial-example/airflow_dags/migration_state`](./examples/tutorial-example/tutorial_example/airflow_dags/migration_state) is used by `make airflow_run`, and can be used as a template for your own migration state files.

Given our example DAG `rebuild_customers_list` with three tasks, `load_raw_customers`, `run_dbt_model`, and `export_customers`, [`migration_state/rebuild_customers_list.yaml`](./examples/tutorial-example/tutorial_example/airflow_dags/migration_state/rebuild_customers_list.yaml) should look like the following:
...
https://github.com/dagster-io/dagster/blob/master/examples/experimental/dagster-airlift/examples/tutorial-example/migrate.py#L1-L107
...
https://github.com/dagster-io/dagster/blob/master/examples/experimental/dagster-airlift/examples/tutorial-example/standalone.py#L1-L86

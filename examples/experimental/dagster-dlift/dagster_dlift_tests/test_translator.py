...
from dagster_dlift.translator import DagsterDbtCloudTranslator, clean_name
...
def test_asset_spec_creation() -> None:
    ...
    for test in data.tests_by_unique_id:
        ...
        assert spec.name == clean_name(test)

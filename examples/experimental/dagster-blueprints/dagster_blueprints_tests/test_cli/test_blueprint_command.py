...
@pytest.mark.parametrize("explicit_loader_module", [True, False])
def test_generate_schemas(explicit_loader_module: bool) -> None:
    from dagster_blueprints.cli import generate_schema_files
    ...
    if explicit_loader_module:
        args.extend(["--loader-module", "blueprint_project"])
    out = CliRunner().invoke(generate_schema_files, args)

...
from consumption_datamart.phase_2.monitoring.report_active_customers_by_product_daily.validate_report_active_customers_by_product_graph import \
    validate_report_active_customers_by_product
from consumption_datamart.phase_2.repo import inmemory_consumption_datamart_job, inmemory_monitoring_job

...
from consumption_datamart.common.resources import regexp_extract, utc_timestamp, date_trunc
from consumption_datamart.common.resources import SQLiteDatawarehouseResource, SQLiteSchema, concat, concat3, concat4
    ...
    return SQLiteDatawarehouseResource(
        ...
        schemas=[
            SQLiteSchema(
                ...
                init_sql_file=str((base_dir / "consumption_datamart_tests/phase_1/acme_lake.sqlite3.sql").resolve())
            ),
        ],

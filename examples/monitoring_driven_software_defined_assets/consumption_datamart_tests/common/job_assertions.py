...
def assert_step_is_successful(graph_name, node_name, job_result):
    for step_event in job_result.events_for_node(f'{graph_name}.{node_name}'):
...
def assert_step_is_failure(graph_name, node_name, job_result):
    failed_steps = [step_event for step_event in job_result.events_for_node(f'{graph_name}.{node_name}') if step_event.is_step_failure]

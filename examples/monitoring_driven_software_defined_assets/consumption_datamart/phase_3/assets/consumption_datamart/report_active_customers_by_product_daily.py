...
from consumption_datamart.phase_3.assets.consumption_datamart.fact_usage_daily import FactUsageDailyDataFrameType
...
@asset(
    namespace=['phase_3', 'consumption_datamart'],
    compute_kind='mart_view',
    ins={
        'fact_usage_daily': AssetIn(namespace=['phase_3', 'consumption_datamart']),
    },

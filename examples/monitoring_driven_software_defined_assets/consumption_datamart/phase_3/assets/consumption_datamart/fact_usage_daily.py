...
from consumption_datamart.phase_3.assets.acme_lake.cloud_deployment_heartbeats import CloudDeploymentHeartbeatsDataFrameType
from consumption_datamart.phase_3.assets.acme_lake.invoice_line_items import InvoiceOrderItemsDataFrameType
...
@asset(
    ...
    ins={
        'cloud_deployment_heartbeats': AssetIn(namespace=['phase_3', 'acme_lake']),
        'invoice_order_lines': AssetIn(namespace=['phase_3', 'acme_lake']),
    },

...
from consumption_datamart.common.resources.datawarehouse.base import _BaseDatawarehouseResource, unix_timestamp, utc_timestamp, date_trunc, regexp_extract
...
class SQLiteDatawarehouseResource(_BaseDatawarehouseResource):
    ...
    def add_table_schema(sql, schema_name):
        ...
        return re.sub(r'(CREATE TABLE IF NOT EXISTS|CREATE TABLE|INSERT INTO|CREATE VIEW)\s+', inject_schema, sql)

...
def test_components_docs_index(update_snippets: bool) -> None:
    ...
    with isolated_snippet_generation_environment():
        ...
        run_command_and_snippet_output(
            cmd="dg scaffold defs 'dagster_components.dagster_sling.SlingReplicationCollectionComponent' ingest_files",
            snippet_path=COMPONENTS_SNIPPETS_DIR
        ...
        with environ(
            ...
            run_command_and_snippet_output(
                cmd="dg scaffold defs dagster_components.dagster_dbt.DbtProjectComponent jdbt --project-path dbt/jdbt",
                snippet_path=COMPONENTS_SNIPPETS_DIR

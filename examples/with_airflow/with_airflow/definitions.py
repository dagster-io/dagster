...
with_airflow = Definitions(jobs=[airflow_complex_dag, airflow_simple_dag, airflow_kubernetes_dag])
# end_repo_marker_0
...
task_flow = Definitions(jobs=task_flow_jobs, schedules=task_flow_schedules)
...
airflow_examples = Definitions(jobs=example_jobs, schedules=example_schedules)

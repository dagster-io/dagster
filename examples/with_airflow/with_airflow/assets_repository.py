...
simple_assets = load_assets_from_airflow_dag(
    ...
    task_ids_by_asset_key={
        ...
        AssetKey("task_instances_0_0"): {"get_task_instance_0_0"},
        AssetKey("task_instances_0_1"): {"get_task_instance_0_1"},
        AssetKey("task_instances_0_2"): {"get_task_instance_0_2"},
        AssetKey("task_instance_2"): {"get_task_instance_2"},
        AssetKey("new_asset"): {"sink_task_foo"},

...
@composite_solid(
    config_mapping=ConfigMapping(
        config_mapping_fn=inner_wrap_fn,
        config={'inner_first': Field(String), 'inner_second': Field(String)},
    )
)
def inner_wrap():
    return basic()
...
@composite_solid(
    config_mapping=ConfigMapping(
        config_mapping_fn=outer_wrap_fn,
        config={
            'outer_first': Field(String),
            'outer_second': Field(String),
            'outer_third': Field(Int),
        },
    )
)
def outer_wrap():

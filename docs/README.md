...
The current dual-pathway system creates inconsistencies that complicate tooling and validation. The following improvements will create a more predictable and maintainable documentation system:

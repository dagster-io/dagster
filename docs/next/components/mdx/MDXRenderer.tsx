...
export const VersionedContentLayout = ({ toggleFeedback, children }) => {
  return (
    <div
      className="flex-1 w-full min-w-0 relative z-0 focus:outline-none pt-4"
      tabIndex={0}
    >
      <div className="flex flex-col lg:mt-5">
        <div className="flex justify-between px-4">
          ...
          <div className="hidden lg:inline-block flex-none">
            <button
              onClick={toggleFeedback}
              className="px-2 py-2 text-sm rounded-full border border-gray-300 text-gray-600 hover:text-gray-700 hover:bg-white transition-colors duration-200"
            >
              Share Feedback
            </button>
          </div>
          ...
          <div className="flex flex-col justify-between sticky top-24  py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8 border border-gray-100 rounded-lg px-4 py-4 relative overflow-y-scroll max-h-(screen-60)">
              <div className="flex items-center group">
                ...
                <a
                  className="ml-2 font-semibold text-gray-500 dark:text-gray-300 group-hover:text-gray-800 dark:group-hover:text-gray-100"
                  href={githubLink}
                >
                  Edit Page on Github
                </a>

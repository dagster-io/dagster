...
file:src/pages/docs/deploying/celery_pipeline.py
relativeToProject
...
```python literalinclude emphasize-lines=-
file:src/pages/docs/deploying/dagster-pg.yaml
relativeToProject
caption:dagster-pg.yaml
```
...
about [the Dagster instance](/docs/deploying/instance).

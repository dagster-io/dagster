...
the built-in [scheduler and partition system](/docs/tutorial/advanced_scheduling) for scheduling
pipelines, and the [Celery-based executor](/docs/deploying/celery) for large-scale deployments.) But

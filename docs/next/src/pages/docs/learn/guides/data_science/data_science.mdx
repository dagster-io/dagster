...
file:src/pages/docs/learn/guides/data_science/iris_pipeline.py
relativeToProject
...
```python literalinclude emphasize-lines=3,5,11,18-19
file:src/pages/docs/learn/guides/data_science/iris_pipeline_2.py
relativeToProject
...
```python literalinclude
file:src/pages/docs/learn/guides/data_science/iris_pipeline.yaml
relativeToProject
...
```python literalinclude emphasize-lines=5-7
file:src/pages/docs/learn/guides/data_science/iris_pipeline_3.py
relativeToProject

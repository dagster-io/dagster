...
[tutorial](/docs/tutorial/advanced_pipelines#pipeline-modes) showcases how you can combine
...
composition in action in the [tutorial](/docs/tutorial/advanced_solids#composite-solids).

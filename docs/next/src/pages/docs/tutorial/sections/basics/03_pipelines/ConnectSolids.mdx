...
file:/dagster_examples/intro_tutorial/basics/e02_solids/serial_pipeline.py
lines:1-40
```
...
```python literalinclude showLines emphasize-lines=55-59 startLine=7
...
```python literalinclude showLines startLine=73
file:/dagster_examples/intro_tutorial/basics/e03_pipelines/complex_pipeline.py
caption:complex_pipeline.py
lines:73-80
```

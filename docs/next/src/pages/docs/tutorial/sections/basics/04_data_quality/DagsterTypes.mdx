...
file:/dagster_examples/intro_tutorial/inputs_typed.py
...
```python literalinclude
file:/dagster_examples/intro_tutorial/custom_types.py
...
file:/dagster_examples/intro_tutorial/custom_types_2.py
...
```python literalinclude showLines startLine=30
file:/dagster_examples/intro_tutorial/custom_types_2.py
caption:custom_types_2.py
lineno-start:30
lines:30-35
...
```YAML literalinclude
file:/dagster_examples/intro_tutorial/inputs_env.yaml
...
```YAML literalinclude
file:/dagster_examples/intro_tutorial/custom_type_input.yaml
...
```python literalinclude
file:/dagster_examples/intro_tutorial/custom_types_3.py
...
```python literalinclude
file:/dagster_examples/intro_tutorial/custom_types_test.py
...
```python literalinclude
file:/dagster_examples/intro_tutorial/custom_types_mypy_verbose.py
...
```python literalinclude
file:/dagster_examples/intro_tutorial/custom_types_mypy_typing_trick.py
...
```python literalinclude
file:/dagster_examples/intro_tutorial/custom_types_4.py

...
```python literalinclude showLines startLine=7
...
```python literalinclude  showLines startLine=6
...
```python literalinclude showLines startLine=13 emphasize-lines=2,12
file:/dagster_examples/intro_tutorial/basics/e04_quality/custom_types.py
caption:custom_types.py
lines:13-36
```
...
```python literalinclude showLines startLine=7 emphasize-lines=1,21
...
```python literalinclude showLines startLine=42 emphasize-lines=5
file:/dagster_examples/intro_tutorial/basics/e04_quality/custom_types_3.py
caption:custom_types_3.py
lines:42-47
```
...
```python literalinclude showLines startLine=70
file:/dagster_examples/intro_tutorial/basics/e04_quality/custom_types_3.py
caption:custom_types_3.py
lines:70-80
```
...
```python literalinclude showLines startLine=102
...
```python literalinclude showLines startLine=21 emphasize-lines=1-5,14-15
...
```python literalinclude showLines startLine=7 emphasize-lines=1-8
...
```python literalinclude showLines startLine=18 emphasize-lines=3-9,33-53

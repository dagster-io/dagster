...
```python literalinclude showLines startLine=25 emphasize-lines=20-23
...
```python literalinclude showLines startLine=24 emphasize-lines=25-33
file:/dagster_examples/intro_tutorial/advanced/materializations/materializations.py
caption:materializations.py
lines:24-57
```
...
```python literalinclude showLines startLine=29
...
```python literalinclude showLines startLine=93 emphasize-lines=5
file:/dagster_examples/intro_tutorial/advanced/materializations/output_materialization.py
caption:output_materialization.py
lines:93-98
```
...
```YAML literalinclude emphasize-lines=6-10

...
file:/dagster_examples/intro_tutorial/materializations.py
...
```python literalinclude
file:/dagster_examples/intro_tutorial/output_materialization.py
...
```YAML literalinclude
file:/dagster_examples/intro_tutorial/output_materialization.yaml

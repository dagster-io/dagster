...
```python literalinclude showLines startLine=59 emphasize-lines=18
...
```python literalinclude showLines startLine=17 emphasize-lines=28-30
file:/dagster_examples/intro_tutorial/advanced/pipelines/resources.py
caption:resources.py
lines:17-46
```
...
```python literalinclude showLines startLine=85 emphasize-lines=2-6
file:/dagster_examples/intro_tutorial/advanced/pipelines/resources.py
caption:resources.py
lines:85-94
```
...
```YAML literalinclude emphasize-lines=1-4
...
```python literalinclude showLines startLine=57 emphasize-lines=1

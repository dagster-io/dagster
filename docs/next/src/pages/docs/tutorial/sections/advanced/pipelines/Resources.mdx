...
file:/dagster_examples/intro_tutorial/resources.py
...
```YAML literalinclude
file:/dagster_examples/intro_tutorial/resources.yaml
...
```python literalinclude
file:/dagster_examples/intro_tutorial/required_resources.py

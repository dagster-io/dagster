...
file:/dagster_examples/intro_tutorial/serialization_strategy.py
...
::literalinclude (file:/dagster_examples/intro_tutorial/inputs_env.yaml) (caption:inputs_env.yaml) (language:YAML)
...
```YAML literalinclude
file:/dagster_examples/intro_tutorial/reexecution_env.yaml

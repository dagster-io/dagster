...
>   [Github](https://github.com/dagster-io/dagster/tree/master/examples/dagster_examples/intro_tutorial/basics/e02_solids/)
> - If you’ve cloned the dagster git repository, you’ll find this example at
>   `examples/dagster_examples/intro_tutorial/basics/e02_solids/`
...
> > > > > > > (rename-environment-dict-to-run-config-4) public cli and more docs

This dict contains all of the user-provided configuration with which to execute a pipeline. As such,
it can have [a lot of sections](/docs/apidocs/execution####config_schema), but we'll only use one of
...
editor pane changes to provide context&mdash;youo you always know where in the nested config schema

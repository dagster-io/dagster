...
<CodeReferenceLink url="https://github.com/dagster-io/dagster/tree/master/examples/dagster_examples/intro_tutorial/advanced/intermediates/" />
...
file:/dagster_examples/intro_tutorial/advanced/intermediates/intermediates.yaml
```
...
file:/dagster_examples/intro_tutorial/advanced/intermediates/reexecution.py
lines:35-52
```

...
<DynamicMetaTags
  title="Lakehouse Example with Pandas and PySpark | Dagster"
  description="In this example, we'll be demonstrating how we can use Lakehouse to construct a Dagster pipeline with multiple compute options."
/>
...
startAfter:start_lakehouse_def_marker_0
endBefore:end_lakehouse_def_marker_0
```
...
```python literalinclude caption=lakehouse_def.py
file:/multi_type_lakehouse/multi_type_lakehouse/lakehouse_def.py
startAfter:start_lakehouse_def_marker_1
endBefore:end_lakehouse_def_marker_1
```
...
```python literalinclude caption=lakehouse_def.py
file:/multi_type_lakehouse/multi_type_lakehouse/lakehouse_def.py
startAfter:start_lakehouse_def_marker_2
endBefore:end_lakehouse_def_marker_2
```
...
```python literalinclude caption=lakehouse_def.py
file:/multi_type_lakehouse/multi_type_lakehouse/lakehouse_def.py
startAfter:start_lakehouse_def_marker_3
endBefore:end_lakehouse_def_marker_3
```

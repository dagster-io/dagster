...
lineno-start:1
startAfter:start_test_basic_even_type
endBefore:end_test_basic_even_type
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_test_basic_even_type_no_annotations
endBefore:end_test_basic_even_type_no_annotations
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_test_basic_even_type_with_annotations
endBefore:end_test_basic_even_type_with_annotations
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_object_type
endBefore:end_object_type
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_use_object_type
endBefore:end_use_object_type
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_type_loader
endBefore:end_type_loader
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_via_config
endBefore:end_via_config
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_usable_as
endBefore:end_usable_as
```
...
file:/docs_snippets/docs_snippets_tests/intro_tutorial_tests/test_type_guide.py
lineno-start:1
startAfter:start_make_usable
endBefore:end_make_usable
```
...
can cause changes in behavior based on import order.
...
0.761, there is no way to directly annotate an object to treat it as a

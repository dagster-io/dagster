...
The <PyObject module="dagster" object="daily_schedule" displayText="@daily_schedule"/> or <PyObject module="dagster" object="hourly_schedule" displayText="@hourly_schedule"/> API defines
a schedule that wraps an underlying <PyObject module="dagster" object="PartitionSetDefinition"/>.

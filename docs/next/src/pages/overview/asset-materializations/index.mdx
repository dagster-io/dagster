...
is called a "materialization" and solids can express materializations by yielding a materialization
event.

## Materializing an Asset

To generate an asset materialization, we can yield a <PyObject module="dagster" object="Materialization" /> event in our solid.

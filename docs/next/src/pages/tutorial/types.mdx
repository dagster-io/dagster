...
```python literalinclude showLines startLine=16 emphasize-lines=2,12 caption=custom_types.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types.py
...
```python literalinclude showLines startLine=8 emphasize-lines=1,21 caption=custom_types_2.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types_2.py
startAfter:start_custom_types_2_marker_0
endBefore:end_custom_types_2_marker_0
```
...
```bash
2020-10-01 17:20:54 - dagster - ERROR - custom_type_pipeline - c3267e86-10e9-472d-80e9-15a61d2b6360 - 8649 - bad_read_csv.compute - STEP_FAILURE - Execution of step "bad_read_csv" failed.
...
What we want to be able to do is to write:
...
```python literalinclude showLines startLine=33 caption=custom_types_3.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types_3.py
startAfter:start_custom_types_3_marker_0
endBefore:end_custom_types_3_marker_0
```
...
```python literalinclude showLines startLine=46 emphasize-lines=5 caption=custom_types_3.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types_3.py
startAfter:start_custom_types_3_marker_1
endBefore:end_custom_types_3_marker_1
```

Now if you run a pipeline with this solid from Dagit you will be able to
provide sources for these inputs via config:

```python literalinclude showLines startLine=77 caption=custom_types_3.py
dedent:4
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types_3.py
startAfter:start_custom_types_3_marker_2
endBefore:end_custom_types_3_marker_2
```
...
```python literalinclude showLines startLine=103 caption=custom_types_test.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types_test.py
startAfter:start_custom_types_test_marker_0
endBefore:end_custom_types_test_marker_0
```
...
startAfter:start_custom_types_mypy_verbose_marker_0
endBefore:end_custom_types_mypy_verbose_marker_0
```
...
startAfter:start_custom_types_mypy_typing_trick_marker_0
endBefore:end_custom_types_mypy_typing_trick_marker_0
```
...
```python literalinclude showLines startLine=98 emphasize-lines=1-3,31 caption=custom_types_bad_5.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e04_quality/custom_types_bad_5.py
startAfter:start_custom_types_5_marker_0
endBefore:end_custom_types_5_marker_0
```
...
```python literalinclude showLines startLine=76 emphasize-lines=7 caption=custom_types_5.py

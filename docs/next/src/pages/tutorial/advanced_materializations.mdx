...
When we run this pipeline, we'll see that assets, with the associated type of LessSimpleDataFrame,
are yielded (and visible in the structured logs in Dagit), and that files are created on disk

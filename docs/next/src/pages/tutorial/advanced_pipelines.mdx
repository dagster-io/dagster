...
Dagster's library modules such as [`dagster_aws`](/apidocs/libraries/dagster_aws),
[`dagster_gcp`](/apidocs/libraries/dagster_gcp), and
[`dagster_slack`](/apidocs/libraries/dagster_slack) provide out-of-the-box implementations for

...
```python literalinclude showLines startLine=15 caption=repos.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/repositories/repos.py
startAfter:start_repos_marker_0
endBefore:end_repos_marker_0
```
...
startAfter:start_lazy_repos_marker_0
endBefore:end_lazy_repos_marker_0
```

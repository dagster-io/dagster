...
```python literalinclude caption=iris_pipeline.py
...
```python literalinclude emphasize-lines=3,5,11,18-19 caption=iris_pipeline_2.py
...
![tags.png](/assets/images/learn/guides/data_science/tags.png)
...
```python literalinclude emphasize-lines=5-7 caption=iris_pipeline_3.py

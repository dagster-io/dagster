...
```python file=/intro_tutorial/basics/e03_pipelines/serial_pipeline.py startafter=start_serial_pipeline_marker_0 endbefore=end_serial_pipeline_marker_0
import csv
import os
...
```python file=/intro_tutorial/basics/e03_pipelines/complex_pipeline.py startafter=start_complex_pipeline_marker_0 endbefore=end_complex_pipeline_marker_0
@solid
def load_cereals(_):
...
```python file=/intro_tutorial/basics/e03_pipelines/complex_pipeline.py startafter= start_complex_pipeline_marker_1 endbefore= end_complex_pipeline_marker_1
import csv
import os

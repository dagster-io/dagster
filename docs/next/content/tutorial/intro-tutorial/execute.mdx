...
```python file=/intro_tutorial/basics/e01_first_pipeline/hello_cereal.py startafter=start_solid_marker endbefore=end_solid_marker
import csv
import os
...
```python file=/intro_tutorial/basics/e01_first_pipeline/hello_cereal.py startafter=start_pipeline_marker endbefore=end_pipeline_marker
@pipeline
...
pipeline—which also only has one node, `hello_cereal`.
...
```python file=/intro_tutorial/basics/e01_first_pipeline/hello_cereal.py startafter=start_execute_marker endbefore=end_execute_marker

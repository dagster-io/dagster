---
title: Solids
description: Solids are the functional unit of compuation in Dagster, and contain the core logic of your orchestration graph.
---
...
- They can emit a stream of typed, structured events, such as <PyObject module="dagster" object="Expectations"/> and <PyObject module="dagster" object="AssetMaterialization"/>
...
```python file=/overview/solids_pipelines/solid_definition.py trim=true startafter=start_solid_definition_marker_0 endbefore=end_solid_definition_marker_0
@solid
...
startAfter:input_example_solid_start
endBefore:input_example_solid_end
```
...
```python literalinclude caption=solids.py
file:/docs_snippets/docs_snippets/legacy/how_tos/solids.py
startAfter:my_input_output_example_solid_start
endBefore:my_input_output_example_solid_end
```

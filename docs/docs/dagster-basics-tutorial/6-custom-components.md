...
<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/commands/dg-create-custom-component.txt" />

This adds a new directory, `components`, within `src/dagster_tutorial`:

<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/tree/step-6a.txt" />
...
<CodeExample
  path="docs_snippets/docs_snippets/dagster_basics_tutorial/src/dagster_tutorial/components/tutorial.py"
  language="python"
...
<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/commands/dg-check-defs.txt" />
...
<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/commands/dg-list-components-custom.txt" />

You can now scaffold definitions from it just like any other component:

<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/commands/dg-scaffold-custom-component.txt" />

This adds a new directory, `tutorials`, within `defs`:

<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/tree/step-6b.txt" />
...
<CodeExample
  path="docs_snippets/docs_snippets/dagster_basics_tutorial/src/dagster_tutorial/components/defs.yaml"
  language="yaml"
...
<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/tree/step-6c.txt" />

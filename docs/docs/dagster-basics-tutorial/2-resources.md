...
<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/commands/dg-scaffold-resources.txt" />

This adds a generic resources file to your project. The `resources.py` file is now part of the `dagster-tutorial` module:

<CliInvocationExample path="docs_snippets/docs_snippets/dagster_basics_tutorial/tree/resources.txt" />
...
<CodeExample
  path="docs_snippets/docs_snippets/dagster_basics_tutorial/src/dagster_tutorial/defs/resources.py"
  language="python"

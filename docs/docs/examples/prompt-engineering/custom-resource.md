...
<CodeExample path="examples_section/project_prompt_eng/project_prompt_eng/resources.py" language="python" lineStart="4" lineEnd="27"/>
...
<CodeExample path="examples_section/project_prompt_eng/project_prompt_eng/assets.py" language="python" lineStart="101" lineEnd="118"/>

...
<CodeExample path="examples_section/project_prompt_eng/project_prompt_eng/assets.py" language="python" lineStart="34" lineEnd="66"/>
...
<CodeExample path="examples_section/project_prompt_eng/project_prompt_eng/assets.py" language="python" lineStart="120" lineEnd="157"/>

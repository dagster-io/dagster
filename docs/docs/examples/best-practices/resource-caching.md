...
description: How to handle caching within resources.
last_update:
  author: Dennis Hume
sidebar_custom_props:
  logo: images/examples/best-practices/Resource.png
---
...
<CodeExample
  ...
  language="python"
  title="src/project_mini/defs/resource_caching/expensive_resource_cache.py"
/>
...
<CodeExample
  ...
  language="python"
  title="src/project_mini/defs/resource_caching/expensive_resource_pickle.py"
/>

...
- [Create alerts](https://docs.dagster.io/dagster-plus/features/alerts) based off of Insights metrics
...
| Observations         | The number of [asset observations](https://docs.dagster.io/guides/build/assets/metadata-and-tags/asset-observations) associated with computing this object.                                                                                                             |
...
| Asset check warnings | The number of [asset checks](https://docs.dagster.io/guides/test/asset-checks) that produced warnings.                                                                                                                                                                  |
| Asset check errors   | The number of [asset checks](https://docs.dagster.io/guides/test/asset-checks) that produced errors.                                                                                                                                                                    |
...
- **Asset materialization metadata.** Refer to the [Using asset metadata with Dagster+ Insights guide](https://docs.dagster.io/dagster-plus/features/insights/asset-metadata) for more info.
- [**Google BigQuery usage**](https://docs.dagster.io/dagster-plus/features/insights/google-bigquery) generated by either queries made to BigQuery resources or using dbt to materialize tables
- [**Snowflake usage**](https://docs.dagster.io/dagster-plus/features/insights/snowflake) generated by either queries made to Snowflake resources or using dbt to materialize tables

### Export metrics

Metrics in Dagster+ Insights can be exported using a GraphQL API endpoint. Refer to the [Exporting Insights metrics from Dagster+ guide](https://docs.dagster.io/dagster-plus/features/insights/export-metrics) for details.

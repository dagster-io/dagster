...
- A Dagster+ account
- An empty Dagster project created with the `dagster-create project` CLI. For more information, see [Creating a new Dagster project](/guides/build/projects/creating-dagster-projects).

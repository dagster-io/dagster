...
If using the Kubernetes agent, you can instead forward logs to your own S3 bucket by using the [`S3ComputeLogManager`](/integrations/libraries/aws#dagster_aws.s3.S3ComputeLogManager).

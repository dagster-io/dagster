...
2. **For each project in the repository**, configure a code location in the [`build.yaml` file](/guides/build/projects/project-structure/build-yaml):

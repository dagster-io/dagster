...
2. **For each project in the repository**, configure a code location in the [`dagster_cloud.yaml` file](/guides/build/projects/project-structure/dagster-cloud-yaml):

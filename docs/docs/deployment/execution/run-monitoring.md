...
In Dagster+, run monitoring is always enabled and can be configured in [deployment settings](/deployment/dagster-plus/deploying-code/full-deployments/deployment-settings-reference)
...
or in Dagster+, add the following to your [deployment settings](/deployment/dagster-plus/deploying-code/full-deployments/deployment-settings-reference):

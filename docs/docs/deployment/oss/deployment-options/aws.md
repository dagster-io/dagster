...
Use the `ecs/container_overrides` tag to set container-level overrides for the run container. The value should be a JSON-serialized dictionary, for example:

...
This guide has been adapted from a [GitHub discussion post](https://github.com/dagster-io/dagster/discussions/12047#discussioncomment-12397129) by [HynekBlaha](https://github.com/HynekBlaha).
...
:::info What to expect after the clean-up job completes
...
- You need to run VACUUM to let Postgres reuse them for new inserts (see [Step 2](#step-2)).

:::

## Step 2: Run VACUUM to let Postgres reuse rows marked for deletion \{#step-2}

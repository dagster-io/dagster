...
In this guide, we’ll show you how to migrate from using step launchers to using [Dagster Pipes](/integrations/external-pipelines) in Dagster.
...
You can learn more about packaging Python dependencies for PySpark in [PySpark documentation](https://spark.apache.org/docs/latest/api/python/user_guide/python_packaging.html#python-package-management) or in the [AWS EMR Pipes](/integrations/external-pipelines/aws/aws-emr-pipeline) guide.
...
- [AWS EMR Pipes tutorial](/integrations/external-pipelines/aws/aws-emr-pipeline)

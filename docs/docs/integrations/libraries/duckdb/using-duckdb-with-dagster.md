...
You may want to use an I/O manager to handle storing DataFrames as tables in DuckDB and loading DuckDB tables as DataFrames in downstream assets. See [When to use I/O managers](/guides/build/io-managers#when-to-use-io-managers) for more guidance. You may want to use an I/O manager if:

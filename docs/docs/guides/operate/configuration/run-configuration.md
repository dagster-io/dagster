...
The code examples in this guide conform to the project structure generated by the [`create-dagster project` CLI command](/api/clis/create-dagster#create-dagster-project). For more information, see [Creating Dagster projects](/guides/build/projects/creating-projects).

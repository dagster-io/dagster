...
Dagster also provides a Python client to interface with Dagster's GraphQL API from Python. For more information, see [Dagster GraphQL Python client](/guides/operate/graphql/graphql-client).

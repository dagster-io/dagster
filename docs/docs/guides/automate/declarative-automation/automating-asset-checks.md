...
<CodeExample
  path="docs_snippets/docs_snippets/guides/automate/declarative_automation/on_cron/basic_check.py"
...
<CodeExample
  path="docs_snippets/docs_snippets/guides/automate/declarative_automation/eager/basic_check.py"
  title="src/<project_name>/defs/asset_checks.py"
/>

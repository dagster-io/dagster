...
<CodeExample path="docs_snippets/docs_snippets/guides/automation/simple-sensor-example.py" language="python" title="src/<project-name>/defs/assets.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/automation/sensor-cursor.py" language="python" title="src/<project-name>/defs/assets.py" />

...
| [Declarative automation](/guides/automate/declarative-automation) | A framework that allows you to set automation conditions on assets, asset checks, and asset jobs                             | Asset-centric, condition-based updates.                                                                                         | Assets, Asset checks, Asset jobs |
...
| [Asset sensors](/guides/automate/asset-sensors)                   | Trigger jobs when specific assets are materialized.                                                                          | Triggering a side effect in response to an asset materialization (e.g. sending a notification, or launching a job imperatively) | Assets only                      |

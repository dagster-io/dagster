...
While you can also use [asset sensors](/guides/automate/asset-sensors) to trigger jobs when specific assets are materialized, we strongly recommend using [declarative automation](/guides/automate/declarative-automation) instead.

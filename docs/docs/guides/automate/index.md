...
| [Asset sensors](/guides/automate/asset-sensors)                   | Trigger jobs when specific assets are materialized.                                                                          | Triggering a side effect in response to an asset materialization (such as sending a notification or launching a job imperatively) | Assets only         |

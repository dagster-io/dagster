...
Freshness policies are not yet feature complete, but are intended to supersede [freshness checks](/guides/test/data-freshness-testing) in a future release. Freshness checks are still and will continue to be supported for the foreseeable future. A migration guide will be provided.

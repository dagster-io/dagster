...
| Top assets by retry count             | Count of all attempted asset retries.                                                                                                                                                                                                                                                                                                                                                                                             |
| Top assets by check error count       | Count of asset checks for the selected assets that completed execution but failed the check.                                                                                                                                                                                                                                                                                                                                      |
| Top assets by check warning count     | The top assets that produced [asset check](/guides/test/asset-checks) warnings.                                                                                                                                                                                                                                                                                                                                                   |
| Top assets by freshness failure count | Total number of times the selected assets transitioned to a failed freshness state (i.e. failed their freshness policy).                                                                                                                                                                                                                                                                                                          |
| Top assets by freshness warning count | Total number of times the selected assets transitioned to a warning freshness state (i.e. came close to failing their freshness policy).                                                                                                                                                                                                                                                                                          |

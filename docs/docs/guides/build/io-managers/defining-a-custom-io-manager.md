---
description: If you have specific requirements for where and how your outputs should be stored and retrieved, you can define a custom I/O manager in Dagster by extending the IOManager or ConfigurableIOManager class.

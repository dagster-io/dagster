---
description: If you have specific requirements for where and how your outputs should be stored and retrieved, you can define a custom I/O managers in Dagster by extending the IOManager or ConfigurableIOManager class. 
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/custom_io_manager.py" startAfter="start_io_manager_marker" endBefore="end_io_manager_marker" title="src/<project_name>/defs/resources.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/custom_io_manager.py" startAfter="start_io_manager_factory_marker" endBefore="end_io_manager_factory_marker" title="src/<project_name>/defs/resources.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/external_resources/pythonic_resources.py" startAfter="start_new_io_manager" endBefore="end_new_io_manager" dedent="4" title="src/<project_name>/defs/resources.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/custom_io_manager.py" startAfter="start_partitioned_marker" endBefore="end_partitioned_marker" title="src/<project_name>/defs/resources.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/loading_multiple_upstream_partitions.py" title="src/<project_name>/defs/assets.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_plain_input_manager" endBefore="end_plain_input_manager" title="src/<project_name>/defs/assets.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_better_input_manager" endBefore="end_better_input_manager" title="src/<project_name>/defs/assets.py" />

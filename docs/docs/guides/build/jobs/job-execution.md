...
To view your job in the UI, use the [`dg dev`](/api/clis/dg-cli#dg-dev) command:
...
- [`dg launch`](/api/clis/dg-cli#dg-launch) for launching runs asynchronously using the [run launcher](/deployment/execution/run-launchers) on your instance

...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/load_from_config.py" startAfter="def_start_marker" endBefore="def_end_marker" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/load_custom_type_from_config.py" startAfter="def_start_marker" endBefore="def_end_marker" title="src/<project_name>/defs/assets.py"/>

With this, the input can be specified via config as below:

<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/load_custom_type_from_config.py" startAfter="execute_start_marker" endBefore="execute_end_marker" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_load_unconnected_via_fn" endBefore="end_load_unconnected_via_fn" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_load_unconnected_input" endBefore="end_load_unconnected_input" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_load_unconnected_io" endBefore="end_load_unconnected_io" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_per_input_config" endBefore="end_per_input_config" title="src/<project_name>/defs/assets.py"/>

Then, when executing a job, you can pass in this per-input config:

<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_per_input_config_exec" endBefore="end_per_input_config_exec" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_load_input_subset" endBefore="end_load_input_subset" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_better_load_input_subset" endBefore="end_better_load_input_subset" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/io_management/input_managers.py" startAfter="start_execute_subselection" endBefore="end_execute_subselection" title="src/<project_name>/defs/assets.py"/>

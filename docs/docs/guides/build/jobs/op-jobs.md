...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/simple_job.py" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/jobs_from_graphs.py" startAfter="start_define_graph" endBefore="end_define_graph" title="src/<project_name>/defs/assets.py"/>

Then build op jobs from it using the <PyObject section="graphs" module="dagster" object="GraphDefinition" method="to_job" /> method:

<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/jobs_from_graphs.py" startAfter="start_define_jobs" endBefore="end_define_jobs" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/jobs_with_default_config.py" title="src/<project_name>/defs/assets.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/jobs_with_config_mapping.py" title="src/<project_name>/defs/assets.py" trimMain={false} />

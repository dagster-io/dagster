...
| <PyObject section="ops" module="dagster" object="Jitter"  />        | Random modification to delay between retries                                   |
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/retries.py" startAfter="problem_start" endBefore="problem_end" title="src/<project_name>/defs/ops.py"/>

### `RetryPolicy`

To get this op to retry when an exception occurs, we can attach a <PyObject section="ops" module="dagster" object="RetryPolicy" />.

<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/retries.py" startAfter="policy_start" endBefore="policy_end" title="src/<project_name>/defs/ops.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/retries.py" startAfter="policy2_start" endBefore="policy2_end" title="src/<project_name>/defs/ops.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/retries.py" startAfter="policy3_start" endBefore="policy3_end" title="src/<project_name>/defs/ops.py"/>

:::info

Retry policies also work for asset jobs.

<CodeExample path="docs_snippets/docs_snippets/deployment/execution/asset_job_retries.py" title="src/<project_name>/defs/ops.py"/>

...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/unnested_ops.py" title="src/<project_name>/defs/ops.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/nested_graphs.py" startAfter="start_composite_solid_example_marker" endBefore="end_composite_solid_example_marker" title="src/<project_name>/defs/ops.py" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/nested_graphs.py" startAfter="start_composite_solid_config_marker" endBefore="end_composite_solid_config_marker" title="src/<project_name>/defs/ops.py" />

To kick off a run of this job, you will need to specify the config for both `add_n` and `multiply_by_m` through the sub-graph:

<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/composite_config.yaml" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/graph_provides_config.py" title="src/<project_name>/defs/ops.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/graph_provides_config_mapping.py" title="src/<project_name>/defs/ops.py"/>

To run a job that contains `to_fahrenheit` as a sub-graph, you need to provide a value for the `from_unit` config option:

<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/composite_config_mapping.yaml"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/ops_jobs_graphs/nested_graphs.py" startAfter="start_composite_multi_output_marker" endBefore="end_composite_multi_output_marker" title="src/<project_name>/defs/ops.py"/>

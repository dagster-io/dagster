...
<CodeExample path="docs_snippets/docs_snippets/concepts/ops_jobs_graphs/graphs/fan_in_graph.py" startAfter="start_marker" endBefore="end_marker" title="src/<project_name>/defs/assets.py"/>

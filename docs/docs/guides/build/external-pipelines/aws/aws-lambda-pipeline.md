...
Next, you'll add the asset and AWS Lambda resource to your project's project via the <PyObject section="definitions" module="dagster" object="Definitions" /> object. This makes the resource available to [other Dagster definitions in the project](/deployment/code-locations).

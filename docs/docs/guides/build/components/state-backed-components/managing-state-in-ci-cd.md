...
:::note `uv run` is a convenience prefix
...
For more information on Dagster+ deployment commands, see the [CI/CD deployment guide](/deployment/dagster-plus/deploying-code/configuring-ci-cd).

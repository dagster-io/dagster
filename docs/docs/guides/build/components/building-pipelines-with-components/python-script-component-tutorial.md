...
Navigate to the Dagster UI and you'll see your assets. To execute your Python script, click the asset, then click **Materialize**. The script will run in a subprocess, and you'll be able to see the logs and metadata in the Dagster UI.

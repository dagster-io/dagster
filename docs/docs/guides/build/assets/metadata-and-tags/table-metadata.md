...
<CodeExample path="docs_snippets/docs_snippets/concepts/metadata-tags/asset_column_schema.py" title="src/<project-name>/defs/assets.py" />
...
<CodeExample path="docs_snippets/docs_snippets/concepts/metadata-tags/asset_row_count.py" title="src/<project-name>/defs/assets.py" />
...
<CodeExample path="docs_snippets/docs_snippets/concepts/metadata-tags/schema_change_checks.py" startAfter="start_check" endBefore="end_check" title="src/<project-name>/defs/assets.py" />

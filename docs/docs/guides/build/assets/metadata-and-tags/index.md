...
canonicalUrl: "/guides/build/assets/metadata-and-tags"
slug: "/guides/build/assets/metadata-and-tags"
---
...
If you want to customize how code references are attached - such as when you are building [domain-specific languages with asset factories](/guides/build/components/asset-factories-to-components) - you can manually add the `dagster/code_references` metadata to asset definitions:

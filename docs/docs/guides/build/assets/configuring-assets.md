...
<CodeExample path="docs_snippets/docs_snippets/guides/build/assets/configuring-assets/config-schema.py" language="python" title="src/<project_name>/defs/assets.py" />

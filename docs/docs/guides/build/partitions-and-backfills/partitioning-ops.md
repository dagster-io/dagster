...
<CodeExample path="docs_snippets/docs_snippets/guides/build/partitions_backfills/date_config_job.py" title="src/<project_name>/defs/ops.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/partitions_backfills/config.yaml" />
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/partitions_backfills/partitioned_job.py" startAfter="start_partitioned_config" endBefore="end_partitioned_config" title="src/<project_name>/defs/ops.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/partitions_backfills/partitioned_job.py" startAfter="start_partitioned_job" endBefore="end_partitioned_job" title="src/<project_name>/defs/ops.py"/>
...
<CodeExample path="docs_snippets/docs_snippets/guides/build/partitions_backfills/static_partitioned_job.py" title="src/<project_name>/defs/ops.py"/>

...
You can manually construct a set of definitions for your components using `load_defs`, then merge them with your existing definitions using `Definitions.merge`. You point `load_defs` at the directory you just created that contains components.

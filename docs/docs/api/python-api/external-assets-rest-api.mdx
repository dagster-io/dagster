...
Authentication is required only if requests are being made against a [Dagster+ instance](/dagster-plus/). To authenticate, provide a valid [Dagster+ user token](/dagster-plus/deployment/management/tokens/user-tokens) using the `Dagster-Cloud-Api-Token` header:
...
<table
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <strong>Required only for Dagster+.</strong> The request header must contain the <code>Dagster-Cloud-Api-Token</code> header and a valid user token.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <ul>
          <li>
            <code>Dagster-Cloud-Api-Token</code> - Required if using Dagster+, e.g. <code>Dagster-Cloud-Api-Token: [USER_TOKEN]</code>
          </li>
          <li>
            <code>Content-Type</code> - Required if the request contains a JSON body, specified as <code>Content-Type: application/json</code>
          </li>
        </ul>
      </td>
    </tr>
...
<table
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Optional</td>
      <td>
        The data version of the asset associated with the materialization. May be passed in JSON body or as a query parameter; value is passed to
    ...
    <tr>
      ...
      <td>Optional</td>
      <td>
        A human-readable description of the materialized value. May be passed in JSON body or as a query parameter; value is passed to the
        <PyObject section="ops" module="dagster" object="AssetMaterialization" /> constructor.
      </td>
    </tr>
    <tr>
      ...
      <td>Optional</td>
      <td>
        The name of the partition that was materialized. May be passed in JSON body or as a query parameter; value is passed to the
        <PyObject section="ops" module="dagster" object="AssetMaterialization" /> constructor.
      </td>
    </tr>
  </tbody>
...
<table
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Required</td>
      <td>
        The name of the check. May be passed in JSON body or as a query parameter; value is passed to the <code>AssetCheckEvaluation</code>
        constructor.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        May be passed in JSON body or as a query parameter; value is passed to the <code>AssetCheckEvaluation</code> constructor.
      </td>
    </tr>
  </tbody>
</table>
...
<table
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Optional</td>
      <td>
        A human-readable description of the asset or observation. May be passed in JSON body or as a query parameter; value is passed to the
        <PyObject section="assets" module="dagster" object="AssetObservation" /> constructor.
      </td>
    </tr>
    <tr>
      ...
      <td>Optional</td>
      <td>
        The name of the partition that was observed. May be passed in JSON body or as a query parameter; value is passed to the
        <PyObject section="assets" module="dagster" object="AssetObservation" /> constructor.
      </td>
    </tr>
  </tbody>

...
<dl>
    <dt><Link id='dagster_pyspark.PySparkResource'>dagster_pyspark.PySparkResource ResourceDefinition</Link></dt>
    <dd>
...
<dl>
    <dt><Link id='dagster_pyspark.pyspark_resource'>dagster_pyspark.pyspark_resource ResourceDefinition</Link></dt>
    <dd>

...
export const config: VercelConfig = {
  ...
  redirects: [
    ...
    */
    ...
    routes.redirect('/guides/build/ml-pipelines/:path*', '/examples/full-pipelines/ml'),
    ...
    routes.redirect('/examples/dspy/:path*', '/examples/full-pipelines/dspy/:path*'),
    ...
    routes.redirect('/examples/ml/:path*', '/examples/full-pipelines/ml/:path*'),

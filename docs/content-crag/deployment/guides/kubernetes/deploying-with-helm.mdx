...
Now try running a job. Visit <http://127.0.0.1:8080>, navigate to the [launchpad](http://127.0.0.1:8080/workspace/example_repo@k8s-example-user-code-1/jobs/single_pod_job/launchpad) and click _Launch Execution_.

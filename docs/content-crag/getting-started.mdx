...
You can execute the job in three different ways: [Dagit](/concepts/dagit/dagit), Dagster Python API, or [Dagster CLI](/\_apidocs/cli#dagster-pipeline-execute).
...
Click on the "Playground" tab, then press the "Launch Execution" button to execute the job. You will then see Dagit launches a job run:

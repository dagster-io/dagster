...
Click on the "Playground" tab, then press the "Launch Execution" button to execute the job. You will then see Dagit launch a job run:
...
Similarly, you can specify the same op selection in Dagit Playground:

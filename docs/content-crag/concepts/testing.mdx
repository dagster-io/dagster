...
```python file=/concepts/resources/tests.py startafter=start_mode_test_before_marker endbefore=end_mode_test_before_marker
@solid
...
```python file=/concepts/resources/tests.py startafter=start_mode_test_after_marker endbefore=end_mode_test_after_marker
...
For more information, you can check out the [Modes](/concepts/resources) and [Resources](/concepts/resources) sections.

...
<PyObject module="dagster_slack" object="make_slack_on_run_failure_sensor" /> helps you create a job
...
Besides, if you would like to set up success or failure handling policies on solids, you can find more information on the [Solid Hooks](/concepts/solids-pipelines/op-hooks) page.

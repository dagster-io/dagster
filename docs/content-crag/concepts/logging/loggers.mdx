...
Dagster recognizes this by attaching loggers to [modes](/concepts/resources) so that you can seamlessly switch from, e.g., Cloudwatch logging in production to console logging in development and test, without changing any of your code.

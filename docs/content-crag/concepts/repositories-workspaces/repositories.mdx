...
- Includes various definitions: [Jobs](/concepts/solids-pipelines/pipelines), [Schedules](/concepts/partitions-schedules-sensors/schedules), [Sensors](/concepts/partitions-schedules-sensors/sensors).
...
Now you can see that all jobs, schedules, and sensors in this repository are on the left:

...
```python file=/concepts/assets/materialization_ops.py startafter=start_materialization_solids_marker_0 endbefore=end_materialization_solids_marker_0
@solid
def my_simple_solid():
    df = read_df()
...
```python file=/concepts/assets/materialization_ops.py startafter=start_materialization_solids_marker_1 endbefore=end_materialization_solids_marker_1
@solid
...
```python file=concepts/assets/materialization_ops.py startafter=start_simple_asset_solid endbefore=end_simple_asset_solid
@solid
...
If you specified any metadata entries on the <PyObject object="Output" /> event while yielding it (see: [Solid Event Docs](/concepts/solids-pipelines/op-events#attaching-metadata-to-outputs)), these entries will automatically be attached to the materialization event for this asset.
...
```python file=/concepts/assets/materialization_ops.py startafter=start_output_def_mat_solid_0 endbefore=end_output_def_mat_solid_0
...
```python file=/concepts/assets/materialization_ops.py startafter=start_output_def_mat_solid_1 endbefore=end_output_def_mat_solid_1

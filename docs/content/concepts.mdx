...
<LinkGrid>
  ...
  <LinkGridItem
    ...
    href="/concepts/types"
  >
  Dagster includes facilities for typing the input and output values of solids (“runtime” types). This section explains how to define, use, and test types in Dagster.
  </LinkGridItem>
  <LinkGridItem
    title="IO Management"
  ...
  <LinkGridItem
    title="Executors"
    href="/concepts/executors/executors"
  >

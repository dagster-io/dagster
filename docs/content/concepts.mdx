...
Resources enable you to separate logic from external dependencies, making developing and testing possible in multiple environments. [Learn more about resources](/concepts/resources).

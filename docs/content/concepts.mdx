...
## Resources and I/O management

**Resources** enable you to separate logic from external dependencies, making development and testing in multiple environments possible.

[Learn more about resources](/concepts/resources).

A special type of resource, **I/O managers** are user-provided objects that store asset and op outputs and load them as inputs to downstream assets and ops.

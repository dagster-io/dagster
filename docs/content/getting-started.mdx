...
<span id="tutorial" className="md:col-span-3 flex flex-wrap md:flex-nowrap items-center bg-blurple rounded-2xl py-6 md:py-2 px-6 md:pr-5 space-y-4 md:space-y-0 md:space-x-8">
  <p className="flex-auto text-gray-100 text-lg">
    New to Dagster? Learn all about it in a short tutorial.
  </p>
  <a
    href="/tutorial"
    className="flex-none border border-1 bg-blurple hover:no-underline border-gray-100 hover:bg-white hover:text-blurple shadow-none transition-colors duration-200 text-white font-semibold rounded-full py-3 px-4 no-underline"
  >
    Start the Tutorial
  </a>
</span>

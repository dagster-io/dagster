...
1. [Define an asset](#step-2-define-an-asset)
1. [Materialize the asset](#step-3-materialize-the-asset)
...
1. Navigate to <http://localhost:3000> in your web browser to view your asset.

1. Click the **Materialize All** button to launch a run that materializes the asset:

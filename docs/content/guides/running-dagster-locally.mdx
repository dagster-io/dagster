...
The `dagster dev` command launches [the Dagster webserver/UI](/concepts/dagster-ui) and the [Dagster daemon](/deployment/dagster-daemon), allowing you to start a full deployment of Dagster from the command line.

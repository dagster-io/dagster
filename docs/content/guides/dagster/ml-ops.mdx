...
We will work through building a machine lerning pipeline, including using assets for different elements, how to automate model training, and monitoring your model's drift.
...
<Note>
  This guide assumes you have familiarity with machine learning concepts and
  several Dagster concepts, including{" "}
  ...
  as many of the same principles can be applied to machine learning.
</Note>

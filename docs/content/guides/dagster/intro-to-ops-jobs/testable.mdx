---
title: "Intro to ops and jobs, part three: Testing ops and jobs | Dagster Docs"
...
Let's go back to the `diamond` job we wrote in the [prior section](/guides/dagster/intro-to-ops-jobs/connecting-ops#step-2-use-op-outputs-as-op-inputs), and ensure that it's working as expected by writing some unit tests.
...
Dagster is written to make testing easy in a domain where it has historically been very difficult. You can learn more about Testing in Dagster by reading the [Testing](/concepts/testing) documentation.

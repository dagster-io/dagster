...
description: This guide walk through a fully featured Dagster project that uses many of Dagster's features.
---
...
This example contains [three asset group](https://github.com/dagster-io/dagster/blob/master/examples/project_fully_featured/project_fully_featured/assets/\__init\_\_.py):

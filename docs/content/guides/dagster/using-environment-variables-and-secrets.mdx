...
If your Dagster project contains a `.env` file, Dagster will automatically load the environment variables it contains when Dagit is started.

When using a `.env` to develop locally, keep the following in mind:

- The `.env` file must be in the same folder where Dagit is run
- The workspace must be re-loaded any time the file is modified for Dagit to be aware of the changes
...
- [Empty .env file](#empty-env-file)

### Variable not set

```shell
You have attempted to fetch the environment variable "[variable]" which is not set.
In order for this execution to succeed it must be set in this environment.
```
...
>
  <tbody>
    <tr>
      ...
      <td>
        Dagster couldn't find the named environment variable in the executing
        environment.
      </td>
    </tr>
    <tr>
      ...
      <td>
        Verify that the environment variable is named correctly and accessible
        in the environment.
        <ul>
          <li>
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                <a href="/dagster-cloud/developing-testing/environment-variables-and-secrets#scope">
              ...
              <li>
                ...
                and added to your{" "}
                <a href="/dagster-cloud/developing-testing/environment-variables-and-secrets#managing-environment-variables">
...
```shell
No environment variables in .env file
```
...
>
  <tbody>
    ...
    <tr>
      ...
      <td>
        If this is unexpected, verify that your <code>.env</code> is correctly
        formatted and located in the same folder where you're running Dagit.
      </td>
    </tr>
  </tbody>
</table>

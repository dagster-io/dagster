...
Refer to the [Dagster Cloud environment variables guide](/dagster-plus/managing-deployments/environment-variables-and-secrets) for more info.
...
This approach also works for accessing [built-in environment variables for Dagster Cloud](/dagster-plus/managing-deployments/environment-variables-and-secrets#built-in-environment-variables):

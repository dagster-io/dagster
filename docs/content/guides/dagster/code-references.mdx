...
from dagster_cloud.metadata.source_code import (
...
The <PyObject module="dagster" object="dagster._core.definitions.metadata.link_code_references_to_git"/> utility allows you to convert local file code references to source control links. You'll need to provide the base URL of your git repository, the branch or commit hash, and a path to the repository root locally.

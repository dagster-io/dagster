...
Note that using software-defined assets in one job doesn’t mean need to be used in all your jobs. If your use case doesn't meet these criteria, you can still use graphs and ops.
...
| A [graph](/concepts/ops-jobs-graphs/jobs-graphs) is a composite unit of computation that connects multiple ops | Every software-defined asset includes a graph or an op                                         |

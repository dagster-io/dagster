...
<Note>
  ...
  Join our [GitHub discussion]() to share how you organize your Dagster code.
</Note>
...
As your experience with Dagster grows, certain aspects of this guide no longer apply to your use cases, and you may want to change the structure to adapt to your business needs.
...
In these situations, we recommend having a `jobs` folder rather than a `jobs.py` file. Depending on the types of jobs you have, you can create a separate file for each types of jobs.

...
`sfo_q2_weather_sample` represents our base temperature table. It's a <PyObject module="dagster.core.asset_defs" object="ForeignAsset" />, meaning that it's generated outside Dagster.

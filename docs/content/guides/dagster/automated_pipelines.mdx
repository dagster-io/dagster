...
```python file=/guides/dagster/automated_pipelines/vanilla_schedule.py
...
```python file=/guides/dagster/automated_pipelines/declare_schedule.py
from dagster import (
    AssetSelection,
    Definitions,
    FreshnessPolicy,
...
```python file=/guides/dagster/automated_pipelines/s3_sensor.py
...
```python file=/guides/dagster/automated_pipelines/airbyte_dbt_sensor.py

...
```python file=/guides/dagster/automating_pipelines/vanilla_schedule.py
...
```python file=/guides/dagster/automating_pipelines/config_schedule.py
...
```python file=/guides/dagster/automating_pipelines/s3_sensor.py
...
```python file=/guides/dagster/automating_pipelines/airbyte_dbt_sensor.py

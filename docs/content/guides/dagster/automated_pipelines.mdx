...
```python file=/examples/docs_snippets/docs_snippets/guides/dagster/automating_pipelines/vanilla_schedule.py
...
```python file=/guides/dagster/automated_pipelines/config_schedule.py
...
```python file=/examples/docs_snippets/docs_snippets/guides/dagster/automating_pipelines/declare_schedule.py
from dagster import (
    AssetSelection,
    Definitions,
    FreshnessPolicy,
...
```python file=/examples/docs_snippets/docs_snippets/guides/dagster/automating_pipelines/s3_sensor.py
...
If every time you materialize Airbyte assets you want to execute a dbt asset, [asset sensors](/concepts/partitions-schedules-sensors/asset-sensors#asset-sensors-1) can be used to automate that process. Asset sensors can be used across [code locations](/concepts/code-locations#code-locations), so if you are managing some Airbyte assets in one code location and DBT assets in another, you can use asset sensors to trigger jobs to run. 
...
```python file=/examples/docs_snippets/docs_snippets/guides/dagster/automating_pipelines/airbyte_dbt_sensor.py

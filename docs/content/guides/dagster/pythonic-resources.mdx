...
ENOENT: no such file or directory, open '/Users/ben/Documents/repos/dagster/examples/docs_snippets/docs_snippets/guides/dagster/pythonic_resources/pythonic_resources.py'
```

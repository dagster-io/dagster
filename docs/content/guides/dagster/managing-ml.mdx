...
- [Automating your data pipelines](/guides/dagster/automating-pipelines) which provides background on using [schedules](/concepts/partitions-schedules-sensors/schedules) and [sensors](/concepts/partitions-schedules-sensors/sensors).
- [Building machine learning pipelines with Dagster](/guides/dagster/ml-pipeline) which walks through using [assets](/concepts/assets/software-defined-assets) for machine learning.

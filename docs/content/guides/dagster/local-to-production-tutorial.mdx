...
- [IO managers](/concepts/io-management/io-managers) - An IO manager is a special kind of resource that handles storing and loading assets. For example, if we wanted to store assets in S3, we could use Dagster’s built-in S3 IO manager.
...
### Option 1: Clone the example code:
...
### Option 2: Start with a scaffolded project:

...
Now we can write stubbed version of the Hacker News resource. We want to make sure the stub has implementations for each method the real `HackerNewsClient` implements.

...
```bash
cd examples/local_to_production
pip install -e .
```
...
```python file=/guides/dagster/local_to_production/repository/repository_v1.py startafter=start endbefore=end
# repository.py
...
```python file=/guides/dagster/local_to_production/repository/repository_v2.py startafter=start endbefore=end
# repository.py
...
```python file=/guides/dagster/local_to_production/repository/repository_v3.py startafter=start endbefore=end
# repository.py
...
```python file=/guides/dagster/local_to_production/repository/repository_v3.py startafter=start_staging endbefore=end_staging
resource_defs = {
    "local": {...},
    "production": {...},
    "staging": {
...
```python file=/guides/dagster/local_to_production/resources/resources_v1.py startafter=start_resource endbefore=end_resource
# resources.py
...
```python file=/guides/dagster/local_to_production/assets_v2.py startafter=start_items endbefore=end_items
# assets.py
...
```python file=/guides/dagster/local_to_production/resources/resources_v2.py startafter=start_mock endbefore=end_mock
# resources.py
...
```python file=/guides/dagster/local_to_production/test_assets.py startafter=start endbefore=end
# test_assets.py

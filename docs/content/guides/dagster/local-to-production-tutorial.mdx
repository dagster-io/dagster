...
<Note>
If you're using [Dagster Cloud](link to dagster cloud page explaining this?), this environment variable will be set for you. Additionally, if you're using [Branch Deployments](link to branch deployments page explaining this?) <code>DAGSTER_DEPLOYMENT</code> will be automatically set to <code>VAR</code>.

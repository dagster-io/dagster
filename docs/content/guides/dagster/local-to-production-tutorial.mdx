...
```python file=/guides/dagster/local_to_prod_tutorial/assets_v1.py startafter=start_assets endbefore=end_assets
# assets.py
import pandas as pd
import requests
...
```python file=/guides/dagster/local_to_prod_tutorial/repository/repository_v3.py startafter=start_staging endbefore=end_staging
resource_defs = {
    "local": {...},
    "production": {...},
    "staging": {

...
- An existing [Branch Deployments setup that uses GitHub actions](/dagster-cloud/managing-deployments/branch-deployments/using-branch-deployments-with-github). Your setup should contain a Dagster project set up for branch deployments containing:

...
- [Resources](/concepts/resources) - We'll use the [Snowflake resource](/\_apidocs/libraries/dagster-snowflake#dagster_snowflake.SnowflakeResource) to swap in different Snowflake connections to our jobs depending on environment.

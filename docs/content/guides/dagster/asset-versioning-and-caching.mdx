...
The core abstraction of Dagster a software-defined asset which, in its idealized form, is a side-effect-free ("pure") function that produces an output asset from input assets.

...
**Note**: This guide describtes approaches to unit testing assets, but **asset checks** can be used to test assets at runtime! Refer to the [Asset checks](/concepts/assets/asset-checks) documentation for more information and examples.

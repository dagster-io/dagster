...
Dagster provides _eager_ <PyObject object="AutoMaterializePolicy" pluralize >, which allow materializing an asset whenever it's parent assets are materialized. Note that this feature is currently marked experimental, and some of the APIs may change in the future. test

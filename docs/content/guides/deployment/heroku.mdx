# Deploying Dagster on Heroku

Here you should include one short description about the Heroku, and why it's a good fit for Dagster
...
Once you have Dagster installed, run the `new-repo` command to scaffold a new project.
...
- Components to deploy:
  ...
  - Storages (Database)
  - User Code
  - Heroku-specific compute log manager, if any
  - Heroku-specific IO Managers, if any
...
- Summary
- Further learning materials, e.g. relevant Heroku docs

...
- [Scheduling Software-defined assets with freshness policies](/guides/dagster/schduling-assets) - Create data SLAs and schedule based on desired outcomes not tasks

...
- [Scheduling Software-defined assets with freshness policies](/guides/dagster/scheduling-assets) - Create data SLAs and schedule based on desired outcomes not tasks

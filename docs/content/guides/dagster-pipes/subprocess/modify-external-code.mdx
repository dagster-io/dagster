...
Then, the log messages will show up in the [**Run details**](/concepts/dagster-ui#run-details) page of the Dagster UI. You can filter the log levels to only view `info` level messages:

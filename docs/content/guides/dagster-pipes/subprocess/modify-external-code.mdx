...
```python file=/guides/dagster/dagster_pipes/subprocess/part_2/step_3/external_code.py startafter=start_events_marker endbefore=end_events_marker dedent=4
# get the Dagster Pipes context
context = PipesContext.get()
...
```python file=/guides/dagster/dagster_pipes/subprocess//part_2/step_3/external_code.py startafter=start_checks_marker endbefore=end_checks_marker dedent=4
...
```python file=/guides/dagster/dagster_pipes/subprocess/part_2/step_3/dagster_code.py
import shutil
...
```python file=/guides/dagster/dagster_pipes/subprocess/part_2/step_3/external_code_finished.py
import pandas as pd
from dagster_pipes import PipesContext, open_dagster_pipes
...
Now, you've learned how to get access to Dagster Pipes context, report log messages events from the external process, and send structured events back to Dagster.

...
You can specify different configured boto3 clients, or handle the switch by swapping underlying AWS env vars between deploymenets.

Check out more details of how to smoothly transition bteween different environments in [Transitioning Data Pipelines from Development to Production](/guides/dagster/transitioning-data-pipelines-from-development-to-production) and [Testing against production with Dagster Cloud Branch Deployments](https://docs.dagster.io/guides/dagster/branch_deployments).

...
- [**Write and execute an op job**](/tutorial/intro-tutorial/single-op-job) using a sample CSV dataset
- [**Connect ops in jobs**](/tutorial/intro-tutorial/connecting-ops) to create complex, multi-op jobs using a sample CSV dataset
- [**Test ops and jobs**](/tutorial/intro-tutorial/testable) with unit tests

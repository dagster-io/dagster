...
- [**Defining an Asset**](/guides/dagster/asset-tutorial) demonstrates how to define an [asset](/concepts/assets/software-defined-assets) using a sample CSV dataset.
- [**Building Graphs of Assets**](/guides/dagster/asset-tutorial/asset-graph) walks you through creating a [graph](/concepts/ops-jobs-graphs/jobs-graphs) using multiple assets.
- [**Testing Assets**](/guides/dagster/asset-tutorial/testing-assets) shows you how to test assets, whether for a single asset or a graph of assets.

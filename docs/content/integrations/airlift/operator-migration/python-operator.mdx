...
```python file=/integrations/airlift/operator_migration/pyop_asset.py startafter=start_asset endbefore=end_asset
ENOENT: no such file or directory, open '/Users/christopherdecarolis/dagster/examples/docs_snippets/docs_snippets/integrations/airlift/operator_migration/pyop_asset.py'
```

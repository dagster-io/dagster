...
```python file=/integrations/airlift/tutorial/custom_operator_examples/custom_proxy.py
from pathlib import Path
...
```python file=/integrations/airlift/tutorial/custom_operator_examples/plus_proxy_operator.py
import requests
from airflow.utils.context import Context

...
```bash
git clone git@github.com:dagster-io/airlift-tutorial.git
cd airlift-tutorial
```
...
The tutorial example involves running a local Airflow instance. This can be done by running the following commands from the root of the `airlift-tutorial` directory.

...
- Analyze the data stored in Snowflake without writing custom SQL queries to fetch the data
- Visualize the data dependencies between tables
- Selectively update the contents of your tables
- Integrate your Snowflake tables with other tools in your data stack, like dbt

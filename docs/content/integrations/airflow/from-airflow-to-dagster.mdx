...
### Step 1: Defining the computations
...
```python file=/integrations/airflow/tutorial_rewrite.py startafter=start_imports endbefore=end_ops
import time
...
```python file=/integrations/airflow/tutorial_rewrite.py startafter=start_schedule endbefore=end_schedule
...
```python python file=/integrations/airflow/tutorial_rewrite.py
import time
from datetime import date, timedelta

...
To convert a Dagster Job to a Airflow Dag[dagster repository](/concepts/repositories-workspaces/repositories), use <PyObject module="dagster_airflow" object="make_airflow_dag" />:

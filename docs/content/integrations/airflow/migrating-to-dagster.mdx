...
Your migrated airflow DAGs should be able to on both OSS and Dagster Cloud however in this guide we'll focus on running in Cloud. To get cloud configured we'll want to create a file called `dagster_cloud.yaml` in the root of your project
...
You will also need to install another python library called `dagster-cloud` to your project.

and assuming you've created a dagster cloud account and setup your dagster cloud cli correctly you can run

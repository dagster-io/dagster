...
- **If using Dagster Cloud**, an existing [Dagster Cloud](/dagster-plus) account. While your migrated Airflow DAGs will work with Dagster Open Source, this guide includes setup specific to Dagster Cloud.

  **If you just signed up for a Cloud account**, follow the steps in the [Dagster Cloud Getting Started guide](/dagster-plus/getting-started) before proceeding.
...
1. Complete the steps in the [Dagster Cloud Getting Started guide](/dagster-plus/getting-started), if you haven't already. Proceed to the next step when your account is set up and you have the `dagster-cloud` CLI installed.

...
<Note>
    Note: In order to load data from BigQuery as a PySpark DataFrame, a View containing the data must be created. This will result in the creation of a temporary table in your BigQuery dataset.

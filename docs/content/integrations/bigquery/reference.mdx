...
<Note>
    ...
    <li>Otherwise, if there is a <code>key_prefix</code>, that dataset will be used</li>
    <li>Otherwise, the dataset set as configuration on the I/O manager will be used</li>
    <li>If none of the above are provided, the default dataset will be <code>PUBLIC</code></li>
    </ol>
</Note>

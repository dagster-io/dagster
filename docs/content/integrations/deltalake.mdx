...
Using Dagster's [Software-defined Assets](/concepts/assets/software-defined-assets) and Deltalake I/O manager, you can easily interact with DuckDB tables alongside other Dagster assets.

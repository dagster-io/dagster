---
title: "Dagster + Airflow | Dagster Docs"
...
The [`dagster-airflow`](/\_apidocs/libraries/dagster-airflow) library provides interoperability between Dagster and Airflow. Using `dagster-airflow`, you can:

- Incorporate an Airflow Directed Acyclic Graph (DAG) directory as a Dagster repository, allowing you to do a lift-and-shift migration of your existing Airflow DAGs into Dagster jobs or Software-defined Assets (SDAs)
- Orchestrate Dagster jobs from Airflow
- Ingest DAGs from Airflow
...
Interested in migrating from Airflow to Dagster? Check out the [migration guide](/integrations/airflow/migrating-to-dagster) for a step-by-step walkthrough. You can also refer to the [Airflow reference](/integrations/airflow/reference) for specific examples.

...
- [**Option 1:**](#option-1-with-dbtproject) With DbtProject
- [**Option 2:**](#option-2-without-dbtproject) Without DbtProject

</TabItem>
<TabItem name="Option 1: With DbtProject">

### Option 1: With `DbtProject`
...
<TabItem name="Option 2: Without DbtProject">

### Option 2: Without `DbtProject`

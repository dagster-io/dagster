...
When deploying your Dagster project to production, your dbt project will be cloned from your Dagster project so that dbt commands can be executed. As a result, we recommend that you set up your continuous integration and continuous deployment (CI/CD) workflows to redeploy your Dagster code location whenever dbt updates.
In Dagster+, you can follow [this](#configure-cicd-for-your-project) guide to set up CI/CD pointed at your dagster code location.

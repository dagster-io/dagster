...
- Click the **asset** to open a sidebar containing info about the asset, including its last materialization stats and a link to view the [**Asset details** page](/concepts/dagster-ui#asset-details)
- Click the ID of the **Latest Run** in an asset to view the [**Run details**](/concepts/dagster-ui#run-details) page. This page contains detailed info about the run, including timing information, errors, and logs.

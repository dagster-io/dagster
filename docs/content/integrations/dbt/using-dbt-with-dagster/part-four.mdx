...
1. In `assets.py`, replace the imports section with the following:
...
- Finally, the chart is saved as `order_count_chart.html` in `/dbt_dagster_tutorial/dagster_code` and automatically opened in the browser.

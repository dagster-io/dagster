...
Open the `__init__.py` file, located in `/tutorial_template/dbt_dagster_sda_tutorial/assets`, and add the following code:
...
Open the `repository.py` file, located in `/tutorial_template/dbt_dagster_sda_tutorial`, and add the following code:
...
1. To start Dagit, run the following in the `tutorial_template` folder:

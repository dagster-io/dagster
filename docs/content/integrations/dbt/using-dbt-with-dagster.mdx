...
- [Create and materialize a downstream asset](/integrations/dbt/using-dbt-with-dagster/part-four) that outputs a plotly chart
...
When you've fulfilled all the prerequisites for the tutorial, you can get started by [setting up the dbt project](/integrations/dbt/using-dbt-with-dagster/part-one).

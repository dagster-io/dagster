...
- [Configure dbt model data sources](/integrations/dbt/using-dbt-with-dagster/part-two)
- [Create Dagster assets upstream of the dbt models](/integrations/dbt/using-dbt-with-dagster/part-three)
- [Materialize the assets using Dagit](/integrations/dbt/using-dbt-with-dagster/part-four), Dagster's web interface
- [Create a downstream asset](/integrations/dbt/using-dbt-with-dagster/part-five) that outputs a histogram chart using plotly

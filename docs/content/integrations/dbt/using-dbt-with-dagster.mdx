...
Dagster has built-in support for loading dbt models, seeds, and snapshots as [software-defined assets](/concepts/assets/software-defined-assets), enabling you to:
...
In this tutorial, we'll walk you through integrating dbt with Dagster using dbt's example [jaffle shop project](https://github.com/dbt-labs/jaffle_shop), the [dagster-dbt library](/\_apidocs/libraries/dagster-dbt), and a [DuckDB database](https://duckdb.org/). By the end of this tutorial, you will:

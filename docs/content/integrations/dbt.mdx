...
## Loading dbt models as Software-Defined Assets
...
For larger projects, the overhead involved in recompiling your entire project whenever your repository needs to be loaded may become a significant concern. In these cases, it's possible

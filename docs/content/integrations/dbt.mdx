...
<Note>
  <b>Using Dagster+?</b> Automatically load your dbt models as Dagster assets by{" "}
  <a
    target="_blank"
    href="https://dagster.plus/signup?next=/prod/getting-started%3Ftab%3Dimport_dbt_core_project%26serverless%3D1"
  >
    importing an existing dbt project in Dagster+
  </a>
</Note>
...
- Browse the [`dagster-dbt` integration reference](/integrations/dbt/reference) for short lessons on dbt and Dagster topics.
- Review the [API docs](/\_apidocs/libraries/dagster-dbt) for the `dagster-dbt` library.
- Automatically load your dbt models as Dagster assets by [importing an existing dbt project into Dagster+](https://dagster.plus/signup?next=/prod/getting-started%3Ftab%3Dimport_dbt_core_project%26serverless%3D1).

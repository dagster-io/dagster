...
- Automatically load your dbt models as Dagster assets by [importing an existing dbt project into Dagster+](https://dagster.cloud/signup?next=/prod/getting-started%3Ftab%3Dimport_dbt_core_project%26serverless%3D1).

...
resources, visit the [Resources Overview](/concepts/modes-resources/resources).
...
need a [ModeDefinition](/concepts/modes-resources/modes) that defines a resource under the
key `"dbt_rpc"`.

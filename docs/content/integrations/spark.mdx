...
```python file=../../with_pyspark/with_pyspark/defs.py
import os
...
```python file=../../with_pyspark_emr/with_pyspark_emr/repository.py startafter=start-snippet endbefore=end-snippet

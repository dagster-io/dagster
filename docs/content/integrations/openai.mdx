...
description: The dagster-openai library provides the ability to build OpenAI pipelines with Dagster and log OpenAI API usage metadata in Dagster Insights, through helpful resources.
---

# Dagster OpenAI

The dagster-openai library provides the ability to build OpenAI pipelines with Dagster and log OpenAI API usage metadata in Dagster Insights, through helpful resources.

This library includes a resource, <PyObject module="dagster_openai" object="OpenAIResource" />, using the [OpenAI Python API Library](https://github.com/openai/openai-python), which provides a simple way to interact with OpenAI API.

When used with Dagster's [Software-defined Asset](/concepts/assets/software-defined-assets), the resource automatically logs OpenAI usage metadata in the asset metadata. More details can be found in [relevant APIs](#relevant-apis).
...
To get started with `dagster-openai` and OpenAI, familiarize yourself with the [OpenAI Python API Library](https://github.com/openai/openai-python) by reading their docs which describe how to interact with the OpenAI API using Python.

More information is also available the [OpenAI API documentation website](https://platform.openai.com/docs/introduction).

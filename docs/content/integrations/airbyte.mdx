...
The easiest way to get started using Airbyte with Dagster is to have Dagster automatically generate asset defintions from your Airbyte project. Dagster can [load asset definitions from an Airbyte instance via API](#loading-airbyte-asset-definitions-from-an-airbyte-instance), at initialization time.

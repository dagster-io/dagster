...
description: The Dagstermill (Dagster + papermill) package lets you run notebooks using the Dagster tools and integrate them into your data pipelines.
---
...
- Run notebooks as assets or ops in heterogeneous data jobs with minimal changes to notebook code
...
In this guide we go through the process of creating a Dagster asset for a Jupyter notebook. Then we will create an asset that will be an input for the notebook.

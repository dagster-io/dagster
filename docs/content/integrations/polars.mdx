---
title: "Polars + Dagster"
description: Use Polars DataFrames with Dagster
---
...
| Name                                                                 | Description                  |
| -------------------------------------------------------------------- | ---------------------------- |
| <PyObject module="dagster_polars" object="BasePolarsUPathIOManager" /> | Base IOManager        |
| <PyObject module="dagster_polars" object="PolarsParquetIOManager" /> | IOManager for Parquet        |
| <PyObject module="dagster_polars" object="PolarsDeltaIOManager" /> | IOManager for DeltaLake |
| <PyObject module="dagster_polars" object="PolarsBigQueryIOManager" /> | IOManager for BigQuery |
...
from dagster_polars import PartitionedDataFrame, PartitionedLazyFrame
...
def downstream_eager(upstream: PartitionedDataFrame):
...
def downstream_lazy(upstream: PartitionedLazyFrame):
    assert isinstance(upstream, dict)

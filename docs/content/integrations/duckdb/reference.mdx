...
DuckDB I/O manager customization:
...
DuckDB resource information:

- [Executing custom SQL commands with the DuckDB resource](#executing-custom-sql-commands-with-the-duckdb-resource)

---

## Customizing the DuckDB I/O manager's behavior

The DuckDB I/O manager provides several ways to customize how your data is stored and loaded in DuckDB. However, if you find that these do not provide enough customization for your use case, we recommend using the DuckDB resource to save and load your data. By using the resource, you will have more fine grained control over how your data in handled. For more information on the DuckDB resource, see the \[DuckDB resource]\(# TODO LINK) section.
...
### Using the DuckDBResource in assets

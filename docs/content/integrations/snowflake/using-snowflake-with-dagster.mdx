...
**Prefer to use an I/O manager?** Unlike resources, an [I/O manager](/concepts/io-management/io-managers) transfers the responsibility of storing and loading DataFrames as Snowflake tables to Dagster. Refer to the [Snowlake I/O manager guide](/integrations/snowflake/using-snowflake-with-dagster-io-manager) for more info.

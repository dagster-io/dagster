...
Since the data in the **TIME** column cannot be directly compared to a timestamp, the `partition_expr` metadata is a SQL statement that converts integers to timestamps.

...
Note that the content and size of Sigma organization may affect the performance of your Dagster deployments. Filtering the workbooks from which your Sigma assets will be loaded is particularly useful for improving loading times.

```python file=/integrations/sigma/filter-workbooks-sigma-assets.py

...
Congratulations on successfully running your first Dagster pipeline! In this example, we used [assets](/tutorial), which are a cornerstone of most Dagster projects. They empower data engineers to:

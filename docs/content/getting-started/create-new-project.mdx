  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <PyObject object="load_assets_from_package_module" /> to load assets from a package or <PyObject object="load_assets_from_modules" /> from a list of modules into your project and
        group them based on the folder structure, rather than needing to manually add assets to the top-level definitions every time you define one.

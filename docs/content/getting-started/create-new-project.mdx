  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        <br />
        This file includes a <code>tool.dagster</code> section which references the Python
        package with your Dagster definitions defined and discoverable at the top level.
        This allows you to use the
        <code>dagster dev</code> command to load your Dagster code without any parameters.
        Refer to the <a href="/concepts/code-locations">Code locations documentation</a> to learn more.
        <br />
...
1. To install it as a package and its Python dependencies, run:
   ...
   <Note>
     Using the <code>--editable</code> (<code>-e</code>) flag instructs <code>pip</code> to install
     your code location as a Python package in{" "}

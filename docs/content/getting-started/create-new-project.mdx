...
>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        A file that specifies the location of your code for Dagit and the
        Dagster CLI. Check out{" "}
    ...
    <tr>
      <td>setup.cfg</td>
      <td>
        An int file that contains option defaults for <code>setup.py</code>{" "}
        commands.
      </td>
    </tr>
  </tbody>
...
>
  ...
  <tbody>
    <tr>
      <td>my_dagster_project/repository.py</td>
      <td>
        A Python module that contains a{" "}
        <PyObject object="RepositoryDefinition" />, to specify which assets,
        jobs, schedules, and sensors are available in your repository.
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        into your repository, rather than needing to add assets to the
        repository every time you define one.
      </td>
    </tr>
  </tbody>
</table>

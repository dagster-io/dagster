...
3. Click **Materialize All** to run the pipeline and create your assets:
...
Congrats on your first Dagster pipeline! This example used [assets](/tutorial#assets), which most Dagster projects utilize because they let data engineers:

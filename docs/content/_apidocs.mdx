...
- [Definitions](/\_apidocs/definitions) APIs to collect definitions tools such as the Dagster CLI or Dagit can them as code locations.
...
- [Repositories](/\_apidocs/repositories) Older APIs to define collections of jobs and other definitions that tools such as the Dagster CLI or Dagit can load from.

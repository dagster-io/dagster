...
- [Tables](/\_apidocs/tables) (Experimental) `TableRecord` and `TableSchema` objects can be attached to Dagster Types and events as metadata, where they are specially rendered in Dagit.

...
- [Definitions](/\_apidocs/definitions) APIs to collect definitions so that tools like the Dagster CLI or UI can load them as code locations.
...
- [Asset Checks (Experimental)](/\_apidocs/asset-checks) APIs to define checks that can be run on assets.

- [Job-Level Versioning & Memoization](/\_apidocs/memoization) (Deprecated) Code versioning and memoization of previous outputs based upon that versioning.

- [Repositories](/\_apidocs/repositories) Older APIs to define collections of jobs and other definitions that tools like the Dagster CLI or UI can load.

- [Utilities](/\_apidocs/utilities) Miscellaneous helpers used by Dagster that may be useful to users.

- [Pipes](/\_apidocs/pipes) APIs for working with the Dagster Pipes protocol from the orchestration side.

...
To verify that your dagster installation was successful, let's create your first Dagster project! We'll be using the Dagster scaffolding to give you an empty Dagster project that you can run locally.
...
For more information on starting a Dagster project, you can look at the [Creating a new Dagster project page](/getting-started/create-new-project).
...
When you've created your first Dagster project, you can get started [creating your first asset](/tutorial/assets/defining-an-asset).

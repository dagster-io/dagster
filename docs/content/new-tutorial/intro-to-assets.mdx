...
```python file=/intro_tutorial/basics/hackernews/hackernews.py startafter=start_topstories_asset_marker endbefore=end_topstories_asset_marker dagimage=/images/asset-screenshots/hackernews_topstories_asset.svg

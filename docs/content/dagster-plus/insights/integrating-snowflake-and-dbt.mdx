...
# Integrating Snowflake & dbt with Dagster+ Insights (Experimental)
...
- To install the following libraries:
  ...
  ```shell
  pip install dagster dagster-plus dagster-dbt dagster-snowflake
  ```

  **Note**: If you already have `dagster-plus` installed, **make sure you're using version 1.5.1 or newer**.

...
Using a GraphQL API endpoint, you can export [Dagster Cloud Insights](/dagster-plus/insights) metrics from your Dagster Cloud instance.
...
- A Dagster Cloud [user token](/dagster-plus/account/managing-user-agent-tokens#managing-user-tokens)

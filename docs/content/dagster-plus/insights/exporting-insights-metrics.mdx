---
title: "Exporting metrics from Dagster+ Insights | Dagster Docs"
description: "Exporting metrics from Dagster+ Insights."

platform_type: "cloud"
---

# Exporting metrics from Dagster+ Insights (Experimental)
...
- Your deployment-scoped Dagster+ deployment URL. For example: `dagster-university.dagster.plus/prod`
...
def get_client():
    url = "YOUR_ORG.dagster.plus/prod"  # Your deployment-scoped url
...
1. Navigate to <https://YOUR_ORG.dagster.plus/prod/graphql>, replacing `YOUR_ORG` with your organization name. For example: `https://dagster-university.dagster.plus/prod/graphql`

...
**For info about deploying an ECS agent in an existing VPC**, check out the [ECS agents in existing VPCs guide](/dagster-plus/deployment/agents/amazon-ecs/creating-ecs-agent-existing-vpc).

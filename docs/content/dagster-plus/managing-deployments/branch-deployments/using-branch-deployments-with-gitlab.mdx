---
title: Using Branch Deployments with Gitlab CI/CD | Dagster+
...
In this guide, we'll walk you through setting up [Branch Deployments](/dagster-plus/managing-deployments/branch-deployments) with Gitlab CI/CD.
...
- **The ability to configure Gitlab CI/CD for your project**. This isn't required if you used the Dagster+ Gitlab app to connect your project as a [code location](/dagster-plus/managing-deployments/code-locations).
...
- `DAGSTER_CLOUD_URL` - Your Dagster+ base URL (e.g. `https://my_org.dagster.plus`)

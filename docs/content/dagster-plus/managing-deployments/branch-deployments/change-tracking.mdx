...
Some Dagster integrations, like `dagster-dbt`, automatically compute code versions for you. For more information on code versions, including strategies for how to automatically compute code versions, refer to the [Code versioning guide](/guides/dagster/asset-versioning-and-caching).

...
Change Tracking can detect when an [asset's definition metadata](/concepts/metadata-tags/asset-metadata#definition-metadata) has changed, whether it's been added, modified, or removed.

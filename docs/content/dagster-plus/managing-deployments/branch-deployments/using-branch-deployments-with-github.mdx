...
<Note>
  ...
  <strong>Want to use secrets in your Dagster code?</strong> Check out the <a href="/dagster-plus/managing-deployments/environment-variables-and-secrets">
    Dagster+ environment variables and secrets guide
  </a> for more info.
</Note>
...
- `DAGSTER_CLOUD_API_TOKEN` - The Dagster+ agent token you created in [Step 1](#step-1-generate-a-dagster-cloud-agent-token)
...
- [Directly in Dagster+](#directly-in-dagster-cloud)

...
To use Branch Deployments, you'll need a [Dagster+ account](https://dagster.plus/).
...
When a Branch Deployment is deployed, it compares the asset definitions in the branch deployment with the asset definitions in the main deployment. The Dagster UI will then mark the changed assets, making it easy to identify changes. Refer to the Tracking asset changes in Branch Deployments guide for more information and examples.

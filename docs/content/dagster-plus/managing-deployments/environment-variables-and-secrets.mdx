  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        to the{" "}
        <a href="/dagster-plus/managing-deployments/setting-environment-variables-dagster-cloud-agents">
...
Refer to the [Setting environment variables for Dagster+ agents guide](/dagster-plus/managing-deployments/setting-environment-variables-dagster-cloud-agents) for more info.

...
**Prefer to work in code?** You can also define and set alert policies using the [`dagster-plus` CLI](/dagster-plus/managing-deployments/alerts/managing-alerts-cli).

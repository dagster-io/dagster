...
2. There are two ways to add an integration to a service:
   ...
   - **If creating a new service for your integration**: Refer to PagerDuty's [Configuring services and integrations documentation](https://support.pagerduty.com/docs/services-and-integrations#section-configuring-services-and-integrations) and follow the steps outlined in the [Create a new service](https://support.pagerduty.com/docs/services-and-integrations#section-create-a-new-service) section, selecting **Dagster+** as the **Integration Type** in step 4. Continue with the [**In Dagster+**](#in-dagster-cloud) section (below) once finished.

3. Enter an **Integration Name** in the format `monitoring-tool-service-name` (e.g. `dagster-cloud-run-failures`) and select **Dagster+** from the **Integration Type** menu.

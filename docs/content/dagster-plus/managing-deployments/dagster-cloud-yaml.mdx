...
description: Use dagster_cloud.yaml to configure code locations for Dagster+
---
...
>
  <tbody>
    ...
    <tr>
      ...
      <td>
        {" "}
        Defines multiple code locations for Dagster+. For Hybrid deployments, this
        file can be used <a href="/dagster-plus/managing-deployments/setting-environment-variables-dagster-cloud-agents">

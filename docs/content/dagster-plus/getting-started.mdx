...
To complete this step using the CLI, add `dagster-cloud` as a dependency in `setup.py` in your Dagster code.
For an example, see the [dagster-quickstart project](https://github.com/dagster-io/dagster-quickstart/blob/main/setup.py).

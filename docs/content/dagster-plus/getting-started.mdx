...
- [**Import an existing project**](#import-an-existing-project) - Import an existing GitHub repository using our GitHub integration or the [dagster-cloud CLI](/dagster-plus/managing-deployments/dagster-cloud-cli). **Note**: If using the GitHub integration, Dagster+ will automatically set up CI/CD for you.

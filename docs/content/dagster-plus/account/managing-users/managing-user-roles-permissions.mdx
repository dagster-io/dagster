...
Dagster+ employs a flexible approach to user roles and permissions. This system is built on two fundamental concepts:
...
- **Default Roles:** Hierarchical roles, based on sensible defaults that come out of the box with Dagster.
- **Custom Roles:** Allows you to define tailored roles with specific sets of permissions

This dual approach provides both the simplicity of predefined roles and the flexibility to create custom roles that precisely match your organization's needs.
...
Deleting custom roles is similar to editing. At the bottom of the edit dialog you'll see a button to "Delete role". Two things to note when deleting a role:

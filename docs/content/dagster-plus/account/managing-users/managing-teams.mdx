...
As part of our [role-based access control (RBAC) feature](/dagster-plus/account/managing-users/managing-user-roles-permissions), Dagster Cloud supports the ability to assign users to teams. A team is a group of users with a set of default deployment, code location, and Branch Deployment user roles.
...
<Note>
  <a href="/dagster-plus/account/managing-users/managing-user-roles-permissions#teams">

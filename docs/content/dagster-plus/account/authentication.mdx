...
- **Google**. Users must be [added in Dagster Cloud](/dagster-plus/account/managing-users#adding-users) before they'll be able to log in using their Google accounts.
- GitHub

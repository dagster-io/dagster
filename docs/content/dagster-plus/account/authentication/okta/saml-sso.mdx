...
2. In the **Organization** field, enter your Dagster+ organization name. This is used to route the SAML response to the correct Dagster+ subdomain.
...
3. Click **View IdP metadata**:
   ...
   ![The View IdP metadata options in the Okta UI](/images/dagster-cloud/sso/okta/save_identity_provider_metadata.png)
...
4. Right-click on the page and use **Save As** or **Save Page As**:
   ...
   ![](/images/dagster-cloud/sso/okta/save-xml-as-page.png)

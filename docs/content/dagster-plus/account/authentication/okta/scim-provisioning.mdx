---
title: "Setting up Okta SCIM provisioning for Dagster+ | Dagster Docs"
...
# Setting up Okta SCIM provisioning for Dagster+
...
4. Click the **Sign On** tab and complete the following:
   ...
   3. In the **Credential Details** section, set the **Application username format** field to **Email**:
      ...
      <Image
      alt="Configured Sign On tab of Dagster+ Okta application"
...
5. Click the **Provisioning** tab and complete the following:
   ...
   3. In the **API Token** field, paste the Dagster+ API token you generated in [Step 1](#step-1-enable-scim-provisioning-in-dagster-cloud):

      <Image
      alt="Configured Provisioning tab of Dagster+ Okta application"
...
<Image
alt="Synced/external user icon next to user in Dagster+ user list"

...
5. After you've downloaded the SAML metadata file, upload it to Dagster+ using the `dagster-plus` CLI:

   ```shell
   dagster-plus organization settings saml upload-identity-provider-metadata <path/to/metadata> \

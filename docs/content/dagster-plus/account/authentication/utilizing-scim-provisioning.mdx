...
In addition to the above user management changes, there are a few things to keep in mind when managing user groups, otherwise known as Dagster Cloud [teams](/dagster-plus/account/managing-users/managing-teams).

...
In the Asset Catalog, Asset Graph, and Global Asset Graph, you can apply filters to show the new and changed assets in the Branch Deployment. This filtering can be useful for understanding which assets will be impacted by code changes and should be tested.

  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <ul>
          <li>
            <strong>Asset materialization</strong> - Failure or success
          </li>
          <li>
            <strong>Asset check</strong> - Error, warn, passed, or failure to
            execute
          </li>
          <li>
        ...
        An asset group or asset key can be provided, which limits notifications
        to fire only if the asset group or asset key matches the materialized
        asset. In the case of checks, notifications will only be sent if the
        asset group/key to which the check is attached matches.
        <br />
        <br />
        <strong>Note:</strong> Asset based alert policies are still experimental

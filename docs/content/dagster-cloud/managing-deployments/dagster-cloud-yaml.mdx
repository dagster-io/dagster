...
>
  <tbody>
    ...
    <tr>
      ...
      <td> Similar to the `workspace.yaml` in open source to define code locations for Dagster Cloud.
      </td>
    </tr>
    <tr>
      <td
...
<ReferenceTable>
  <ReferenceTableItem propertyName="location_name">
    ...
    Use if your dagster code is structured as a package
    <ul>
      <li>
 ...
 <ReferenceTableItem propertyName="working_directory">
   ...
   <ReferenceTableItem propertyName="build.directory">
    The path to the directory in your project that you want to deploy; the default is `.`. If there are subdirectories, you can specify the path to only deploy a specific project directory. 
    <ul>
      <li>
        <strong>Format</strong> - <code>string</code>(path)
      </li>
    ...
    The Docker registry to push your code location to in the registry (Hybrid only)
    <ul>
      <li>

...
A [dagster_cloud.yaml](/dagster-cloud/managing-deployments/dagster-cloud-yaml) can also be used to configure code locations for Dagster Cloud.
...
You can also keep the YAML configuration ([dagster_cloud.yaml reference](/dagster-cloud/managing-deployments/dagster-cloud-yaml)) for your entire workspace in a file and use the `dagster-cloud sync` command to reconcile the workspace config in Dagster Cloud with that local file.

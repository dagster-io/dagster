...
Dagster Cloud supports [sending alerts](/dagster-cloud/managing-deployment/alerts) to Slack channels using a Slack workplace app. Messages will be posted using a `@Dagster Cloud` bot user.

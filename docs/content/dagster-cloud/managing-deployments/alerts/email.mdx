...
1. Create and configure an alert policy. Refer to the [alert policy documentation](/dagster-cloud/managing-deployments/alerts/managing-alerts-in-ui) for more info.

...
If you need help with this integration, [contact Dagster Cloud support](https://dagster.io/contact) by selecting **Contact support** in the contact form's **Request type**.
...
2. Create and configure an alert policy as per the [alert policy documentation](/dagster-cloud/managing-deployments/alerts/managing-alerts-in-ui#creating-alert-policies).

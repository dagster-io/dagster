...
Whether to manage complexity or to divide your work into areas of responsibility, you may want to separate your Dagster code into multiple projects. See [Strategies for code separation](#strategies-for-code-separation) for more information.

If you require isolation between your code execution environments, see [Strategies for execution context isolation](#strategies-for-execution-context-isolation).
...
3. Modify the CI/CD workflow to deploy every code location for this repository.

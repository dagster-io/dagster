...
>
  ...
  <tbody>
    ...
    <tr>
      <td>Agent YAML configuration</td>
      <td>
        Environment variables are defined in the agent's configuration in the
        <code>dagster_cloud.yaml</code> file making them available to your jobs at runtime. 
        As these values are pulled from your user cluster and bypass Dagster Cloud altogether. 

...
<Image
alt="The View in Preview link for a pull request using Branch Deployments"
...
<Image
alt="Clicking the pull request's View in Preview link and opening the branch deployment in Dagster Cloud"

...
2. **Create a private [Amazon Elastic Registry (ECR) repository](https://console.aws.amazon.com/ecr/repositories).** Refer to the [AWS ECR documentation](https://docs.aws.amazon.com/AmazonECR/latest/userguide/repository-create.html) for instructions.
   ...
   ![Highlighted repository URI in the AWS ECR console](/images/dagster-cloud/developing-testing/branch-deployments/aws-ecr-uri.png)
...
3. [**Create an IAM user.**](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html) This user must:
   ...
   ![Highlighted repository URI in the AWS ECR console](/images/dagster-cloud/developing-testing/branch-deployments/aws-iam-user-keys.png)
...
![Configured GitHub Actions secrets for an AWS ECS agent](/images/dagster-cloud/developing-testing/branch-deployments/github-aws-ecr.png)
...
![Required GitHub Actions secrets for a Docker agent](/images/dagster-cloud/developing-testing/branch-deployments/github-dockerhub.png)
...
2. In the list of workflows, locate the latest branch deployment run. For example:
   ...
   ![A successful run for a Branch Deployment Action](/images/dagster-cloud/developing-testing/branch-deployments/github-verify-run.png)
...
![TODO](/images/dagster-cloud/developing-testing/branch-deployments/github-cloud-preview-link.png)

Clicking the link will open a branch deployment - or a preview of the changes - in Dagster Cloud:

![TODO](/images/dagster-cloud/developing-testing/branch-deployments/github-preview-link-click.gif)

### Directly in Dagster Cloud

You can also access branch deployments directly in Dagster Cloud from the **deployment switcher**:

![TODO](/images/dagster-cloud/developing-testing/branch-deployments/dagit-deployment-switcher.png)
...
**If you don't use GitHub for version control or want full control over your setup**, check out the dedicated [Branch deployments with TODO guide](/dagster-cloud/developing-testing/branch-deployments/using-branch-deployments).
...
- **The ability to configure GitHub Actions for your repository**. This isn't required if you used the GitHub app to connect your repository as a [code location](/dagster-cloud/developing-testing/code-locations).

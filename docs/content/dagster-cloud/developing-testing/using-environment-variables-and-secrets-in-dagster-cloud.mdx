...
How you make environment variables accessible to your Dagster code depends on the [deployment type](/dagster-cloud/deployment) you're using:
...
## Making environment variables accessible in Serverless deployments
...
## Making environment variables accessible in Hybrid deployments

...
Refer to the [Managing deployments in Dagster Cloud guide](/dagster-cloud/developing-testing/managing-deployments#configuring-deployment-settings) for info about configuring settings in Dagster Cloud or using the dagster-cloud CLI.
...
The `run_monitoring` settings allow you to define how long Dagster Cloud should wait before failing runs in the deployment.

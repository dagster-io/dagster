...
The only **mandatory** section in the dagster_cloud.yaml file is setting up your code locations. If you have multiple code locations, you will have multiple code locations within a single dagster_cloud.yaml file. Dagster code can be sourced from a package, a python file, or a module, and one of these parameters should be specified for each code location.
...
=======
| `locations.code_source.package_name` |  Use if your dagster code is structured as a package | string (folder name) |
| `locations.code_source.python_file`  | Use if your dagster code is in a single file | string (.py file)    |
>>>>>>> 94859ae6a0 (Update docs/content/dagster-cloud/developing-testing/dagster-cloud-yaml.mdx):docs/content/dagster-cloud/managing-deployments/dagster-cloud-yaml.mdx
| `locations.code_source.module_name`  | Use if your dagster code is in a python module                                            | string (module name) |

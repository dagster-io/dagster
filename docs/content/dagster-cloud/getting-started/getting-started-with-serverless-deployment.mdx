...
We'll walk you through setting up your Dagster Cloud account, TODO, loading your code, launching your first run, and configuring continuous integration.

**Before you get started, note that**:

- Serverless deployment is still in **early access**
...
<details>
	<summary><strong>USING GITHUB</strong></summary>
...
4. After Dagster Cloud is connected, you'll be prompted to either:
   ...
   - **Clone the Dagster Cloud starter project** - This option clones the [dagster-cloud-template](https://github.com/dagster-io/dagster-cloud-template) repository.
...
2. Complete the authentication step, including [creating a user token](/dagster-cloud/account/managing-user-agent-tokens#managing-user-tokens).

3. Run the following to deploy your code to Dagster Cloud:

   ```shell
   dagster-cloud serverless deploy "<PATH_TO_CODE_DIRECTORY>" \
         --location-name "<LOCATION_NAME>" \
         --package-name <PACKAGE_NAME> \
         --url https://<YOUR_DAGSTER_CLOUD_ORG>.dagster.cloud/prod \

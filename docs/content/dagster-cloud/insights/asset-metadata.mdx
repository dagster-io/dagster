...
Once one or more assets are emitting numeric metadata values, you are able to enable viewing them in the Insights UI. Note that it may take up to 24 hours for new metadata types to be reflected in the UI.

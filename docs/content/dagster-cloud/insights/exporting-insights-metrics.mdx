...
In this example, we're using the [GraphQL Python Client](/concepts/graphql/graphql-client) to export the Dagster credits metric for all assets for September 2023:

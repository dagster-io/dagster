...
- **Updates to users' emails and names must be completed in the IdP.** When these attributes are changed in the IdP, they'll automatically be synced to Dagster Cloud. You'll still be able to change user permissions in Dagster Cloud, however.

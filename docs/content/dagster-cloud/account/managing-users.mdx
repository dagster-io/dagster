...
After the user is created, you can [add the user to teams and assign user roles for each deployment](#managing-users).
...
<Note>This is a Dagster Cloud Enterprise feature.</Note>

Using the **Teams** field, you can add users to one or more teams. This is useful for centralizing permission sets for different types of users. Refer to the [Managing user teams](/dagster-cloud/account/managing-users/managing-user-teams) guide for more info about creating and managing teams.
...
**Note**: When determining a user's final level of access, team user roles and individual user roles are taken into account. Dagster Cloud will use the most permissive role for the deployment or code location when determining the level of access. Refer to the [Managing user roles and permissions](/dagster-cloud/account/managing-users/managing-user-roles-permissions) guide for more info.
...
4. **Enterprise only**: To set permissions for individual [code locations](/dagster-cloud/account/managing-users/managing-user-roles-permissions#code-location-permissions) in a deployment:
   ...
   4. Click **Save**.
5. Repeat step 2 for each deployment.

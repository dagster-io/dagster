...
- **If using an Identity Provider (IdP) like Okta for SSO**, users must be assigned to the Dagster app in the IdP to be able to log in to Dagster Cloud. Refer to the [SSO setup guides](/dagster-cloud/account/authentication#sso) for setup instructions for each of our supported IdP solutions.

...
<ReferenceTable>
  ...
  How long (in seconds) to poll against ECS API endpoints. If your runs take an unusually long time to start and result in timeouts, you can increase this setting above the default.
  <ul>

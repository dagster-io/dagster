...
- **Enable Branch Deployments**: Whether to have this agent serve your ephemeral [Branch deployments](/dagster-cloud/managing-deployments/branch-deployments). Only a single agent should have this setting enabled.
...
src="/images/dagster-cloud/agents/aws-ecs-stack-wizard-new.png"
width={970}
height={794}
/>

...
<ReferenceTable>
	...
	propertyDescription="The name of the Dagster Cloud deployment associated with the agent."
	>
	</ReferenceTableItem>
</ReferenceTable>
...
<ReferenceTable>
	...
	propertyDescription='The name of an <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/create_cluster.html" target="_blank">ECS cluster</a> with a <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/cluster-capacity-providers.html" target="_blank">Fargate capacity provider</a>.'
	>
	</ReferenceTableItem>
	<ReferenceTableItem
	propertyName="config.subnets"
	propertyDescription='<strong>At least one subnet is required</strong>. <a href="https://docs.aws.amazon.com/AmazonECS/latest/userguide/fargate-task-networking.html" target="_blank">Fargate tasks</a> require a route to the internet so they can pull images. How this requirement is satisfied depends on the type of subnet provided:
   ...
   <ul>
	...
	propertyDescription="The name of a <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-privatednsnamespace.html" target="_blank">private DNS namespace</a>.
   ...
   <p>
	...
	propertyDescription="The name of a CloudWatch <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/Working-with-log-groups-and-streams.html#Create-Log-Group" target="_blank">log group</a>."
	>
	</ReferenceTableItem>
</ReferenceTable>

...
- **Dagster credits**: Dagster credit cost associated with computing this object. Dagster credits are charged for every step that is run, and for every asset that is materialized. For more information, [see the pricing FAQ](https://dagster.io/pricing#faq).

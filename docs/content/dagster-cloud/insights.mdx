...
External metrics, such as Snowflake credits, can be integrated into Dagster Insights. Refer to the [Integrating external metrics into Dagster Cloud guide](/dagster-cloud/insights/external-metrics) for details.

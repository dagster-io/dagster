...
You'll also be asked to create a Dagster Cloud organization. When your organization is created, a single deployment, named `prod`, will also be created. Refer to the [Managing deployments guide](/dagster-cloud/developing-testing/managing-deployments) for more information about deployments in Dagster Cloud.

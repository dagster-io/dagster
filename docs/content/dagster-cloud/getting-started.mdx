...
Once you're up and running with a Serverless or Hybrid deployment, the next step is (probably) setting up connections in your Dagster code. Check out the [Environment variables and secrets in Dagster Cloud guide](/dagster-cloud/developing-testing/environment-variables-and-secrets) to learn how to use environment variables to securely pass secrets in Dagster.

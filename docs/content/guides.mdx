...
- [Integrating Dagster Pipes with Databricks](/guides/dagster-pipes/integrating-databricks-with-dagster-pipes) - Learn to integrate external Databricks code into Dagster with Dagster Pipes

- [Integrating Dagster Pipes with Docker](/guides/dagster-pipes/integrating-docker-with-dagster-pipes) - Learn to integrate external Docker code into Dagster with Dagster Pipes

- [Integrating Dagster Pipes with Kubernetes](/guides/dagster-pipes/integrating-kubernetes-with-dagster-pipes) Learn to integrate external Kubernetes code into Dagster with Dagster Pipes

- [Understanding the Dagster Pipes process](/guides/dagster-pipes/understanding-dagster-pipes) - A detailed guide describing how communication process between Dagster Pipes and external environments

- [Customizing Dagster Pipes protocols](/guides/dagster-pipes/customizing-dagster-pipes-protocols) - Learn to customize how context is sent to external environments, and how metadata and logs are sent back to Dagster

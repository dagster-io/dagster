...
- [Testing Against Production with Dagster Cloud Branch Deployments](/guides/dagster/branch_deployments) - This guide illustrates a workflow that enables testing Dagster code in your cloud environment without impacting your production data

- [Fully Featured Example with Recommended Project Layout](/guides/dagster/example_project) - A walkthrough of a fully featured example project that uses many of Dagster's features, with project structure recommendations

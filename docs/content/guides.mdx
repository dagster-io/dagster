...
- [Fully-featured example with recommended project layout](/guides/dagster/example_project) - A look at an example project that demonstrates many of Dagster's features, using our layout recommendations

...
Let's go back to our first solid and pipeline in [`hello_cereal.py`](/tutorial/intro-tutorial/single-solid-pipeline#executing-our-first-pipeline)
...
framework as we learn about it. You can learn more about Testing in Dagster by reading the [Testing](/concepts/solids-pipelines/testing) page.

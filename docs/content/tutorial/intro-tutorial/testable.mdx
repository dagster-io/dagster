...
Let's go back to the `diamond` job we wrote in the [prior section](/tutorial/intro-tutorial/connecting-solids#a-more-complex-dag), and ensure that it's working as expected by writing some unit tests.

...
Let's go back to the assets we defined in the [prior section](/tutorial/intro-tutorial/assets/asset-graph#a-more-complex-asset-graph), and ensure that they work as expected by writing some unit tests.
...
- **Non-asset jobs** - This tutorial assumed that your only goal was producing assets. You can also build and run arbitrary [jobs](/concepts/ops-jobs-graphs/jobs-graphs), on top of the same [op](/concepts/ops-jobs-graphs/ops) and [graph](/concepts/ops-jobs-graphs/jobs-graphs) abstractions that underlie assets.

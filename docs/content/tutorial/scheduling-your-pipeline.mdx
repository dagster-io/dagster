...
1. Going to the Dagster UI
2. Reloading your project through **Reload Definitions** button in the asset graph or the **Deployment** page
...
Managing one type of definition, such as assets, is easy. However, it can quickly become unruly as your project grows to have a variety of definitions (ex. schedules, jobs, sensors, etc.). To combine all definitions, Dagster provides a utility called the object. To combine definitions and have them aware of each other, Dagster provides a utility called the <PyObject object="Definitions" /> object.

...
```python file=/guides/dagster/asset_tutorial/serial_asset_graph.py dagimage=images/asset-screenshots/guides/dagster/asset_tutorial/serial_asset_graph.svg
import csv
...
```python file=/guides/dagster/asset_tutorial/complex_asset_graph.py dagimage=images/asset-screenshots/guides/dagster/asset_tutorial/complex_asset_graph.svg
import csv

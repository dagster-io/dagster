...
```bash
dagster dev -f serial_asset_graph.py
```

Navigate to <http://127.0.0.1:3000>:

<!-- ![Serial asset graph in Dagit](/images/guides/asset-tutorial/serial_asset_graph.png) -->

<Image
alt="Serial asset graph in Dagit"
...
<!-- ![Complex asset graph](/images/guides/asset-tutorial/complex_asset_graph.png) -->

...
- Add the test to the bottom of the `complex_asset_graph.py` file and **remove** the `from` statement in the following code
- Create a new file and uncomment the `from` statement in the following code

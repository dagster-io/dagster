...
```python file=/guides/dagster/asset_tutorial/cereal.py startafter=start_asset_marker endbefore=end_asset_marker function=asset_marker dagimage=images/asset-screenshots/guides/dagster/asset_tutorial/cereal/asset_marker.svg
import csv
import requests

...
For more information, refer to the [Resources](/concepts/resources) documentation.
...
Functions decorated with <PyObject object="asset_check" decorator /> can be directly invoked. For example:

```python file=/concepts/assets/asset_checks/test_asset_check.py startafter=start endbefore=end
import pandas as pd
...
| <PyObject object="materialize_to_memory"  />                       | Ephemerally materializes a provided list of assets for testing.                                                                       |

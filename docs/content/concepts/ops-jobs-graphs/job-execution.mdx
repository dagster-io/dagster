...
The Launchpad also offers a configuration editor to let you interactively build up the configuration. Refer to the [Dagster UI documentation](/concepts/dagster-ui#launchpad-tab) for more info.

...
<Note>
    This guide is applicable to both <a href="/concepts/ops-jobs-graphs/jobs">op</a> and <a href="/concepts/assets/asset-jobs">asset</a> jobs.
</Note>

Dagster provides several methods to execute [op](/concepts/ops-jobs-graphs/jobs) and [asset jobs](/concepts/assets/asset-jobs). This guide explains different ways to do one-off execution of jobs using the [Dagster UI](#dagster-ui), [command line](#command-line), or [Python APIs](#python-apis).

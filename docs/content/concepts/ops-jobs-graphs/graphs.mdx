...
- [**To back assets**](/concepts/assets/software-defined-assets#graph-backed-assets) - Basic software-defined assets are computed using a single op, but if computing one of your assets requires multiple discrete steps, you can compute it using a graph instead.
- [**Directly inside a job**](/concepts/ops-jobs-graphs/jobs) - Each non-asset job contains a graph.
...
- [Directly inside jobs](#directly-inside-jobs)

...
Dagster provides a way to create a sensor that reacts to job failure events. You can find details at [Job failure sensor](/concepts/partitions-schedules-sensors/sensors#run-failure-sensor) on the [Sensors](/concepts/partitions-schedules-sensors/sensors) page.

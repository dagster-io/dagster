...
The computational core of a [software-defined assets](/concepts/assets/software-defined-assets) is an op. Collections of ops can also be assembled to create a [graph](/concepts/ops-jobs-graphs/graphs).

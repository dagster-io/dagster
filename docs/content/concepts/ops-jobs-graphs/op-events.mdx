...
To learn more about assets and how they are surfaced once you send this event, check out the [Asset Catalog](/concepts/dagster-ui#assets) documentation.
...
In the example above, an observation tracks the number of rows in an asset persisted to storage. This information can then be viewed on the [Asset Details](/concepts/dagster-ui#asset-details) page.

...
- [Building a job that targets all the assets in a group](https://github.com/dagster-io/dagster/blob/master/examples/hacker_news_assets/hacker_news_assets/recommender/\__init\_\_.py)

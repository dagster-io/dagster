...
- In [the Dagster UI](/concepts/webserver/ui). The UI centers on jobs, making it a one-stop-shop - you can manually kick off runs for a job and view all historical runs.

...
<Note>
  Looking to materialize a selection of{" "}
  <a href="/concepts/assets/software-defined-assets">Software-defined Assets</a>?
  Check out
  <a href="/concepts/assets/asset-jobs">Asset jobs</a>.
</Note>

Jobs are the main unit of execution and monitoring in Dagster. An op job executes a [graph](/concepts/ops-jobs-graphs/graphs) of [ops](/concepts/ops-jobs-graphs/ops).
...
Refer to the [Partition documentation](/concepts/partitions-schedules-sensors/partitions) for more info and examples.

...
Metadata allows you to attach information to [op jobs](/concepts/op-jobs-graphs/op-jobs) and the runs launched from those jobs. By the end of this guide, you'll understand what metadata is, how to attach it to an op job, and how to view the job metadata in the Dagster UI.
...
Tags can also be used to attach information to jobs. Refer to the [Using tags](/guides/using-tags) guide for more information.

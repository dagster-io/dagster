...
Jobs can also contain [resources](/concepts/resources) and [configuration](/concepts/configuration/config-schema), which determine some of the behavior of those ops.
...
Ready to start running your jobs? Refer to the [Job execution guide](/concepts/ops-jobs-graphs/job-execution) for more info and examples.

...
<Note>
  ...
  ? Check out <a href="/concepts/assets/asset-jobs">Asset jobs</a>.
</Note>
...
Refer to the [Partition documentation](/concepts/partitions-schedules-sensors/partitions#partitioned-op-jobs) for more info and examples.

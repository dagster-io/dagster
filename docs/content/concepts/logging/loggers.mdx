...
| <PyObject module="dagster" object="ModeDefinition" /> | Modes allow you to vary pipeline behavior between different deployment environments. For more info, see the [Modes](/concepts/modes-resources/modes) section |

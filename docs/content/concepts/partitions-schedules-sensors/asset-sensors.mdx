...
- It is not up to date with respect to its FreshnessPolicy (see [Freshness-based scheduling](/concepts/partitions-schedules-sensors/asset-sensors#freshness-based-scheduling-)).

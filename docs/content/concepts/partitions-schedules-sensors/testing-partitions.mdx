...
- [Partitioned ops and jobs](/concepts/partitions-schedules-sensors/partitioned-ops) (Optional; Advanced)
...
<ArticleList>
  ...
  ></ArticleListItem>
  <ArticleListItem
    href="/concepts/partitions-schedules-sensors/partitioned-ops"

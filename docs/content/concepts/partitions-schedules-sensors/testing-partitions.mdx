...
- [Partitioned assets](/concepts/partitions-schedules-sensors/partitioned-assets)
- [Partitioned ops and jobs](/concepts/partitions-schedules-sensors/partitioned-op-jobs) (Optional; Advanced)
...
<ArticleList>
  ...
  ></ArticleListItem>
  <ArticleListItem
    href="/concepts/partitions-schedules-sensors/partitioned-assets"
    title="Partitioned assets"
  ></ArticleListItem>
  <ArticleListItem
    href="/concepts/partitions-schedules-sensors/partitioned-op-jobs"

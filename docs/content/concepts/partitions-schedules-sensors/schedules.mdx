...
| Name                                                      | Description                                                                                                   |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| <PyObject object="config_based_schedule" decorator />     | Decorator that defines a schedule that executes runs on a given cron schedule, using the provided run config. |
| <PyObject object="request_based_schedule" decorator />    | Decorator that defines a schedule that executes runs on a given cron schedule, using `RunRequest` objects.    |
| <PyObject object="schedule" decorator />                  | Decorator that is an alias of `config_based_schedule` .                                                       |

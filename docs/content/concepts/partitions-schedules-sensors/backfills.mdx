...
Backfills can also be launched for a selection of differently partitioned assets, as long as the roots share the same partitioning. You can select assets to materialize from the lineage tab of your asset group.

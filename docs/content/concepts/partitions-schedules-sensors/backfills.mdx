...
After defining a [Partition Set](/concepts/partitions-schedules-sensors/partitions#defining-a-partition-set),
...
the [Partitions tab](/concepts/partitions-schedules-sensors/partitions#the-partitions-tab).

...
Once you have created your partition selector, you can manually create a schedule using the `create_schedule_definition` method on your <PyObject object="PartitionSetDefinition" />.

...
```python file=/concepts/partitions_schedules_sensors/sensors/sensor_alert.py startafter=start_run_status_sensor_testing_with_context endbefore=end_run_status_sensor_testing_with_context
@op
def succeeds():
    return 1
...
```python file=/concepts/partitions_schedules_sensors/sensors/sensor_alert.py startafter=start_alert_sensor_testing_with_context_setup endbefore=end_run_status_sensor_testing_with_context_setup
from dagster import op, job
...
```python file=/concepts/partitions_schedules_sensors/sensors/sensor_alert.py startafter=start_alert_sensor_testing_with_context endbefore=end_alert_sensor_testing_with_context
from dagster import op, job

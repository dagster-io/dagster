...
@run_status_sensor(
    monitored_jobs=[RepositorySelector(location_name="repository.location", repository_name="team_a_repository")],
    run_status=DagsterRunStatus.SUCCESS,
)
...
@run_failure_sensor(
    monitored_jobs=[JobSelector(location_name="repository.location", repository_name="team_a_repository", job_name="data_update")],
    run_status=DagsterRunStatus.SUCCESS,
)

...
```python file=concepts/partitions_schedules_sensors/sensors/sensors.py startafter=start_run_status_sensor_testing_with_context endbefore=end_run_status_sensor_testing_with_context
...
```
You could provide the `context` argument like this
```python file=concepts/partitions_schedules_sensors/sensors/sensors.py startafter=start_alert_sensor_testing_with_context endbefore=end_alert_sensor_testing_with_context
from dagster import build_run_status_sensor_context

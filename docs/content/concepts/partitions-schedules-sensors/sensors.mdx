...
```python file=/concepts/partitions_schedules_sensors/sensors/sensors.py startafter=start_asset_status_sensor_marker endbefore=end_asset_status_sensor_marker
@asset_status_sensor(
...
```python file=/concepts/partitions_schedules_sensors/sensors/sensors.py startafter=start_asset_status_sensor_or_marker endbefore=end_asset_status_sensor_or_marker
@asset_status_sensor(

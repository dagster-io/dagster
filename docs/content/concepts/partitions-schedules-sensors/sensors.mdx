...
- Materializing a weekly asset when any upstream daily partitions are materialized or replaced
- Materializing a daily partition only if both upstream daily partitions are materialized
...
### Multi-asset sensor examples with partitions

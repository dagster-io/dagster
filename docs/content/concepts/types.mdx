...
For more examples of the dagster type system, check out our [Type and Metadata example](https://github.com/dagster-io/dagster/tree/master/examples/assets_type_metadata)

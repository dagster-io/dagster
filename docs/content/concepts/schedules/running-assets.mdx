---
title: "Running assets on a schedule | Dagster Docs"
description: ""
---

# Running assets on a schedule

In this guide, we'll walk you through defining a schedule for [Software-defined Assets](/concepts/assets/software-defined-assets). If you're looking to do this for ops, refer to the [Defining schedules for ops guide](/concepts/schedules/running-ops).
...
Let's assume we already have a few assets in our project, in a group named `ecommerce_assets`. To create a job that materializes the assets in this group, we'll use <PyObject object="define_asset_job" />.

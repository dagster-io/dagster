...
After creating some [Software-defined Assets](/concepts/assets/software-defined-assets), you'll may want to automate their materialization.
...
To create a schedule, start by building a job that materializes assets. Let's assume we already have a few assets in our project in a group named `ecommerce_assets`:
...
2. Constructed the job using <PyObject object="define_asset_job" /> and name it `ecommerce_asset_job`

...
A repository is a collection of assets, jobs, schedules, and sensor definitions. Repositories are loaded as a unit by the Dagster CLI, Dagit and the Dagster Daemon.
...
- Includes various definitions: [Assets](/concepts/assets/software-defined-assets), [Jobs](/concepts/ops-jobs-graphs/jobs-graphs), [Schedules](/concepts/partitions-schedules-sensors/schedules), and [Sensors](/concepts/partitions-schedules-sensors/sensors).

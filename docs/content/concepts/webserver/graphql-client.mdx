...
Dagster provides a GraphQL Python Client to interface with <Link href="/concepts/webserver/graphql">Dagster's GraphQL API</Link> from Python.

## Relevant APIs

| Name                                                                    | Description                                                          |
| ----------------------------------------------------------------------- | -------------------------------------------------------------------- |
| <PyObject module="dagster_graphql" object="DagsterGraphQLClient"/>      | The client class to interact with Dagster's GraphQL API from Python. |
...
If you are using Dagster Cloud, you can configure your client against the Dagster Cloud API by passing your deployment-specific URL and a User Token to the client as follows:

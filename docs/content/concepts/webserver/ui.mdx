...
- **Description**: The **Asset catalog** page lists all [assets](/concepts/assets/software-defined-assets) in your Dagster deployment, which can be filtered by asset key and/or [asset group](/concepts/assets/software-defined-assets#grouping-assets). Clicking an asset opens the [**Asset details** page](#asset-details) for that asset. You can also navigate to the [Global asset lineage](#global-asset-lineage) page, reload definitions, and materialize assets.
  ...
  **If using Dagster Cloud Pro**, you have the option to use a new version of this page. Click the **Asset catalog (Cloud Pro)** tab for more information.
...
- **Description**: The **Asset details** page contains details about a single asset. Use the tabs on this page to view detailed information about the asset:
  ...
  - **Overview** - Information about the asset such as its description, resources, config, type, etc. If you have the **Use new asset overview page** [user setting](/concepts/webserver/ui-user-settings) enabled, this tab will display instead of **Definition**.
  ...
  - **Plots** - Any plots associated with the asset
  - **Definition** - The same information as the **Overview** tab. This tab will display if the **Use new asset overview page** user setting isn't enabled.
  ...
  - **Insights** - **Cloud only.** Historical information about the asset, such as failures and credit usage. Refer to the [Dagster Cloud Insights](/dagster-plus/insights) documentation for more information.
...
- **Description**: The **Agents** tab contains information about the agents in a Dagster Cloud deployment. Refer to the [Dagster Cloud agent documentation](/dagster-plus/deployment/agents) for more info.
...
- **Description**: The **Agents** tab contains information about the environment variables configured in a Dagster Cloud deployment. Refer to the [Dagster Cloud environment variables and secrets documentation](/dagster-plus/managing-deployments/environment-variables-and-secrets) for more info.
...
- **Description**: The **Alerts** tab contains information about the alert policies configured for a Dagster Cloud deployment. Refer to the [Dagster Cloud alerts guide](/dagster-plus/managing-deployments/alerts) for more info.

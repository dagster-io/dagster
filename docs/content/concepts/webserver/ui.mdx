...
- **Description**: The **Asset details** page contains details about a single asset. Use the tabs on this page to view detailed information about the asset:
  ...
  - **Insights** - **Cloud only.** Historical information about the asset, such as failures and credit usage. Refer to the [Dagster Cloud Insights](/dagster-cloud/insights) documentation for more information.

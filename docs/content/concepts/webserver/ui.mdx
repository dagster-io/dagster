...
- **Accessed by**: Clicking the **Configuration tab** in the [**Resource details**](#resource-details) page
...
- **Accessed by**: Clicking the **Uses tab** in the [**Resource details**](#resource-details) page
...
- **Description**: The **Jobs** page lists all [jobs](/concepts/ops-jobs-graphs/jobs) defined in your Dagster deployment across all code locations. It also includes information about the job's schedule or sensor, its latest run time, and its history. Click a job to open the [**Job details**](#job-details) page.
...
<!-- ![UI Job Definition](/images/concepts/webserver/jobs-overview-tab.png) -->

<Image
alt="UI Job Definition"
src="/images/concepts/webserver/jobs-overview-tab.png"
width={3066}
height={1628}
/>
...
- **Description**: The **Launchpad tab** provides a configuration editor to let you experiment with configuration and launch runs. **Note**: This tab will display only if the job requires config.

- **Accessed by:** Clicking the **Launchpad** tab in the [**Job details**](#job-details) page

<!-- ![UI Launchpad](/images/concepts/webserver/job-launchpad-tab.png) -->

<Image
alt="UI Launchpad"
src="/images/concepts/webserver/job-launchpad-tab.png"
width={1920}
height={1025}
/>
...
- **Accessed by:** Clicking the **Runs** tab in the [**Job details**](#job-details) page
...
- **Accessed by:** Clicking the **Partitions** tab in the [**Job details**](#job-details) page
...
- **Accessed by**:
  ...
  - Clicking the **Code locations** tab in the **Deployment overview** page
...
- **Accessed by**: Clicking the **Daemons** tab in the [**Deployment overview**](#code-locations-tab) page
...
- **Accessed by**: Clicking the **Configuration** tab in the [**Deployment overview**](#code-locations-tab) page
...
- **Accessed by**: Clicking the **Agents** tab in the [**Deployment overview**](#code-locations-tab) page
...
- **Accessed by**: Clicking the **Environment variables** tab in the [**Deployment overview**](#code-locations-tab) page
...
- **Accessed by**: Clicking the **Alerts** tab in the [**Deployment overview**](#code-locations-tab) page

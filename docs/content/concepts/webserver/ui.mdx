...
- **Accessed by:** Clicking the **Launchpad** tab tab in the [**Job details**](#job-details) page
...
- **Accessed by**: Clicking the **Environmental variables** tab in the [**Deployment overview**](#code-locations-tab) page

...
from dagster import asset, with_resources, repository
...
from dagster import asset, fs_io_manager, with_resources, repository
...
## Recording metadata from an IO Manager <Experimental />

...
ENOENT: no such file or directory, open '/Users/jamie/dev/dagster/examples/docs_snippets/docs_snippets/tutorial/saving/no_io_assets_examples.py'
```
...
For a full list of Dagster-provided I/O managers, refer to the [built-in I/O managers list](#built-in-io-managers).

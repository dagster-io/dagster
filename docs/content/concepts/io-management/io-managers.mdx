...
For more examples of IO Managers, check out the following in our [Hacker News example](https://github.com/dagster-io/dagster/tree/master/examples/hacker_news_assets):

- [Snowflake IO Manager](https://github.com/dagster-io/dagster/blob/master/examples/hacker_news_assets/hacker_news_assets/resources/snowflake_io_manager.py)
- [Parquet IO Manager](https://github.com/dagster-io/dagster/blob/master/examples/hacker_news_assets/hacker_news_assets/resources/parquet_io_manager.py)
- [S3 IO Manager with custom bucket](https://github.com/dagster-io/dagster/blob/master/examples/hacker_news_assets/hacker_news_assets/resources/common_bucket_s3\_pickle_io_manager.py)

Our [Type and Metadata example](https://github.com/dagster-io/dagster/tree/master/examples/assets_type_metadata) also covers writing custom IO managers.

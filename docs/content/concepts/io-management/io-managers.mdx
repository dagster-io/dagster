...
| <PyObject module="dagster_gcp_pandas" object="bigquery_pandas_io_manager" /> | Stores Pandas DataFrame outputs in Google Cloud Platform BigQuery. | [Tutorial](/integrations/bigquery/using-biguqery-with-dagster), [Reference Guide](/integrations/bigquery/reference) |
| <PyObject module="dagster_gcp_pyspark" object="bigquery_pyspark_io_manager" /> | Stores PySpark DataFrame outputs in Google Cloud Platform BigQuery. | [Tutorial](/integrations/bigquery/using-biguqery-with-dagster), [Reference Guide](/integrations/bigquery/reference) |

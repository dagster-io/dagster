...
<p align="center">
  <img src="/images/concepts/io-managers-main-diagram.png" />
</p>
...
<PyObject module="dagster" object="IOManager" pluralize /> are user-provided objects that
...
and outputs.  The green inputs and outputs use the green IO manager, and the yellow inputs and
outputs use the yellow IO manager.

<img src="/images/concepts/two-io-managers.png" />

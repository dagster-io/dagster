...
Dagster also provides a Python client to interface with Dagster's GraphQL API from Python. Refer to the <Link href="/concepts/graphql/graphql-client">GraphQL Python client docs</Link> for more info.

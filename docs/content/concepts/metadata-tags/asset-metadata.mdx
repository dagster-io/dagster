...
| ----------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dagster/uri`                 | `str`                                             | The URI for the asset, e.g. `"s3://my_bucket/my_object"`.                                                                                                                                                                                                      |
| `dagster/column_schema`       | <PyObject object="TableSchema" />                 | For an asset that's a table, the schema of the columns in the table. See the [table metadata page](/concepts/metadata-tags/asset-metadata/table-metadata#attaching-column-schema) for details.                                                                 |
| `dagster/column_lineage`      | <PyObject object="TableColumnLineage" />          | For an asset that's a table, the lineage of column inputs to column outputs for the table. See the [column lineage page](/concepts/metadata-tags/asset-metadata/column-level-lineage) for details.                                                             |
| `dagster/row_count`           | `int`                                             | For an asset that's a table, the number of rows in the table. See the [table metadata page](/concepts/metadata-tags/asset-metadata/table-metadata#attaching-row-count) for details.                                                                            |
| `dagster/partition_row_count` | `int`                                             | For a partition of an asset that's a table, the number of rows in the partition.                                                                                                                                                                               |
| `dagster/relation_identifier` | `str`                                             | A unique identifier for the table/view, typically fully qualified. For example, `my_database.my_schema.my_table`.                                                                                                                                              |
| `dagster/code_references`     | <PyObject object="CodeReferencesMetadataValue" /> | A list of code references for the asset, such as file locations or references to Github URLs. See the [code references guide](/guides/dagster/code-references) for details. Should only be provided in definition-leel metadata, not materialization metadata. |

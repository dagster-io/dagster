...
Tags are useful for organizing assets non-hierarchical ways. Unlike [asset groups](/concepts/assets/software-defined-assets#grouping-assets), where each asset belongs to a single group, each asset can have many tags. For example:

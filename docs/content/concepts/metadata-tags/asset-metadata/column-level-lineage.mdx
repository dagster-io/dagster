...
3. For each column, use <PyObject object="TableColumnDep" /> to define the column's lineage. This object accepts `asset_key` and `column_name` arguments, allow you to specify the name of the asset and column that make up the dependency.

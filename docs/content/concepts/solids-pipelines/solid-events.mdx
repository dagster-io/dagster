...
ENOENT: no such file or directory, open '/Users/christopherdecarolis/dagster/examples/docs_snippets/docs_snippets/concepts/assets/materialization_solids.py'
```

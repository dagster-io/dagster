...
- Guard against inaccurate and stale data by [checking for quality and freshness](/concepts/assets/asset-checks/define-execute-asset-checks)
- [Execute checks](/concepts/assets/asset-checks/define-execute-asset-checks#executing-checks) using the Dagster UI or schedules/sensors that run jobs with assets and checks
- Use severity levels and metadata [to include actionable details about check results in the UI](/concepts/assets/asset-checks/define-execute-asset-checks#using-asset-check-results)

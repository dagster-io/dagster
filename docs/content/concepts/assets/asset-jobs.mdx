...
<Note>
  ...
  <a href="/concepts/ops-jobs-graphs/op-jobs">Op jobs</a> page.
</Note>
...
```python file=/concepts/assets/build_job.py startafter=start_code_location_marker endbefore=end_code_location_marker
from dagster import Definitions, asset, define_asset_job

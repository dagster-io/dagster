...
- In the [Modern Data Stack example](https://github.com/dagster-io/dagster/tree/master/examples/assets_modern_data_stack):
  ...
  - [Loading assets from dbt](https://github.com/dagster-io/dagster/blob/master/examples/assets_modern_data_stack/assets_modern_data_stack/dbt.py)
  - [Loading assets from Airbyte](https://github.com/dagster-io/dagster/blob/master/examples/assets_modern_data_stack/assets_modern_data_stack/airbyte.py)

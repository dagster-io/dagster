...
```python file=/concepts/assets/cross_code_location_asset.py startafter=start_code_location_1 endbefore=end_code_location_1
# code_location_1.py
...
```python file=/concepts/assets/cross_code_location_asset.py startafter=start_code_location_2 endbefore=end_code_location_2
# code_location_2.py
...
- Navigating to the graph view of the [**Asset atalog** page](#asset-catalog) and clicking the **Materialize** button in the upper right corner. You can also click on individual assets to collect a subset to materialize.

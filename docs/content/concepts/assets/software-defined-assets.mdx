...
Since a function decorated with <PyObject object="asset" /> acts as the op for a software defined asset. You can write unit tests for this function in the same way you would a standard [op](/concepts/testing#testing-ops).
...
If you use a context object in your function, you can mock it with <PyObject object="build_op_context" />

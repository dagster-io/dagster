...
<PyObject object="Definitions" /> objects define code locations, which are collections
of assets, jobs, resources, and schedules. Refer to the [Code locations documentation](/concepts/code-locations)
for more info.

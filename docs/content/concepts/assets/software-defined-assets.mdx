...
```python file=/concepts/assets/explicit_asset_dependency.py startafter=start_string_example endbefore=end_string_example
@asset
def upstream_asset():
    return [1, 2, 3]
...
```python file=/concepts/assets/explicit_asset_dependency.py startafter=start_explicit_asset_key_example endbefore=end_explicit_asset_key_example
@asset
def upstream_asset():
    return [1, 2, 3]

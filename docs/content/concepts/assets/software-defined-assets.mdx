...
If you want the UI to show both assets and [jobs](/concepts/ops-jobs-graphs/asset-jobs) that target the assets, you can place the assets and jobs together inside a <PyObject object="Definitions" /> object. For example:

...
- [Graph-backed assets](/concepts/assets/graph-backed-assets) allow you to split the computation for an asset into multiple discrete functions in order to enable parallelization and launch re-executions of the functions.

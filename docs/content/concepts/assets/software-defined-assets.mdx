...
The [examples section](#advanced-subsetting-a-graph-backed-asset) below features an example of how a subset of assets defined in a graph-backed asset can be selected for execution.
...
### Advanced: Subsetting a graph-backed asset
...
my_repo.get_job("graph_asset").execute_in_process(asset_selection=[AssetKey("baz_asset")])
```

...
Clicking on "Assets", in the right section of Dagit's top navigation pane, takes you to the Assets page, which shows a list of all your assets.
...
You can view a graph of all the assets with their dependencies by clicking the graph icon to the upper-left of the Assets page, or by clicking "View in Graph" on any of the assets.
...
- In the graph view of the Assets page, click the "Materialize" button in the upper right corner. You can click on assets to collect a subset to materialize.

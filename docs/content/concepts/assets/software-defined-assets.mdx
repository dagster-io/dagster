...
- [Graph-Backed Assets](/concepts/assets/graph-backed-assets): A specific type of multi-asset whose computations are separated into multiple [ops](/concepts/ops-jobs-graphs/ops) that are combined to build a [graph](/concepts/ops-jobs-graphs/graphs).

...
In this section, we'll walk you through the various ways you can define assets in Dagster:

- [A basic software-defined asset](#a-basic-software-defined-asset)
- [Assets with dependencies](#assets-with-dependencies)
- [Using graphs](#graph-backed-assets)
- [Using multi-assets](#multi-assets)
- [Assets that use context](#asset-context)
- [Assets that use configuration](#asset-configuration)
...
A multi-asset is a set of assets that are updated by the same operation. Multi-assets can be useful when it's inconvenient or impossible to map each persisted asset to a unique operation. Refer to the [Multi-assets documentation](/concepts/assets/multi-assets) for more info and examples.

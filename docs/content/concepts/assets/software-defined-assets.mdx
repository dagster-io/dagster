...
Software-defined assets can depend on other software-defined assets. In Dagster, you can either define dependencies that just specify materialization order, or you can define dependencies that also load the contents of the upstream asset. You can also define dependencies on external assets.

In this section, we'll show you how to define:

- [Basic asset dependencies](#defining-basic-dependencies)
- [Basic data-loading asset dependencies](#defining-explicit-dependencies)
- [Explicit data-loading asset dependencies](#defining-explicit-dependencies)
...
In this example, `upstream_asset` creates a new table (`sugary_cereals`) by selecting records from the `cereals` table. Then `downstream_asset` creates a new table (`shopping_list`) by selecting records from `sugary_cereals`
...
#### Defining basic data-loading dependencies

The easiest way to define an asset dependency that will load the contents of an upstream asset is to include the upstream asset name as an argument to the decorated function.
...
#### Defining explicit data-loading dependencies
...
You can also define dependencies on `SourceAsset`s that will load the data of the asset:

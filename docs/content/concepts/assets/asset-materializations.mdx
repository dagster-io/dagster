...
The [Asset Catalog](/concepts/dagit/dagit#assets) shows all assets that have been materialized and allows you to wipe the asset or view other details about the asset.

<!-- Reusing image linked from dagit.mdx -->

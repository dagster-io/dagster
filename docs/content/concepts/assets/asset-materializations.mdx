...
In most cases, you should be able to work with assets using <PyObject object="asset" decorator />, but there may be situations where you want to create an asset in the body of a <PyObject object="op" decorator />. You can do this using <PyObject object="AssetMaterialization" /> events.
...
In this section we'll go over some differences between software-defined assets and asset materializations and the different use cases for each.
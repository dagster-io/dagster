...
This feature is still in its early stages, but for now, this lineage information is surfaced in the [Assets page](/concepts/dagit/dagit#assets) page for each asset ("Parent assets"):

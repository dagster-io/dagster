...
### Yield syntax for AssetMaterializations

We also support yielding <PyObject object="AssetMaterialization" /> objects from within the body of an op. When using the yield syntax, it is also necessary to yield all Outputs.

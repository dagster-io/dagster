...
This feature is still in its early stages, but for now, this lineage information is surfaced in the [Assets](/concepts/dagit/dagit#assets) page page for each asset ("Parent assets"):

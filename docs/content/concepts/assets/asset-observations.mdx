...
You may wish to record metadata about an asset outside of that asset's materialization function. To do this, you can write another function and log <PyObject object="AssetObservation" /> events. An asset observation is an event that records metadata about a given asset. Unlike asset materializations, asset observations do not signify that an asset has been mutated.

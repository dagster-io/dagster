...
<PyObject module="dagster" object="AssetObservation" /> events are used to communicate
to Dagster that metadata has been recorded about a given asset. Asset observation
events can be yielded at runtime within ops and assets. An asset must be defined
using the <PyObject object="asset" decorator /> decorator or have existing materializations
in order for its observations to be displayed.

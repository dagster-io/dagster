...
Whether you're using Dagster OSS or Dagster+, you can use a REST endpoint for reporting asset materializations, asset check evaluations, and asset observations. Refer to the [External assets REST API reference](/apidocs/external-assets-rest) for more information and examples.

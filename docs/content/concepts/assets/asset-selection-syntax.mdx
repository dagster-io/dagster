...
- **In the Dagster UI**, in the search box on the [**Global asset lineage** page](/concepts/dagster-ui#global-asset-lineage). The [Examples](#examples) section demonstrates how asset selection queries work in the UI.

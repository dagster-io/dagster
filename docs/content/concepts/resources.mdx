...
<Note>
  ...
  the original asset may result in an "Asset is defined multiple times" error.
  In this case, you may need to place your <code>with_resource</code> call
  within a repository definition.
</Note>

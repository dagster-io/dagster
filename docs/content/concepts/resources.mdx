...
<Note>
  <strong>Heads up!</strong> <a href="/concepts/ops-jobs-graphs/ops">Ops</a> and{" "}
  <a href="/concepts/ops-jobs-graphs/jobs">jobs</a> are considered{" "}
  <strong>Advanced</strong> concepts.
</Note>

...
Resources are objects that are shared across the implementations of multiple [assets](/concepts/assets/software-defined-assets) and [ops](/concepts/ops-jobs-graphs/ops) and that can be plugged in after defining those ops and assets.
...
| <PyObject object="with_resources"/>              | Function for providing resources to assets and source assets.                                                                                                                                                               |
...
Assets use resource keys to access resources:
...
## Providing resources to assets

Resources can be provided to assets using the <PyObject object="with_resources" /> function, which takes in a sequence of assets, and returns transformed versions of those assets with the provided resources specified.

...
Definitions can be included in a Python module like `my_file.py` or a Python package. If using the latter, the <PyObject object="Definitions"/> object should be defined in the package's top-level `__init__.py` file.

...
Similar to [reporting materialization metadata within the Dagster process](/concepts/metadata-tags/asset-metadata), you can also report asset materialization back to Dagster from the external process.
...
<!-- - Learn about [other integrations with Dagster Pipes](/concepts/dagster-pipes#usage) -->

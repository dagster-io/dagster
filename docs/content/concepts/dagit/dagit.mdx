...
This command launches both Dagit and the [Dagster daemon](/deployment/dagster-daemon), allowing you to start a full local deployment of Dagster from the command line.

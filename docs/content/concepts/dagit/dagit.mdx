...
description: Dagit is a web-based interface for Dagster. You can inspect solid and pipeline definitions, launch runs, view launched runs, and view assets.
---
...
![Dagit Pipeline Definition](/images/concepts/dagit/pipeline-definition.png)

### Solid Definition

On the Definition tab, clicking a solid, you can find detailed information about the solid definition.

![Dagit Solid Definition](/images/concepts/dagit/solid-definition.png)
...
![Dagit Playground](/images/concepts/dagit/playground.png)

### Runs Tab

The Runs tab shows the list of recent runs for the pipeline.

![Dagit Pipeline Runs Tab](/images/concepts/dagit/runs-tab.png)
...
![Dagit Pipeline Run](/images/concepts/dagit/single-run.png)
...
![Dagit Re-execution](/images/concepts/dagit/re-execution.png)
...
![Dagit Schedules](/images/concepts/dagit/schedules.png)
...
![Dagit Sensors](/images/concepts/dagit/sensors.png)

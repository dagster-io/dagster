...
You can also build config into jobs, as described in [this section of the Jobs concept page](/concepts/solids-pipelines/pipelines#advanced-job-configuration).

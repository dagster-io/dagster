...
<Note>
  This guide covers using the legacy Dagster config system. For docs on the new
  Pythonic config system introduced in Dagster 1.3, see the [updated
  configuration guide](/concepts/configuration/config-schema).
</Note>

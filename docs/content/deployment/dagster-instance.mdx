...
<TabItem name="S3ComputeLogManager (obstore)">

#### ComputeLogManagers using `obstore`

\<PyObject module="dagster_obstore" provides three lean integrations with object stores, ADLS, GCS & S3.

The <PyObject module="dagster_obstore.s3" object="S3ComputeLogManager" /> writes `stdout` and `stderr` to any S3 compatible endpoint.

```yaml file=/deploying/dagster_instance/dagster.yaml startafter=start_marker_compute_log_storage_s3_obstore endbefore=end_marker_compute_log_storage_s3_obstore
...
<TabItem name="ADLSComputeLogManager (obstore)">

#### ComputeLogManagers using `obstore`

\<PyObject module="dagster_obstore" provides three lean integrations with object stores, ADLS, GCS & S3.

The <PyObject module="dagster_obstore.azure" object="ADLSComputeLogManager" /> writes `stdout` and `stderr` to Azure Datalake/Blob storage.

```yaml file=/deploying/dagster_instance/dagster.yaml startafter=start_marker_compute_log_storage_azure_obstore endbefore=end_marker_compute_log_storage_azure_obstore
...
<TabItem name="GCSComputeLogManager (obstore)">

#### ComputeLogManagers using `obstore`

\<PyObject module="dagster_obstore" provides three lean integrations with object stores, ADLS, GCS & S3.

The <PyObject module="dagster_obstore.gcs" object="GCSComputeLogManager" /> writes `stdout` and `stderr` to Google Cloud Storage.

```yaml file=/deploying/dagster_instance/dagster.yaml startafter=start_marker_compute_log_storage_gcs_obstore endbefore=end_marker_compute_log_storage_gcs_obstore

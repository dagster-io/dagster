...
<Warning>
  ...
  <Link href="/_apidocs/execution#config-schema">Run Config Schema</Link> for
...
This determines the policy used to determine the prioritization rules and concurrency limits for runs. Please see the <Link href="/deployment/run-coordinator">Run Coordinator Docs</Link> for more information and for troubleshooting help.

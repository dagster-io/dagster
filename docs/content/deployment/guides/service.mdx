...
The core of any deployment of Dagster is [the Dagster webserver](/concepts/dagster-ui), a process that serves the Dagster UI and responds to GraphQL queries.

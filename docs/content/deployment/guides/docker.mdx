...
In this passage you have a "code location server" "running a gRPC server" which isn't really right.

I think in this context it is right to say the code location IS a grpc server.

...
Related guides:
  ...
  - [Using Dagster with Delta Lake guide](https://docs.dagster.io/integrations/deltalake)
  - [DeltaLake I/O manager reference](https://docs.dagster.io/integrations/deltalake/reference)

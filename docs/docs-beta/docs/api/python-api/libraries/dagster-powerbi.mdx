...
<dl>
    ...
    <dl>
        ...
        Parameters: 
          - <strong>context</strong> (<em>Optional</em><em>[</em><em>DefinitionsLoadContext</em><em>]</em>) – The context to use when loading the definitions.
          - <strong>dagster_powerbi_translator</strong> (<em>Type</em><em>[</em>[*DagsterPowerBITranslator*](#dagster_powerbi.DagsterPowerBITranslator)<em>]</em>) – The translator to use
          - <strong>enable_refresh_semantic_models</strong> (<em>bool</em>) – Whether to enable refreshing semantic models

...
The following classes are used as part of the new [Pythonic resources system](https://docs.dagster.io/concepts/resources).
...
The following classes are used as part of the [legacy resource system](https://docs.dagster.io/concepts/resources-legacy).

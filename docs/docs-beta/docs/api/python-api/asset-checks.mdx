...
<dl>
    ...
    [https://docs.dagster.io/concepts/metadata-tags/asset-metadata/table-metadata#attaching-column-schema](https://docs.dagster.io/concepts/metadata-tags/asset-metadata/table-metadata#attaching-column-schema).

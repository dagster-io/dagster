...
The following classes are used as part of the new [Pythonic config system](https://docs.dagster.io/concepts/configuration/config-schema). They are used in conjunction with builtin types.
...
The following types are used as part of the legacy [Dagster config system](https://docs.dagster.io/concepts/configuration/config-schema-legacy). They are used in conjunction with builtin types.

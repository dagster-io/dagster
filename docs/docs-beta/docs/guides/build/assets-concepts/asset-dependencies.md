...
<CodeExample filePath="guides/build/create-a-pipeline/data-assets/passing-data-assets/passing-data-explicit.py" language="python" title="Using External Storage" />
...
<CodeExample filePath="guides/build/create-a-pipeline/data-assets/passing-data-assets/passing-data-io-manager.py" language="python" title="Using I/O managers" />
...
<CodeExample filePath="guides/build/create-a-pipeline/data-assets/passing-data-assets/passing-data-avoid.py" language="python" title="Avoid Passing Data Between Assets" />
...
The assets are modeled as tasks, rather than as data assets. For more information on the difference between tasks and data assets, check out the [Thinking in Assets](/guides/build/assets-concepts/assets) guide.
...
<CodeExample filePath="guides/build/create-a-pipeline/data-assets/passing-data-assets/passing-data-rewrite-assets.py" language="python" title="Avoid Passing Data Between Assets" />

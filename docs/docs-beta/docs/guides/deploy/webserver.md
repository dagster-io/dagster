...
- **Description**: This version of the **Asset catalog** page includes all the information and functionality of the original page, broken out by compute kind, [asset group](/todo), [code location](/guides/deploy/code-locations/), [tags](/guides/build/assets/metadata-tags/organizing-assets-with-tags-and-metadata#tags), and [owners](/guides/build/assets/metadata-tags/organizing-assets-with-tags-and-metadata#owners), etc. On this page, you can:

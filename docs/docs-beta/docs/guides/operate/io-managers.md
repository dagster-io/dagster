...
As a general rule, if your pipeline becomes more complicated in order to use I/O managers, it's likely that I/O managers aren't a good fit. In these cases you should use `deps` to [define dependencies](/guides/build/assets/defining-dependencies-with-asset-factories).
...
- Learn to [connect databases](/guides/build/external-resources-and-systems/connect/databases) with resources
- Learn to [connect APIs](/guides/build/external-resources-and-systems/connect/apis) with resources
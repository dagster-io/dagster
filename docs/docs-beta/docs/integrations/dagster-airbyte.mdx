...
status: 'published'
name: 'Airbyte'
title: 'Using Airbyte with Dagster'
...
[The guide](https://docs.dagster.io/integrations/airbyte) focuses on how to work with Airbyte connections using Dagster's software-defined asset (SDA) framework.

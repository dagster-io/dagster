...
docslink: https://docs.dagster.io/integrations/libraries/dbt/dbt-core
...
<CodeExample path="docs_beta_snippets/docs_beta_snippets/integrations/dbt.py" language="python" />

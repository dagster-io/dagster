...
Dagster allows you to emit column-level metadata, like [column schema](/guides/build/assets/metadata-tags/organizing-assets-with-tags-and-metadata#standard-metadata-types) and [column lineage](/guides/build/assets/metadata-tags/organizing-assets-with-tags-and-metadata#column-lineage), as [materialization metadata](/guides/build/assets/metadata-tags/organizing-assets-with-tags-and-metadata#runtime-metadata).

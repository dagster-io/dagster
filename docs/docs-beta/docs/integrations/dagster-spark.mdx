...
- [Running Pyspark code in ops](https://docs.dagster.io/integrations/spark#running-pyspark-code-in-ops)
- [Submitting PySpark ops on EMR](https://docs.dagster.io/integrations/spark#submitting-pyspark-ops-on-emr)

      ...
      items: [
        {
          ...
          customProps: {logo: 'images/examples/panels/deep-dives.png', logoVariant: 'panel'},
        },
        {
          type: 'link',
          label: 'Customer case studies',
          href: 'https://dagster.io/customers',
          customProps: {logo: 'images/examples/panels/case-studies.png', logoVariant: 'panel'},
        },
        {
          type: 'category',
          ...
          customProps: {logo: 'images/examples/panels/full-pipeline.png', logoVariant: 'panel'},
          items: [
            {
              type: 'link',
        ...
        },
        {
          ...
          customProps: {logo: 'images/examples/panels/best-practices.png', logoVariant: 'panel'},
          items: [
            {
              type: 'autogenerated',

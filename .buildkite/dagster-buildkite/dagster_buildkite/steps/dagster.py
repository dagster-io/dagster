...
def build_repo_wide_ruff_steps() -> List[CommandStep]:
    return [
        ...
        .run(
            "pip install -e python_modules/dagster[ruff] -e python_modules/dagster-pipes -e python_modules/libraries/dagster-dg",
            "make check_ruff",
        )
...
def build_sql_schema_check_steps() -> List[CommandStep]:
    return [
        ...
        .on_test_image(AvailablePythonVersion.get_default())
        .run(
            "pip install -e python_modules/dagster -e python_modules/dagster-pipes -e python_modules/libraries/dagster-dg",
...
def build_graphql_python_client_backcompat_steps() -> List[CommandStep]:
    return [
        ...
        .run(
            ...
            " -e python_modules/libraries/dagster-dg -e python_modules/dagster-graphql -e python_modules/automation",
            " -e python_modules/dagster-graphql -e python_modules/automation",

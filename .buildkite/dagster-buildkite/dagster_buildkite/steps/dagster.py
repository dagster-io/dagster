...
def build_repo_wide_ruff_steps() -> list[CommandStepConfiguration]:
    return [
        ...
        .run(
            "uv pip install -e python_modules/dagster[ruff] -e python_modules/dagster-pipes -e python_modules/libraries/dagster-shared",
            "make check_ruff",
        )
...
def build_sql_schema_check_steps() -> list[CommandStepConfiguration]:
    return [
        add_test_image(
            ...
            .run(
                "uv pip install -e python_modules/dagster -e python_modules/dagster-pipes -e python_modules/libraries/dagster-shared",
...
def build_graphql_python_client_backcompat_steps() -> list[CommandStepConfiguration]:
    return [
        add_test_image(
            ...
            .run(
                "uv pip install -e python_modules/dagster[test] -e python_modules/dagster-pipes"

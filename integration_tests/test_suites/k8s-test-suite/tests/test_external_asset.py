...
from dagster_pipes import DefaultPipesProcessContextLoader, PipesProcessContextData
...
class ExtConfigMapContextInjector(ExtContextInjector):
    ...
    def inject_context(
        ...
        try:
            yield {DefaultPipesProcessContextLoader.FILE_PATH_KEY: "/mnt/dagster/context.json"}
        finally:
